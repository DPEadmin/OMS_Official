                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group mb-0">
                                            ...
                                            <asp:TextBox ID="txtSearchEndDateFrom" class="form-control" placeholder="ถึง" runat="server" AutoCompleteType="Disabled" onkeydown="return false"></asp:TextBox>
                    ...
                    <asp:UpdatePanel ID="UpModal" runat="server">
                        <ContentTemplate>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtStartDate_INS" class="form-control" placeholder="ตั้งแต่" runat="server" AutoCompleteType="Disabled" onkeydown="return false"></asp:TextBox>
                                ...
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtEndDate_INS" class="form-control" placeholder="สิ้นสุด" runat="server" AutoCompleteType="Disabled" onkeydown="return false"></asp:TextBox>
