<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="DiscountbillDetail.aspx.cs" Inherits="DOMS_TSR.src.Promotion.DiscountbillDetail" %>
...
<asp:Content ID="head" ContentPlaceHolderID="HeaderContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddDiscountBillDetailConfirm() {
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--<asp:HiddenField ID="hidDiscountBillName" runat="server" />--%>
                                    ...
                                    <table class="table-detail m-0" style="width: 100%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label runat="server" ID="txtDiscountBillCode"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">ชื่อโปรโมชั่น</th>
                                                <td>
                                                    <asp:Label runat="server" ID="txtDiscountBillName"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">ประเภทโปรโมชั่น</th>
                                                <td>
                                                    <asp:Label runat="server" ID="txtDiscountBillTypeName">
                                                    </asp:Label>
                                                    <asp:Label Visible="false" ID="hidFlagComboset"
                                                        runat="server"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label Visible="false" ID="hidDiscountBillTypeCode"
                                                        runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label runat="server" ID="txtDiscountBillStatusName">
                                                    </asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                ...
                                                <asp:LinkButton ID="btnAddDiscountBill" class="button-action button-add m-r-10"
                                            ...
                                            <asp:GridView ID="gvDiscountBill" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                                OnRowCreated="gvDiscountBill_RowCreated"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        <HeaderTemplate>
                                                            <center>
                                            <asp:CheckBox ID="chkDiscountBillDetailAll" OnCheckedChanged="chkDiscountBillDetailAll_Change" AutoPostBack="true" runat="server"  />
                                        </center>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="true">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCombosetName" Text='<%# DataBinder.Eval(Container.DataItem, "DiscountBillName")%>' runat="server" />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="LBLid" Text='<%# DataBinder.Eval(Container.DataItem, "DiscountBillDetailId")%>' runat="server" Visible="false" />
                                                      <asp:HiddenField ID="hidDiscountBillDetailInfoId"  value='<%# DataBinder.Eval(Container.DataItem, "DiscountBillDetailId")%>' runat="server" Visible="false" />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="right" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPrice" Text='<%# DataBinder.Eval(Container.DataItem, "Price","{0:N2}")%>' runat="server" />
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField runat="server" ID="hidDiscountBillDetailId" Value='<%# DataBinder.Eval(Container.DataItem, "DiscountBillDetailId")%>' />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="false">

                                                        <HeaderTemplate>

                                                            <div align="Center">DiscountBillDetailId </div>

                                                        </HeaderTemplate>

                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDiscountBillDetailId" Text='<%# DataBinder.Eval(Container.DataItem, "DiscountBillDetailId")%>' runat="server" />
                            ...
                            <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="right" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblPrice" Text='<%# DataBinder.Eval(Container.DataItem, "Price")%>' runat="server" Style="text-align: right" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPrice_Ins" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "Price")%>' class="form-control" Enabled='<%# hidDiscountBillTypeCode.Text == "02" || hidDiscountBillTypeCode.Text == "11" %>' Style="text-align: right" />
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="btnEdit" runat="Server" CommandName="AddDiscountBillDetail"
                                                class="button-activity "
                                            ...
                                            <asp:HiddenField runat="server" ID="hidDiscountBillDetailId" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <asp:DropDownList ID="ddlDiscountBill_Ins" runat="server" class="form-control"></asp:DropDownList>
                                    <asp:Label ID="lblDiscountBillLevel_Ins" runat="server" CssClass="validation"></asp:Label>
                                </div>--%>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="btnEdit" runat="Server" CommandName="AddDiscountBillComboDetail"
                                                    class="button-activity "
                                                    CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"> <span class="icofont icofont-ui-add f-14"></span></asp:LinkButton>
                                        ...
                                        <td width="100%" align="right" valign="top">
                                            <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                                <tr>
                                                    ...
                                                    <td style="width: 12px"></td>
                                                    <td>
                                                        <asp:Button ID="btnnextProcom" CssClass="Button" ToolTip="First" CommandName="First"
                                                            Text="<<" runat="server" OnCommand="GetProComboPageIndex"></asp:Button>
                                                    </td>
                                                    <td style="width: 6px"></td>
                                                    <td>
                                                        <asp:Button ID="btnpreviousProcom" CssClass="Button" ToolTip="Previous" CommandName="Previous"
                                                            Text="<" runat="server" OnCommand="GetProComboPageIndex"></asp:Button>
                                                    </td>
                                                    <td style="width: 6px"></td>
                                                    <td style="font-size: 8.5pt;">Page
                                                    ...
                                                    <td style="width: 6px"></td>
                                                    <td>
                                                        <asp:Button ID="Button3" CssClass="Button" ToolTip="Next" runat="server" CommandName="Next" Text=">" OnCommand="GetProComboPageIndex"></asp:Button>
                                                    </td>
                                                    <td style="width: 6px"></td>
                                                    <td>
