                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group mb-0">
                                            ...
                                            <asp:TextBox ID="txtSearchStartDateFrom" class="form-control txtdate" placeholder="ตั้งแต่" runat="server" AutoCompleteType="Disabled" onkeydown="return false"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtSearchStartDateTo" class="form-control txtdate" placeholder="ถึง" runat="server" AutoCompleteType="Disabled" onkeydown="return false"></asp:TextBox>
