<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="PromotionComplementaryManagement.aspx.cs" Inherits="DOMS_TSR.src.Promotion.PromotionComplementaryManagement" %>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">ค้นหาข้อมูลโปรโมชั่นของแถม</div>
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                ...
                                                <asp:LinkButton ID="btnAddPromotion" class="button-action button-add m-r-5" Visible ="false"
                                                    OnClick="btnAddPromotion_Click" runat="server"><i class="fa fa-plus m-r-5"></i>เพิ่ม</asp:LinkButton>
                                                <asp:LinkButton ID="btnDelete" Visible="false" OnClick="btnDelete_Click" OnClientClick="return DeleteConfirm();"
                    ...
                    <asp:UpdatePanel ID="UpModal" runat="server">
                        <ContentTemplate>
                            ...
                            <%--    <label class="col-sm-4 col-form-label">แบรนด์<span style="color: red; background-position: right top;">*</span></label>
                                ...
                                <label class="col-sm-4 col-form-label">ระดับโปรโมชั่น<span style="color: red; background-position: right top;">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-4 col-form-label">ประเภทโปรโมชั่น<span style="color: red; background-position: right top;">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row" id="ComplementaryStandardSection" runat="server" visible="false">
                                ...
                                <label class="col-sm-4 col-form-label">การเปลี่ยนของแถม</label>
                                <div class="col-sm-8">
