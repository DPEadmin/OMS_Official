...
{
    public partial class PromotionComplementaryManagement : System.Web.UI.Page
    {
        ...
        public List<PromotionInfo> GetPromotionMasterByCriteria()
        {
            ...
            using (var wb = new WebClient())
            {
                ...
                // For load promotiontype complementary only
                data["ComplementaryFlag"] = "Y";

                if (ddlSearchPromotionType.SelectedValue == "-99")
                {
                ...
                // End for load promotiontype complementary only
        ...
        protected string GetLink(object objCode)
        {
            ...
            return "<a href=\"PromotionDetail.aspx?PromotionCode=" + strCode + "&MenuId=02&ComplementaryFlag=Y\">" + strCode + "</a>";
        }
        ...
        protected void BindddlPromotionType()
        {
            ...
            List<PromotionTypeInfo> lpInfo = new List<PromotionTypeInfo>();

            foreach (var od in lLookupInfo)
            {
                if (od.PromotionTypeCode == StaticField.PromotionTypeCode18) 
                {
                    PromotionTypeInfo pInfo = new PromotionTypeInfo();

                    pInfo.PromotionTypeCode = od.PromotionTypeCode;
                    pInfo.PromotionTypeName = od.PromotionTypeName;
                    lpInfo.Add(pInfo);
                }
            }

            ddlPromotionType_Ins.DataSource = lpInfo;
        ...
        protected void BindddlSearchPromotionType()
        {
            ...
            ddlSearchPromotionType.DataSource = lpInfo;
        ...
        protected Boolean validateInsert()
        {
            ...
            else
            {
                ...
                else if (ddlPromotionType_Ins.SelectedValue == StaticField.PromotionTypeCode00 || ddlPromotionType_Ins.SelectedValue == StaticField.PromotionTypeCode01) 
                {
                    flag = (flag == false) ? false : true;
                }
