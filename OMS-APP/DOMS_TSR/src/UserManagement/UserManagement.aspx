<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="UserManagement.aspx.cs" Inherits="DOMS_TSR.src.UserManagement.UserManagement" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Employee name</label>
                                     <div class="col-sm-1">
                                          ...
                                          <asp:TextBox  ID="txtSearchEmpFNameTH" class="form-control" runat="server"></asp:TextBox>
                                       </div> 
                                        <div class="col-sm-2">
                                           <asp:TextBox  ID="txtSearchEmpLNameTH" class="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                        <div align="center">ชื่Employee Name</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modal-emp">
        <div class="modal-dialog modal-lg" style="max-width: 1050px;">
