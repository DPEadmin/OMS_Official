<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="PromotionWorkListDetail.aspx.cs" Inherits="DOMS_TSR.src.WorkList.PromotionWorkListDetail" %>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border-top: 0px;">
                                                    <asp:TextBox ID="txtDescription" TextMode="multiline" Enabled="false" Rows="4" CssClass="from-control w-100" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <asp:Label ID="lblDataEmpty" class="fontBlack" runat="server" Text="Data not Found"></asp:Label>
                                            ...
                                            <table width="100%" cellpadding="1" cellspacing="1" bgcolor="#ffffff">
                                                ...
                                                <div class="text-center m-t-20 col-sm-12 ">
                                                <asp:Button type="button" ID="btnApprove" Text="Approve" class="button-pri button-appove m-r-10" OnClick="btnApprove_Click" OnClientClick="return CheckDouble();" runat="server" />
                                                <asp:Button type="button" ID="btnRevise" Text="Revise" class="button-pri button-revise m-r-10" OnClick="btnRevise_Click" OnClientClick="return CheckDouble();" runat="server" />
                                                <asp:Button type="button" ID="btnReject" Text="Reject" class="button-pri button-reject m-r-10" OnClick="btnReject_Click" OnClientClick="return CheckDouble();" runat="server" />
                                                    </div>
                                        </div>
                                            <div class="text-center m-t-20 col-sm-12 ">
            ...
            <div class="modal-content">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitleMessage" class="modal-title sub-title " style="font-size: 16px;">Message Dialog</div>
                ...
                <div class="modal-body "> 
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                    <div class="form-group row">
                        <asp:Label ID="lblstringjson" runat="server"></asp:Label>
                        <asp:Label ID="lblstringtextonfinishd" runat="server"></asp:Label>
                    </div>
                            <div class="text-center m-t-10">
                            <asp:Button ID="btn_submitredirectlink" Text="OK" class="button-pri button-appove" OnClick="btn_submitredirectlink_Click" runat="server"/>
                            </div>
                            </ContentTemplate>
                </asp:UpdatePanel>
                </div>
