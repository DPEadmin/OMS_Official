                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                ...
                                                <asp:LinkButton ID="btnDelete" OnClick="btnDelete_Click" OnClientClick="return DeleteConfirm();"
                                                    class="button-action button-add" runat="server"><i class="fa fa-plus m-r-5"></i>Delete</asp:LinkButton>
                                            </div>

                                            <div class="dt-responsive table-responsive">
                                                <asp:GridView ID="gvLogistic" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2 ">
                            <div class="col-sm-11">
                                <div class="card-header">
                                    <div class="sub-title" >Logistic Detail</div>
                                    </div>
                            </div>
                            <div class="col-sm-1">
