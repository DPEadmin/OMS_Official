...
{
    public partial class ReportLogfile_Excel : System.Web.UI.Page
    {
        ...
        protected void LoadDar(string StrDate)
        {
            ...
            Util aaa = new Util();
            string respstr = "";
            APIpath = APIUrl + "/api/support/LogfileExcelReport";
            ...
            dtdatasale.Columns.Add("วันเกิด");
            dtdatasale.Columns.Add("อายุ");
                    ...
                    foreach (DataRow Detail in OrderDate.Rows)
                    {
                        ...
                        foreach (DataRow Detailorder in Orderinfo.Rows)
                        {
                            ...
                            if (NumRow <= 1)
                            {
                                ...
                                if (Detailorder["Gender"].ToString() == "-99")
                                {
                                    drsale["เพศ"] = "";
                                }
                                else {
                                ...
                                drsale["วันเกิด"] = Detailorder["CustomerBirthdate"].ToString();
                                drsale["อายุ"] = Detailorder["Age"].ToString();
                                NumRow++;
            ...
            if (dtdatasale.Rows.Count > 0)
            {
                ...
                this.Response.AddHeader("Content-Disposition", "attachment; filename= ReportLogfile_" + DateTime.Now.ToString("ddmmyy") + ".xlsx");
