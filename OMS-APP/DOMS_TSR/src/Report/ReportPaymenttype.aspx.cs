...
{
    public partial class ReportPaymenttype : System.Web.UI.Page
    {
        ...
        {
            List<OrderPaymenttypeInfo> lOrderInfo_NoAnswerOrder = new List<OrderPaymenttypeInfo>();
        ...
        protected void ExportOrder_NoAnswerOrder()
        {
            ...
            olist.Add(new OrderPaymenttypeInfo
            {
                ...
                ContactTel = txtSearchTelephone.Text,
                
            });


            Session["dataExportExcel"] = olist;
            string URL = "ReportPaymenttypeExcel.aspx";
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/ReportPaymenttypeCount";
            ...
            using (var wb = new WebClient())
            {
                ...
                data["ContactTel"] = txtSearchTelephone.Text;
        ...
        public List<OrderPaymenttypeInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            string respstr = "";

            APIpath = APIUrl + "/api/support/ReportPaymenttypeSearch";
            ...
            List<OrderPaymenttypeInfo > lVehicleInfo = JsonConvert.DeserializeObject<List<OrderPaymenttypeInfo>>(respstr);
