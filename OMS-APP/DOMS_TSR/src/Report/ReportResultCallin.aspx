<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="ReportResultCallin.aspx.cs" Inherits="DOMS_TSR.src.Report.ReportResultCallin" %>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header border-0">
                                        <div class="sub-title">รายงานสรุปการขายตาม Call in </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="searchSection_NoAnswerOrder" runat="server">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txtSearchEmpCode_NoAnswerOrder" class="form-control" runat="server"></asp:TextBox>
                                                </div>
                                                     ...
                                                     <Columns>
                                                          <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <ItemTemplate>
                                                               ...
                                                               <asp:Label ID="lblorderdate_NoAnswerOrder" Text='<%# DateTime.Parse(Eval("ORDER_DATE").ToString()).ToString("dd/MM/yyyy")%>' runat="server" />
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">สถานะการโทร</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                        
                                                               <asp:Label ID="lblCallstatus_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "CALL_STATUS")%>' runat="server" />
                                                         ...
                                                         <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">จำนวนการโทร</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                        
                                                               <asp:Label ID="lblCountCall_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "COUNT_CALL")%>' runat="server" />
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ราคา(กรุงเทพ)</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                        
                                                               <asp:Label ID="lblbkkorder_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "BKK_ORDER")%>' runat="server" />
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ราคารวม(กรุงเทพ)</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                        
                                                               <asp:Label ID="lblbkkrevenue_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "BKK_REVENUE")%>' runat="server" />
                                                         ...
                                                         <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ราคา(ต่างจังหวัด)</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                        
                                                               <asp:Label ID="lblupcorder_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "UPC_ORDER")%>' runat="server" />
                                                         ...
                                                         <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ราคารวม(ต่างจังหวัด)</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                        
                                                               <asp:Label ID="lblupcrevenue_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "UPC_REVENUE")%>' runat="server" />
