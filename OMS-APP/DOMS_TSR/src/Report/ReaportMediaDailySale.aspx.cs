...
{
    public partial class ReaportMediaDailySale : System.Web.UI.Page
    {
        ...
        {
            List<ReaportMediaDailySaleInfo> lOrderInfo_NoAnswerOrder = new List<ReaportMediaDailySaleInfo>();
        ...
        protected void ExportOrder_NoAnswerOrder()
        {
            ...
            string URL = "ReaportMediaDailySale_Excel.aspx";
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/CountReaportMediaDailySale";
        ...
        public List<ReaportMediaDailySaleInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            string respstr = "";

            APIpath = APIUrl + "/api/support/ReaportMediaDailySale";
            ...
            List<ReaportMediaDailySaleInfo> lVehicleInfo = JsonConvert.DeserializeObject<List<ReaportMediaDailySaleInfo>>(respstr);
        ...
        protected Boolean Changestatus_NoAnswerOrderforCancel()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstatus = StaticField.OrderStatus_06, orderstate = StaticField.OrderStatus_04, Confirmno = conNo.ToString() }); 
                }
            }
