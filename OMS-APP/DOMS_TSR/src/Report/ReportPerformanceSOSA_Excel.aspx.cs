...
{
    public partial class ReportPerformanceSOSA_Excel : System.Web.UI.Page
    {
        ...
        protected void LoadDar(string StrDate)
        {
            ...
            List<ReaportPerformanceSOSAInfo> lOrder = JsonConvert.DeserializeObject<List<ReaportPerformanceSOSAInfo>>(respstr);
