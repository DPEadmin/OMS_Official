...
{
    public partial class ReportSaleSOSA : System.Web.UI.Page
    {
        ReportResultSOSAInfo resultExport = new ReportResultSOSAInfo();
        ...
        {
            List<ReportResultSOSAInfo> lOrderInfo_NoAnswerOrder = new List<ReportResultSOSAInfo>();
        ...
        protected void ExportOrder_NoAnswerOrder()
        {
            ...
            olist.Add(new OrderOLInfo
            {
                ...
                ,
               SALE_CODE = txtSearchSalemanCode_NoAnswerOrder.Text,
               SALE_FNAME = txtSearchSaleFName_NoAnswerOrder.Text,
               SALE_LNAME = txtSearchSaleLName_NoAnswerOrder.Text,
            ...
            string URL = "ReportSaleSOSA_Excel.aspx";
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/CountReaportResultSOSA";
            ...
            using (var wb = new WebClient())
            {
                ...
                data["SaleCode"] = txtSearchSalemanCode_NoAnswerOrder.Text;

                data["SaleFName"] = txtSearchSaleFName_NoAnswerOrder.Text;

                data["SaleLName"] = txtSearchSaleLName_NoAnswerOrder.Text;
        ...
        public List<ReportResultSOSAInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            string respstr = "";
            ...
            using (var wb = new WebClient())
            {
                ...
                data["SALE_CODE"] = txtSearchSalemanCode_NoAnswerOrder.Text.Trim();

                data["SALE_FNAME"] = txtSearchSaleFName_NoAnswerOrder.Text.Trim();

                data["SALE_LNAME"] = txtSearchSaleLName_NoAnswerOrder.Text.Trim();
            ...
            List<ReportResultSOSAInfo> lVehicleInfo = JsonConvert.DeserializeObject<List<ReportResultSOSAInfo>>(respstr);
            foreach (var i in lVehicleInfo) 
            {
                if (i.TOTAL_AMOUNT != null || i.TOTAL_AMOUNT != "")
                {
                    i.TOTAL_AMOUNT = string.Format("{0:N}",Convert.ToDecimal(i.TOTAL_AMOUNT));
                }
            }
        ...
        public void clearSearch_NoAnswerOrder()
        {
            ...
            txtSearchSalemanCode_NoAnswerOrder.Text = "";
            txtSearchSaleFName_NoAnswerOrder.Text = "";
            txtSearchSaleLName_NoAnswerOrder.Text= "";
        ...
        protected Boolean validateSearch()
        {
            ...
            if (regexItem.IsMatch(txtSearchSalemanCode_NoAnswerOrder.Text))
            {
                flag = (flag == false) ? false : true;
                lblSearchSalemanCode_NoAnswerOrder.Text = "";
            }
            else
            {
                flag = false;
                lblSearchSalemanCode_NoAnswerOrder.Text = MessageConst._MSG_PLEASEINSERT + " รหัสพนักงานขายต้องไม่มีอักขระพิเศษ";
            }
            if (regexItem.IsMatch(txtSearchSaleFName_NoAnswerOrder.Text) && regexItem.IsMatch(txtSearchSaleFName_NoAnswerOrder.Text))
            {
                flag = (flag == false) ? false : true;
                lblSearchSaleName_NoAnswerOrder.Text = "";
            }
            else
            {
                flag = false;
                lblSearchSaleName_NoAnswerOrder.Text = MessageConst._MSG_PLEASEINSERT + " ชื่อ - สกุลต้องไม่มีอักขระพิเศษ";
            }
