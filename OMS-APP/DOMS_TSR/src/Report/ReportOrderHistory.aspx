<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="ReportOrderHistory.aspx.cs" Inherits="DOMS_TSR.src.Report.ReportOrderHistory" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="searchSection_NoAnswerOrder" runat="server">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-sm-2 col-form-label">วันที่ติดต่อ</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:DropDownList ID="ddlSearchContactStatus_NoAnswerOrder" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ผลการติดต่อ</label>
                                                <div class="col-sm-3">
                                                    <asp:DropDownList ID="ddlSearchOrderSituation_NoAnswerOrder" runat="server" class="form-control"></asp:DropDownList>
                                                </div>

                                                <div class="col-sm-1"></div>

                                                <label class="col-sm-2 col-form-label">ประเภทการขาย</label>
                                                <div class="col-sm-3">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:CheckBox ID="chkAll_NoAnswerOrder" OnCheckedChanged="chkAll_Change_NoAnswerOrder" AutoPostBack="true" runat="server"  />
                                                     ...
                                                     <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCreatedDate_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "Date")%>' runat="server" />
                                                                <%--<asp:Label ID="lblCreatedDate_NoAnswerOrder" Text='<%# ((null == Eval("Date"))||("" == Eval("Date"))) ? string.Empty : DateTime.Parse(Eval("Date").ToString()).ToString("dd/MM/yyyy") %>' runat="server" />--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                            <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCreatedTime_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "Time")%>' runat="server" />
                                                                <%--<asp:Label ID="lblCreatedDate_NoAnswerOrder" Text='<%# ((null == Eval("Date"))||("" == Eval("Date"))) ? string.Empty : DateTime.Parse(Eval("Date").ToString()).ToString("dd/MM/yyyy") %>' runat="server" />--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCustomerCode_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "OrderCode")%>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                         ...
                                                         <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblContactStatus_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "ContactStatus")%>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ผลการติดต่อ</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOrderSituation_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "OrderSituation")%>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ประเภทการขาย</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOrderType_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "OrderType")%>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                          <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblOrderNote_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "OrderNote")%>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
