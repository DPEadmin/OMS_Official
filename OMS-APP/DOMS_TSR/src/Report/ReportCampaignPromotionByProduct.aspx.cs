...
{
    public partial class ReportCampaignPromotionByProduct : System.Web.UI.Page
    {
        ...
        {
            List<ReaportCampaignPromotionByProductInfo> lOrderInfo_NoAnswerOrder = new List<ReaportCampaignPromotionByProductInfo>();
        ...
        protected void ExportOrder_NoAnswerOrder()
        {
            ...
            olist.Add(new OrderOLInfo
            {
                ...
                CAMPAIGN_CODE = txtSearchCampaignCode_NoAnswerOrder.Text.Trim(),
                CAMPAIGN_NAME = txtSearchCampaignName_NoAnswerOrder.Text.Trim(),
            ...
            string URL = "ReportCampaignPromotionByProduct_Excel.aspx";
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/CountReaportCampaignPromotionByProduct";
            ...
            using (var wb = new WebClient())
            {
                ...
                data["CAMPAIGN_CODE"] = txtSearchCampaignCode_NoAnswerOrder.Text.Trim();
                data["CAMPAIGN_NAME"] = txtSearchCampaignName_NoAnswerOrder.Text.Trim();
        ...
        public List<ReaportCampaignPromotionByProductInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            string respstr = "";
            ...
            List<ReaportCampaignPromotionByProductInfo> lVehicleInfo = JsonConvert.DeserializeObject<List<ReaportCampaignPromotionByProductInfo>>(respstr);
        ...
        public void clearSearch_NoAnswerOrder()
        {
            ...
            txtSearchCampaignCode_NoAnswerOrder.Text = "";
            txtSearchCampaignName_NoAnswerOrder.Text = "";
        ...
        protected Boolean validateSearch()
        {
            ...
            if (regexItem.IsMatch(txtSearchCampaignCode_NoAnswerOrder.Text))
            {
                flag = (flag == false) ? false : true;
                lblSearchCampaignCode_NoAnswerOrder.Text = "";
            }
            else
            {
                flag = false;
                lblSearchCampaignCode_NoAnswerOrder.Text = MessageConst._MSG_PLEASEINSERT + " รหัสแคมเปญต้องไม่มีอักขระพิเศษ";
            }
            if (regexItem.IsMatch(txtSearchCampaignName_NoAnswerOrder.Text))
            {
                flag = (flag == false) ? false : true;
                lblSearchCampaignName_NoAnswerOrder.Text = "";
            }
            else
            {
                flag = false;
                lblSearchCampaignName_NoAnswerOrder.Text = MessageConst._MSG_PLEASEINSERT + " ชื่อแคมเปญต้องไม่มีอักขระพิเศษ";
            }
            if (regexItem.IsMatch(txtSearchOrderDateFrom_NoAnswerOrder.Text) && regexItem.IsMatch(txtSearchOrderDateUntil_NoAnswerOrder.Text))
            {
                flag = (flag == false) ? false : true;
