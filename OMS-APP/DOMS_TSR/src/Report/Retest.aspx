<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="Retest.aspx.cs" Inherits="DOMS_TSR.src.Report.Retest" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card ">
                                    ...
                                    <div>
                                        <rsweb:ReportViewer ID="rpsSale" runat="server">
                                            <LocalReport ReportPath="..\OMS_Report\Report\RDLCReportSaleOrder.rdlc">
                                            </LocalReport>

                                        </rsweb:ReportViewer>
                                    </div>
                                    <div id="GvData" runat="server" visible="false"  class="card-block p-t-5"  style="width: 100%; height: 400px; overflow: scroll">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:Panel ID="Panel_NoAnswerOrder" runat="server" Style="overflow-x: scroll;">
                                                ...
                                                <asp:GridView ID="gvOrder_NoAnswerOrder" runat="server"  AutoGenerateColumns="true" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true">
