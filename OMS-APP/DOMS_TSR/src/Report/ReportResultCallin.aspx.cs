...
{
    public partial class ReportResultCallin : System.Web.UI.Page
    {
        ...
        public void sectionLoad_NoAnswerOrder()
        {
            ...
            LoadOrder_NoAnswerOrder(); //ดึงข้อมูลมาแสดง
        }
        ...
        {
            List<ReportResultCallinInfo> lOrderInfo_NoAnswerOrder = new List<ReportResultCallinInfo>();
        ...
        protected void ExportOrder_NoAnswerOrder()
        {
            ...
            olist.Add(new OrderOLInfo
            {
                ...
                ,
                SALE_CODE = txtSearchEmpCode_NoAnswerOrder.Text
                ,
                SALE_FNAME = txtSearchFName_NoAnswerOrder.Text
                ,
                SALE_LNAME = txtSearchLName_NoAnswerOrder.Text
                ,
            ...
            string URL = "ReportResultCallin_Excel.aspx";
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/CountReportResultCallin";
            ...
            using (var wb = new WebClient())
            {
                ...
                data["SALE_CODE "] = txtSearchEmpCode_NoAnswerOrder.Text;

                data["SALE_FNAME"] = txtSearchFName_NoAnswerOrder.Text;

                data["SALE_LNAME"] = txtSearchLName_NoAnswerOrder.Text;
        ...
        public List<ReportResultCallinInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            string respstr = "";
            ...
            List<ReportResultCallinInfo> lVehicleInfo = JsonConvert.DeserializeObject<List<ReportResultCallinInfo>>(respstr);
        ...
        public void clearSearch_NoAnswerOrder()
        {
            ...
            txtSearchEmpCode_NoAnswerOrder.Text = "";
