...

{
    public partial class ReportOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (empInfo != null)
                {
                    ...
                    if (Request.QueryString["LotNo"] == null || Request.QueryString["LotNo"] == "")
                    {
                        hidLotNo.Value = "";
                    }
                    else
                    {
                        hidLotNo.Value = Request.QueryString["LotNo"].ToString();
                    }
                }
                else
                {
        ...
        public List<OrderOLInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/DtOlExcelReportSearch";
