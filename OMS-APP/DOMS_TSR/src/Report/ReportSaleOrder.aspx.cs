...
{
    public partial class ReportSaleOrder : System.Web.UI.Page
    {
        ...
        {
            List<ReportSaleOrderAmountInfo> lOrderInfo_NoAnswerOrder = new List<ReportSaleOrderAmountInfo>();
        ...
        protected void ExportOrder_NoAnswerOrder()
        {
            ...
            olist.Add(new OrderOLInfo
            {
                ...
                CampaignCategoryCode = ddlSearchCamCate_NoAnswerOrder.SelectedValue == "-99" ? dataExcel["CampaignCategoryCode"] = "" : dataExcel["CampaignCategoryCode"] = ddlSearchCamCate_NoAnswerOrder.SelectedValue
                    ,
                SALE_CODE = txtSaleCode.Text,
                SALE_FNAME = TxtFsalename.Text,
                SALE_LNAME = txtLsalename.Text
            });


            Session["dataExportExcel"] = olist;
            string URL = "ReportSaleOrder_Excel.aspx";
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/NewCountListSaleorderByCriteria";
            ...
            using (var wb = new WebClient())
            {
                ...
                data["SALE_CODE"] = txtSaleCode.Text;

                data["SALE_FNAME"] = TxtFsalename.Text;
                data["SALE_LNAME"] = txtLsalename.Text;
        ...
        public List<ReportSaleOrderAmountInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            string respstr = "";

            APIpath = APIUrl + "/api/support/NewSaleorder";
            ...
            List<ReportSaleOrderAmountInfo> lVehicleInfo = JsonConvert.DeserializeObject<List<ReportSaleOrderAmountInfo>>(respstr);
        ...
        protected void BindddlSearchChannel_NoAnswerOrder()
        {
            ...
            ddlSearchChannel_NoAnswerOrder.Items.Insert(0, new ListItem("---- Please Select ----", "-99"));
        }
        ...
        protected void BindddlSearchCamCate_NoAnswerOrder()
        {
            ...
            ddlSearchCamCate_NoAnswerOrder.Items.Insert(0, new ListItem("---- Please Select ----", "-99"));
        }
        ...
        protected void BindddlSearchOrderStatus_NoAnswerOrder()
        {
            ...
            ddlSearchOrderstatus_NoAnswerOrder.Items.Insert(0, new ListItem("---- Please Select ----", "-99"));
        }
