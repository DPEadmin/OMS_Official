<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/WebReatil.Master" AutoEventWireup="true" CodeBehind="TakeOrderEdit.aspx.cs" Inherits="DOMS_TSR.src.TakeOrderRetail.TakeOrderEdit" %>
...
<script>
    ...
    function CancelReturnUrl() {
        if (confirm('ต้องการยกเลิกการแก้ไขใบสั่งขายหรือไม่')) {
            document.getElementById("<%= isConfirm.ClientID %>").value = "Y";
            ReturntoOrderPage();
        }
        else {
    ...
    function ReturntoOrderPage() {
        document.getElementById("<%= ReturntoOrderPage.ClientID %>").click();
    }
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <asp:HiddenField ID="hidMsgDel" runat="server" />
             <asp:HiddenField ID="hidEmpCode" runat="server" />
                          ...
                          <asp:HiddenField ID="hidtab3OrderNote" runat="server" />
                            ...
                            <asp:HiddenField ID="hidbranchorderID" runat="server" />
                            <asp:HiddenField ID="hidtab1ordertransportadresstype01" runat="server" />
                            <asp:HiddenField ID="hidtab1ordertransportadresstype02" runat="server" />
                            ...
                            <asp:HiddenField ID="hidmediaphone" runat="server" />
          ...
          <div class="page-body">
            <div class="row">
                <div class="m-b-5 col-md-12">
                      ...
                      <asp:Button ID="btntab1" runat="server" OnClick="btntab1_Click" Text="Order" CssClass="myButton" />
                       ...
                       <asp:GridView ID="gvOrder" runat="server" AutoGenerateColumns="False" cssclass="table-p-stand"  OnRowDataBound="gvOrder_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" HeaderStyle-Width="" ItemStyle-Width="" >
                                    ...
                                    <ItemTemplate>     
                                        <asp:TextBox style="width:40px;text-align:right" ID="txtAmount_gvOrderView" AutoPostBack="true" OnTextChanged="txtAmount_gvOrderView1_TextChange" onkeyup="this.value = minmax(this.value, 1)" min="1" Text='<%# Eval("Amount") %>' 
                                          runat="server" TextMode="Number" ></asp:TextBox>
                                      ...
                                      <tr>
                                          ...
                                          <tr>
                                              ...
                                              <td style="text-align: right;">
                                                  <asp:Label ID="lblTransportPrice" runat="server"></asp:Label>
         ...
         <ajaxToolkit:CalendarExtender ID="car_modal_RequestDate" Format="dd/MM/yyyy" runat="server" TargetControlID="txtDate" PopupButtonID="img_modal_RequestDate" Enabled="True" TodaysDateFormat="dd/MM/yyyy" />
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 text-center m-t-10 " style="padding-left:1px"> 
                      <asp:linkbutton ID="BtnSubmitOrder" class="button-submitorder" onclick="Submitorder" runat="server">บันทึกแก้ไขสั่งสินค้า</asp:linkbutton>
                        <asp:linkbutton ID="BtnCancel" class="button-pri button-Cancel_Big" onclick="BtnCancel_Click" runat="server">ยกเลิก</asp:linkbutton>
                        <asp:Button ID="CloseAllTab" style="display:none;" class="button-submitorder" onclick="CloseAllTab_Click" runat="server"></asp:Button>
                        <asp:Button ID="ReturntoOrderPage" style="display:none;" class="button-submitorder" onclick="ReturntoOrderPage_Click" runat="server"></asp:Button>
                    </div>
                  </div>
              </div>
    ...
    <div class="modal fade" id="Edituser_new" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="col-sm-12">
                            <div class="card-block">
                                ...
                                <div class="text-center m-t-20 center">
                                    <asp:Button ID="btnSubmit" Text="Submit" class="button-pri button-accept m-r-10" runat="server" OnClick="UpdatedataCustomer" />
                                    <asp:Button ID="Button1" Text="Cancel" class="button-pri button-cancel" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body">
                                    ...
                                    <div id="gvCampaign_Section" class="table-wrapper-scroll-y" style="width: 100%; padding: 10px" runat="server">
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body">
                                    ...
                                    <div id="gvPromotion_Section" class="table-wrapper-scroll-y" style="width: 100%; padding: 10px" runat="server">
                                ...
                                <div class="modal-content m-b-10">
                                    <div class="modal-body">
                                        <div class="card-block">
                                            ...
                                            <div id="gvProduct_Section" class="table-wrapper-scroll-y" style="width: 100%; padding: 10px" runat="server">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox Style="width: 40px; text-align: right;" ID="txtAmount" AutoPostBack="True" min="1" max="99999" Text='<%# Eval("Amount") %>' OnTextChanged="txtAmountgvProduct_TextChanged" runat="server" TextMode="Number"></asp:TextBox>
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body">
                                    <div class="card-block">
                                        ...
                                        <div id ="gvProductView_Section" class="table-wrapper-scroll-y" style="width: 100%; padding: 10px" runat="server">
                                        <asp:GridView ID="gvProductView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox Style="width: 40px; text-align: right;" ID="txtAmount" AutoPostBack="True" min="1" max="99999" Text='<%# Eval("Amount") %>' OnTextChanged="txtAmountView_TextChanged" runat="server" TextMode="Number"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
  ...
  height:200px;
                        ...
                        <h5 class="modal-title sub-title m-b-5" style="font-size: 18px; border-bottom: none" >สินค้า</h5>
                                 <table class="table-p-stand" style="width:100%">
                                  ...
                                  <div class="col-sm-12 text-center m-t-10 " style="pointer-events: auto;">
                        <!--<button type="button" class="button-active button-submit m-r-10 ">Add &nbsp; To &nbsp; Cart   </button>-->
                         <asp:Button ID="BtnAddtoCartMedia" CssClass="button-pri button-accept m-r-10" OnClick="BtnAddtoCartMedia_Click" Text="เพิ่มลงตะกร้า" runat="server"/>
