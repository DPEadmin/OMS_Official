...
<script>
    ...
    function validateperid(key)
    {
       
        if (key != null) {
            var txtBoxValue = document.getElementById('<%= txtper_id.ClientID %>').value;
            console.log(txtBoxValue.length);
            if (!checkID(txtBoxValue)) {
                alert('รหัสประชาชนไม่ถูกต้อง');
                document.getElementById('<%= txtper_id.ClientID %>').value = null;
            }
        }
    }
    function checkID(id) {
            ...
            <asp:HiddenField ID="hidMsgDel" runat="server" />
             ...
             <asp:HiddenField ID="hidMerchantMapcode" runat="server" />
                          ...
                          <asp:HiddenField ID="hidtab3OrderNote" runat="server" />
                            ...
                            <asp:HiddenField ID="hidtab1ChannelName_Selected" runat="server" />
                            <asp:HiddenField ID="hidtab1ChannelNameMedia_Selected" runat="server" />
                            ...
                            <asp:HiddenField ID="hidtab1InventorySelect" runat="server" />
                            <asp:HiddenField ID="hidtab2InventorySelect" runat="server" />
                            <asp:HiddenField ID="hidtab3InventorySelect" runat="server" />
                            <asp:HiddenField ID="hidtab1ContactStatusSelected" runat="server" />
                            <asp:HiddenField ID="hidtab2ContactStatusSelected" runat="server" />
                            <asp:HiddenField ID="hidtab3ContactStatusSelected" runat="server" />
                            <asp:HiddenField ID="hidtab1ContactResultSelected" runat="server" />
                            <asp:HiddenField ID="hidtab2ContactResultSelected" runat="server" />
                            <asp:HiddenField ID="hidtab3ContactResultSelected" runat="server" />
                            <asp:HiddenField ID="hidtab1ContactDesc" runat="server" />
                            <asp:HiddenField ID="hidtab2ContactDesc" runat="server" />
                            <asp:HiddenField ID="hidtab3ContactDesc" runat="server" />
                            <asp:HiddenField ID="hidtab1deliverydate" runat="server" />
                            <asp:HiddenField ID="hidtab2deliverydate" runat="server" />
                            <asp:HiddenField ID="hidtab3deliverydate" runat="server" />
                            <asp:HiddenField ID="hidflagmediaplan" runat="server" />
                            <asp:HiddenField ID="hidflagmediaplan_val" runat="server" />
                            <asp:HiddenField ID="hidtab1Vat" runat="server" />
                            <asp:HiddenField ID="hidtab2Vat" runat="server" />
                            <asp:HiddenField ID="hidtab3Vat" runat="server" />
                            <asp:HiddenField ID="hidtab1CustomerTaxId" runat="server" />
                            <asp:HiddenField ID="hidtab2CustomerTaxId" runat="server" />
                            <asp:HiddenField ID="hidtab3CustomerTaxId" runat="server" />
                            <asp:HiddenField ID="hidCatagorycode_ins" runat="server" />
                            <asp:HiddenField ID="hidCam_MediaSaleChannel" runat="server" />
                            <asp:HiddenField ID="hidmediaflag_detail" runat="server" />
                            <asp:HiddenField ID="hidltab1eadCode" runat="server" />
                            <asp:HiddenField ID="hidtab1prfilepath" runat="server" />
                            <asp:HiddenField ID="hidtab1prfilename" runat="server" />
                            <asp:HiddenField ID="hidtab1pofilepath" runat="server" />
                            <asp:HiddenField ID="hidtab1pofilename" runat="server" />
            ...
            <div class="row">
              ...
              <div class=" col-md-9 col-pad-r">
                    ...
                    <div class="sub-title  " style="border: none;">ตะกร้าสินค้า 
                     ...
                     <!--     <button type="button" class="btn-add button-active btn-small"
                       ...
                       <!--ยังไม่ได้ต่อหลังบ้าน-->
                        ...
                        <asp:LinkButton runat="server" ID="btnCleargvOrder" class="button-pri button-delete" OnClick="btnCleargvOrder_Click"><i class="fa fa-minus m-r-5" runat="server"></i>ล้างตะกร้า</asp:LinkButton>
                      </span>
                    </div> 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" HeaderStyle-Width="" ItemStyle-Width="" >
                                    ...
                                    <ItemTemplate>    <%#GetTextPrice(DataBinder.Eval(Container.DataItem, "ParentProductCode"),(DataBinder.Eval(Container.DataItem, "ParentProductCode").ToString() == "-PromotionNewPrice") ? DataBinder.Eval(Container.DataItem, "ProductPrice").ToString() + "," + DataBinder.Eval(Container.DataItem, "Price").ToString() : DataBinder.Eval(Container.DataItem, "Price"),DataBinder.Eval(Container.DataItem, "DiscountAmount"),DataBinder.Eval(Container.DataItem, "DiscountPercent"),DataBinder.Eval(Container.DataItem, "ColorCode")
                                                      ,DataBinder.Eval(Container.DataItem, "Amount"),DataBinder.Eval(Container.DataItem, "PromotionTypeCode"),DataBinder.Eval(Container.DataItem, "SumPrice", "{0:n}"))%>
                                 ...
                                 <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" HeaderStyle-Width="10%" ItemStyle-Width="" >
                                    ...
                                    <ItemTemplate>     
                                        <asp:TextBox style="width:60px;text-align:right" min="0" max="99999" ID="txtAmount_gvOrder" AutoPostBack="True" OnTextChanged="txtAmount_gvOrder_TextChanged" Text='<%# Eval("Amount") %>' 
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" HeaderStyle-Width="" ItemStyle-Width="" >
                                    ...
                                    <ItemTemplate>     
                                        <asp:TextBox style="width:65px;text-align:right" ID="txtAmount_gvOrderView" AutoPostBack="true" OnTextChanged="txtAmount_gvOrderView1_TextChange" onkeyup="this.value = minmax(this.value, 1)" min="1" Text='<%# Eval("Amount") %>' 
                                          runat="server" TextMode="Number" ></asp:TextBox>
                                 ...
                                 <asp:TemplateField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center" HeaderStyle-Width="15%" ItemStyle-Width="">
                                    ...
                                    <ItemTemplate>
                                  <asp:Label ID="lblchannel" Text='<%# DataBinder.Eval(Container.DataItem, "ChannelName")%>' runat="server" />
                                    </ItemTemplate>
                               ...
                               <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" HeaderStyle-Width="" ItemStyle-Width="" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <asp:HiddenField ID="hidMinimumQtyTier2" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "MinimumQtyTier2")%>' />
                                    <asp:HiddenField ID="hidProductDiscountPercentTier2" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ProductDiscountPercentTier2")%>' />
                                    <asp:HiddenField ID="hidProductDiscountAmountTier2" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ProductDiscountAmountTier2")%>' />
                                    ...
                                    <asp:HiddenField ID="hidCamcatCode_nud" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "CamcatCode")%>' />
                                    <asp:HiddenField ID="hidChannelCode_nud" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ChannelCode")%>' />
                                    <asp:HiddenField ID="hidChannelName_nud" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ChannelName")%>' />
                                    <asp:HiddenField ID="hidMediaplanFlag_nud" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "MediaplanFlag")%>' />
                                    </ItemTemplate>
                ...
                <div class="row" runat="server">
                  <div class="col-md-4 col-pad-r" id="transportsection" runat="server">
                    <div class="card"  >
                      <div class="card-header">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="140px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblFeeOther" Text='<%# DataBinder.Eval(Container.DataItem, "FeeOther")%>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                  ...
                  <div id="bigcard" runat="server" class="col-md-8 col-pad-l " style="display: inline-grid;">
                    <!-- <div class="card">
                      <div class="card-header">
                    ...
                    <div class="card">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align: right;"> บาท  </td>
                              ...
                              <tr>
                          <td style=" " >ส่วนลด</td>
                          <td style="text-align: right;"><asp:Label ID="lblTotalDiscountAmount" runat="server"></asp:Label></td>
                          <td style="text-align: right;"> บาท  </td>
                                  ...
                                  <tr>
                                      ...
                                      <tr>
                                          ...
                                          <tr>
                                              ...
                                              <td style="text-align: right;"><asp:Label ID="lblTransportPrice" runat="server"></asp:Label>
                                                  <asp:TextBox ID="txtTransportPrice" Style="text-align: center; display: inline-block" OnTextChanged="txtTransport_TextChanged" onkeypress="return isNumberKey(event,this.id)" AutoPostBack="true" runat="server" class="form-control"></asp:TextBox>
                                              </td>
                                              <td style="text-align: right;"> บาท  </td>
                                              </tr>
                      ...
                      <div class="card">
                        ...
                        <div class="sub-title ">วันนัดส่งสินค้า</div>
                          ...
                          <div class="card-block">
                          <asp:TextBox class="form-control" style="border: 2px solid #eb954a;background-color: #ffaf69;" runat="server" onclick="showDate();" ID="txtDate" OnTextChanged="txtDate_Textchanged" placeholder="วว/ดด/ปปปป"/>
         ...
         <ajaxToolkit:CalendarExtender ID="car_modal_RequestDate" Format="dd/MM/yyyy" runat="server" TargetControlID="txtDate" PopupButtonID="img_modal_RequestDate" Enabled="True" TodaysDateFormat="dd/MM/yyyy" />
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-pad-l"  style="display:inline-grid">
                          ...
                          <asp:GridView ID="gvOrderPayment" runat="server" AutoGenerateColumns="False" CssClass=""
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblPaymenymentTypeName" Text='<%# DataBinder.Eval(Container.DataItem, "LookupValue")%>' runat="server" /><%--radiobutt--%>
                      ...
                      <div class="card">
                           <div class="card-header"  style="padding:5px 5px">
                            <div class="sub-title ">สถานะการสั่งซื้อ</div>
                          </div>
                          <div class="card-block">
                               <div class="form-group row">
                                  <label class="col-md-4 col-form-label">สถานะการติดต่อ</label>
                                  <div class="col-md-4" >
                                      <asp:DropDownList ID="ddlContact_Status" runat="server" CssClass="form-control" AutoPostBack="true"  class="form-control"></asp:DropDownList>
                                  </div>
                              </div>
                              <div class="form-group row">
                                  <label class="col-md-4 col-form-label">ผลการติดต่อ</label>
                                  <div class="col-md-4" >
                                      <asp:DropDownList ID="ddlOrderSituation" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlOrderSituation_SelectedChanged" class="form-control"></asp:DropDownList>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div id="inventorypart" class="row" runat="server">
                  ...
                  <div class="col-md-12 "  style="display:inline-grid">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header"  style="padding:5px 5px">
                            ...
                            <div class="sub-title ">สินค้าคงคลัง
    
                            </div>
                          </div>
                          <div class="card-block">
                              <div class="form-group row">
                                  <label class="col-md-2 col-form-label">คลังสินค้า</label>
                                  <div class="col-md-4" >
                                      <asp:DropDownList ID="ddlInventory" runat="server"  CssClass="form-control form-controls" AutoPostBack="true" OnSelectedIndexChanged="ddlInventory_SelectedChanged" class="form-control"></asp:DropDownList>
                                  </div>
                              </div>
                          ...
                          <asp:GridView ID="gvProductInventory" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                        <center>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="false">
                                    <HeaderTemplate>
                                        <center>
                  ...
                  <div id="SaveContactHistory" runat="server">
                  <div class="row" >
                      <div class="col-md-12 " style="display: inline-grid">
                          <div class="card">
                               <div class="card-header"  style="padding:5px 5px">
                              <div class="sub-title ">บันทึกการติดต่อ</div>
                              </div>
                          <div class="card-block">
                              <div class="form-group row">
                                     <label class="col-md-2 col-form-label">สถานะการติดต่อ</label>
                                  <div class="col-md-4" ><asp:DropDownList ID="ddlContactStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlContactStatus_SelectChanged" CssClass="form-control" class="form-control"></asp:DropDownList></div>
                              </div>
                                <div class="form-group row">
                                     <label class="col-md-2 col-form-label">ผลการติดต่อ</label>
                                  <div class="col-md-4" ><div class="col-md-4" ><asp:DropDownList ID="ddlContactResult" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlContactResult_SelectChanged" CssClass="form-control" class="form-control"></asp:DropDownList></div></div>
                              </div>
                                 <div class="form-group row">
                                     <label class="col-md-2 col-form-label">รายละเอียด</label>
                                  <div class="col-md-4" >
                                      <asp:TextBox ID="txtcontactdesc" TextMode="MultiLine" Rows="5" OnTextChanged="txtcontactdesc_TextChanged" Width="100%" runat="server"></asp:TextBox>
                                  </div>
                              </div>
                          </div>
                              </div>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="sub-title ">ข้อมูลลูกค้า
                      <div class="card-header-right" style="    margin-top: 3px;">
                       
                        <%--<asp:LinkButton id="btnEdituser" class="button-pri btn-edit" OnClick="btnEdituser_Click" runat ="server"><i class="fa fa-edit m-r-5"></i>แก้ไข</asp:LinkButton>--%>
                        <asp:LinkButton id="btnEdituser" class="button-pri btn-edit" OnClick="btnEdituser_Click" runat ="server"><i class="fa fa-edit m-r-5"></i>แก้ไข</asp:LinkButton>
                      </div>
                    </div>
                  ...
                  <div class="card-header">
                                <div>
                                    รหัสประจำตัวผู้เสียภาษี  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtCustomerTaxID" Style="text-align: right;" MaxLength="13" OnTextChanged="txtCustomerTaxID_TextChanged" AutoPostBack="true" onkeypress="return validatenumerics(event);" runat="server"></asp:TextBox>
                                    <asp:Label ID="lblCustomerTaxId" style="text-align:right" runat="server"></asp:Label>
                                </div>
                  ...
                  <div class="card-block">
                    <table class="ssre " style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <th style="font-size:16px ; font-weight: 700;" colspan="2"><asp:Label ID="lblCustomerName" runat="server"></asp:Label></th>
                        <tr>
                          <th style="text-align:left ; "><asp:Label ID="lblCustomerCodeLabel" runat="server"></asp:Label><span style="">:</span></th>
                    ...
                    <div class="text-center m-t-10 m-b-10">
                        ...
                        <asp:LinkButton id="PRPOUpload" class="button-pri btn-submit"
                        OnClick="PRPOUpload_Click" runat ="server"><i class="fa fa-edit m-r-5"></i>เพิ่ม File PR&PO</asp:LinkButton>
                    </div>
                ...
                <div class="card">
                  ...
                  <div class="card-block">
                      <div class="card-block">
                                           ...
                                           <span class="m-r-20" id="Ts01" runat="server"  ><i runat="server" id="ico01" class="fa fa-plus button-activity" visible="false"></i></span>                                                                 
                                           ...
                                           <span class="m-r-20" id="Ts02" runat="server"><i runat="server" id="ico02"   class="fa fa-plus button-activity"></i></span>    
                                           ...
                                           <span class="m-r-20" id="Ts03" runat="server"><i runat="server" id="ico03"   class="fa fa-plus button-activity"></i></span>    
                                           ...
                                           <span class="m-r-20" id="Ts04" runat="server"><i  runat="server" id="ico04"  class="fa fa-plus button-activity"></i></span>    
                                           ...
                                           <span class="m-r-20" id="Ts05" runat="server"><i  runat="server" id="ico05"  class="fa fa-plus button-activity"></i></span>    
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px;">แก้ไขข้อมูลลูกค้า</div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div id="divTxtCus_Ins" class="col-sm-4"  runat="server">
                                            ...
                                            <label id="lblCol1"    runat="server"></label>
                                            <label class="col-sm-2 col-form-label">คำนำหน้า</label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="ddlTitle_Ins" runat="server" class="form-control form-controls"></asp:DropDownList>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <asp:HiddenField ID="HiddenFieldFName" runat="server"></asp:HiddenField>
                                                <asp:Label ID="lblFirstName_Ins" runat="server" CssClass="validation"></asp:Label>
                                            </div>
<label class="col-sm-2 col-form-label">เพศ</label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="ddlGender_Ins" runat="server" class="form-control form-controls"></asp:DropDownList>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <asp:HiddenField ID="HiddenFieldLName" runat="server"></asp:HiddenField>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">สถานะ</label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="ddlMaritalStatus_Ins" runat="server" class="form-control form-controls"></asp:DropDownList>
                                            ...
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="ddlOccupation_Ins" runat="server" class="form-control form-controls"></asp:DropDownList>
                                ...
                                <div class="text-center m-t-20 center">
                                    <asp:Button ID="btnSubmit" Text="บันทึก" class="button-pri button-accept m-r-10" runat="server" OnClick="UpdatedataCustomer" />
                                    <asp:Button ID="btnCancel" Text="ล้าง" class="button-pri button-cancel" runat="server" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="ProductScript" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:999999;">
      <div class="modal-dialog" role="document" style="max-width:35%; top:25%">
        ...
        <div class ="modal fade" id="modal-paycredit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><%-- paymentmodal --%>
            <div class="modal-dialog" role="document" style="max-width:70%">
                <div class="modal-box">
                        ...
                        <ContentTemplate>
                            ...
                            <div id = "credit_card">
                                <div class="modal-content m-b-10">
                                     <div class="modal-header">
                                        <div class="sub-title" >เครดิตการ์ด - เดบิตการ์ด</div>
                                     </div>
                                    <div class="card-block"></div>
                                    <div class="modal-body">
                                      <div class="form-group row">
                                         <label class="col-sm-2 col-form-label">จำนวนงวด<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlPeriod" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                          <label class="col-sm-2 col-form-label">จ่ายงวดละ<span style="color: red; background-position: right top;">*</span></label>
                                              <div class="col-sm-2">
                                                    <asp:TextBox ID="txtPer_period" type ="number" class="form-control" placeholder="0" runat="server"></asp:TextBox>
                                              </div>
                                          <label class="col-sm-2 col-form-label">งวดแรก<span style="color: red; background-position: right top;">*</span></label>
                                              <div class="col-sm-2">
                                                    <asp:TextBox ID="txtFirst_period" type ="number" class="form-control" placeholder="0" runat="server"></asp:TextBox>
                                              </div>
                                      </div>
                                     
                                     <div class="form-group row">
                                         <label class="col-sm-2 col-form-label">ประเภทบัตร<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlCardtype" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                          <label class="col-sm-2 col-form-label">ธนาคารผู้ออกบัตร<span style="color: red; background-position: right top;">*</span></label>
                                              <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlCardbank" runat="server" class="form-control"></asp:DropDownList>
                                              </div>
                                      </div>
                                      <div class="form-group row">
                                         <label class="col-sm-2 col-form-label">หมายเลขบัตร<span style="color: red; background-position: right top;">*</span></label>
                                          <div class="col-sm-4">
                                                    <div class="input-group mb-0">
                                                <div style ="width:20%;"><asp:TextBox ID="txtcardnumber01" style ="text-align: center;"  maxlength="4" class="form-control" placeholder="0000" runat="server" AutoPostBack="true" onkeypress="return validatenumerics(event);"></asp:TextBox></div>
                                                <div>&nbsp;</div>
                                                <div style ="width:20%;"><asp:TextBox ID="txtcardnumber02" style ="text-align: center;"  maxlength="4" class="form-control" placeholder="0000" runat="server" AutoPostBack="true" onkeypress="return validatenumerics(event);"></asp:TextBox></div>
                                                <div>&nbsp;</div>
                                                <div style ="width:20%;"><asp:TextBox ID="txtcardnumber03" style ="text-align: center;"  maxlength="4" class="form-control" placeholder="0000" runat="server" AutoPostBack="true" onkeypress="return validatenumerics(event);"></asp:TextBox></div>
                                                <div>&nbsp;</div>
                                                <div style ="width:20%;"><asp:TextBox ID="txtcardnumber04" style ="text-align: center;"  maxlength="4" class="form-control" placeholder="0000" runat="server" AutoPostBack="true" onkeypress="return validatenumerics(event);"></asp:TextBox></div>
                                                        </div>
                                              </div>
                                      </div>
                                      <div class="form-group row">
                                         <label class="col-sm-2 col-form-label">CVV<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-4">
                                                <div style ="width:20%;"><asp:TextBox ID="txtcvv" style ="text-align: center;" AutoPostBack="true" onkeypress="return validatenumerics(event);"  maxlength="3" class="form-control" placeholder="000" runat="server"></asp:TextBox></div>
                                                    </div>
                                      </div>
                                       <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">ชื่อผู้ถือบัตร<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-4">
                                                    <div class="input-group mb-0">
                                                        <asp:TextBox ID="txtFName" class="form-control" placeholder="ชื่อ" runat="server"></asp:TextBox>
                                                        <asp:TextBox ID="txtLName" class="form-control" placeholder="นามสกุล" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                      </div>
                                      <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">วันหมดอายุ<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-4">
                                                    <div class="input-group mb-0">
                                                         <asp:DropDownList ID="ddlmonth_expire" runat="server" class="form-control"></asp:DropDownList>
                                                         <asp:DropDownList ID="ddlyear_expire" runat="server" class="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                      </div>
                                  
                                      <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">รหัสบัตรประชาชน<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-4">
                                                    
                                                        <asp:TextBox ID="txtper_id" maxlength="13" class="form-control" onchange="validateperid(event);" AutoPostBack="true" onkeypress="return validatenumerics(event);" placeholder="1100801255XXX" runat="server"></asp:TextBox>

                                                </div>
                                      </div>
                                    
                                         <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">วัน/เดือน/ปี เกิด<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-4">
                                                    
                                                         <asp:TextBox ID="txtbirthdate" class="form-control" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                                        <ajaxToolkit:CalendarExtender ID="calberthdate" runat="server" TargetControlID="txtbirthdate" PopupButtonID="Image1" Format="dd/MM/yyyy"></ajaxToolkit:CalendarExtender>

                                                </div>
                                      </div>
                                              <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Payment Gateway</label>
                                                <div class="col-sm-4">
                                                    
                                                        <asp:TextBox ID="txtpaymentgateway" class="form-control" runat="server"></asp:TextBox>
                            ...
                            <div id = "transfer_route">
                            <div class="modal-content m-b-10">
                                     <div class="modal-header">
                                        <div class="sub-title" >โอนเงินเข้าบัญชี</div>
                                     </div>
                                 <div class="card-block"></div>
                                    <div class="modal-body">
                                         <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ธนาคาร<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlTransferBank" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                                <label class="col-sm-2 col-form-label">สาขา<span style="color: red; background-position: right top;">*</span></label>
                                              <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlTransferBranch" runat="server" class="form-control"></asp:DropDownList>
                                              </div>
                                        </div>
                                         <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ชื่อบัญชี<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlAccountName" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                                <label class="col-sm-2 col-form-label">เลขที่บัญชี<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-4">
                                                    <div class="input-group mb-0">
                                                    <asp:DropDownList ID="ddlAccountType" runat="server" class="form-control"></asp:DropDownList>
                                                    <asp:Textbox ID="txtAccountNumber"  maxlength="10" runat="server" class="form-control" AutoPostBack="true" onkeypress="return validatenumerics(event);"></asp:Textbox>
                                 ...
                                 <div class="card-block"></div>
                                    <div class="modal-body">
                                         <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">เบอร์โทรศัพท์</label>
                                                <div class="col-sm-2">
                                                    <asp:Textbox ID="txtMpayPhoneNum"  maxlength="10" placeholder="08345782XX" runat="server" class="form-control" AutoPostBack="true" onkeypress="return validatenumerics(event);"></asp:Textbox>
                                                </div>
                                                <label class="col-sm-2 col-form-label">ชื่อผู้จดทะเบียน</label>
                                              <div class="col-sm-2">
                                                    <asp:Textbox ID="txtMpayName" runat="server" class="form-control"></asp:Textbox>
                                              </div>
                                        </div>
                            ...
                            <div class="modal-content m-b-10">
                                     <div class="modal-header">
                                        <div class="sub-title" >อื่นๆ</div>
                                     </div>
                                 <div class="card-block"></div>
                                    <div class="modal-body">
                                         <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ช่องทางอื่นๆ</label>
                                                <div class="col-sm-2">
                                                    <asp:TextBox id="txtareaAnotherPay" TextMode="multiline" Columns="50" Rows="5" runat="server" />
                                                </div>
        ...
        <div class="modal fade" id="modal-addpro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><%--salemodal--%>
              <div class="modal-dialog" role="document" style="max-width:70%">
                ...
                <div class="modal-box">   
                       <asp:UpdatePanel ID="UpModal" runat="server">
                        <ContentTemplate>
                            <div  style="pointer-events: auto;" >   
                                <div>
                                    <asp:Button ID="btntab12" runat="server" OnClick="campaign_Click" Text="แคมเปญ" CssClass="myButton"  />
                                     <asp:Button ID="btntabmediaplan" OnClick="media_Click" runat="server" Text="Mediaplan" CssClass="myButton" />
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body m-b-p-10">
                                     
                                    <div class="col-sm-4 p-r-0"  style=" float: right;">
                                    ...
                                    <div id="gvCampaign_Section" class="table-wrapper-scroll-y" style="width: 100%;  " runat="server">
                                        <asp:GridView ID="gvCampaign" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand " border="0" Style="width: 100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="70%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField runat="server" ID="HidCamcatcode" Value='<%# DataBinder.Eval(Container.DataItem, "CampaignCategory")%>' />
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body m-b-p-10">
                                    ...
                                    <div class="col-sm-4 p-r-0"  style=" float: right;">
                                        <div class="input-group" style="float: right;">
                                            <asp:TextBox id="txtSearchPromotion" runat="server" class="form-control m-r-10" placeholder="ค้นหาชื่อโปรโมชั่น"></asp:TextBox>
                                    ...
                                    <div id="gvPromotion_Section" class="table-wrapper-scroll-y" style="width: 100%;  " runat="server">
                                ...
                                <div id="comboset" runat="server" class="modal-content m-b-10">
                                    ...
                                    <div class="modal-body">
                                        <div class="card-block">
                                            ...
                                            <div id="gvComboset_Section" class="table-wrapper-scroll-y" style="width: 100%; padding: 10px" runat="server">
                                ...
                                <div class="modal-content m-b-10">
                                    <div class="modal-body m-b-p-10">
                                        ...
                                        <div class="col-sm-4 p-r-0"  style=" float: right;">
                                                ...
                                                <div class="input-group" style="float: right;">
                                                 <asp:TextBox id="txtSearchProduct" runat="server" class="form-control m-r-10" placeholder="ค้นหาชื่อสินค้า"></asp:TextBox>
                                            ...
                                            <div id="gvProduct_Section" class="table-wrapper-scroll-y" style="width: 100%; " runat="server">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnSelectProduct" runat="Server" CommandName="SelectProduct"
                                                                class="button-active button-submit m-r-10  " Style="float: none; border-radius: 5px; padding: 3px 10px; padding-top: 5px;"
                                                                CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"> <span class="fas fa-plus f-16"></span></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        <HeaderTemplate>
                                                            <div align="right">จำนวน</div>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:TextBox Style="width: 65px; text-align: right;" ID="txtAmount" AutoPostBack="True" min="1" max="99999" Text='<%# Eval("Amount") %>' OnTextChanged="txtAmountgvProduct_TextChanged" runat="server" TextMode="Number"></asp:TextBox>
...
<%--                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField runat="server" ID="HidProductBrandName" Value='<%# DataBinder.Eval(Container.DataItem, "ProductBrandName")%>' />
                                                            </ItemTemplate>
                                                    </asp:TemplateField>
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body m-b-p-10">
                                    ...
                                    <div class="col-sm-4 p-r-0"  style=" float: right;">
                                        ...
                                        <div id ="gvProductView_Section" class="table-wrapper-scroll-y" style="width: 100%; " runat="server">
                                        <asp:GridView ID="gvProductView" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox Style="width: 65px; text-align: right;" ID="txtAmount" AutoPostBack="True" min="1" max="99999" Text='<%# Eval("Amount") %>' OnTextChanged="txtAmountView_TextChanged" runat="server" TextMode="Number"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <%--    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="HidProductBrandName" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ProductBrandName")%>' />
                        ...
                        <!--<button type="button" class="button-active button-submit m-r-10 ">Add &nbsp; To &nbsp; Cart   </button>-->
                         <asp:Button ID="BtnAddtoCart" CssClass="button-pri button-accept m-r-10"  OnClick="BtnAddtoCart_Click" Text="เพิ่มลงตะกร้า" runat="server"/>
                         <asp:Button ID="btnCloseAddtoCart" runat="server" CssClass="button-pri button-cancel" Text="ปิด" OnClick="btnCloseAddtoCart_Click" />
                      </div>
                         </div>
                        ...
                        <h5 class="modal-title sub-title" style="font-size: 18px; border-bottom: none ;text-transform:unset  ;   margin-bottom: 10px;" >Media Time</h5>
                                 <table class="table-p-stand" style="width:100%">
                                     <thead>
                                         <tr>
                                             <th style="text-align:center ;">เวลาการโทร</th>
                                             ...
                                             <th style="text-align:center ;">เวลาสิ้นสุด</th>                                                                                
                                               <th style="text-align:center ;"><asp:Label ID="thMediaphone" runat="server">Mediaphone</asp:Label></th>       
                                         </tr>
                                     </thead>
                                     <tbody>
                                         <tr style="background-color: #f4f4f4;"  >
                                             ...
                                             <td style="text-align:center ;"><asp:Label ID="lblCampaignMediaExpireDate" runat="server"></asp:Label></td>
                                                 <td style="text-align:center ;"><asp:Label ID="lblMobilephone" runat="server"></asp:Label></td>                                   
                                         </tr>
                            ...
                            <div class="col-sm-4 p-r-0"  style=" float: right;">
                                <div class="input-group" style=" float: right;">
                                      <asp:TextBox id="txtSearchCampaign1" runat="server" class="form-control m-r-10" placeholder="ค้นหาชื่อแคมเปญ"></asp:TextBox>
  ...
  height:200px;
                        ...
                        <h5 class="modal-title sub-title" style="font-size: 18px; border-bottom: none" >แคมเปญ</h5>
                                 ...
                                 <div class="table-wrapper-scroll-y my-custom-scrollbar " style="width: 100%;  ">
                                        <asp:GridView ID="gvCampaignMedia" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand " border="0" Style="width: 100%"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-Width="33%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="33%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="center">ชื่อแคมเปญ</div>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField runat="server" ID="hidCampaignCode" Value='<%# DataBinder.Eval(Container.DataItem, "CampaignCode")%>' />
                                                        <asp:HiddenField runat="server" ID="hidCampaignName" Value='<%# DataBinder.Eval(Container.DataItem, "CampaignName")%>' />
                                                        <asp:HiddenField runat="server" ID="hidCampaignCatCode" Value='<%# DataBinder.Eval(Container.DataItem, "CampaignCategory")%>' />
                                                        <asp:HiddenField runat="server" ID="hidFlagComboSet" Value='<%# DataBinder.Eval(Container.DataItem, "FlagComboSet")%>' />
                                                        <asp:HiddenField runat="server" ID="hidCam_SaleChannel" Value='<%# DataBinder.Eval(Container.DataItem, "Sale_Channel")%>' />
                                                        <asp:HiddenField runat="server" ID="hidNotifyDate" Value='<%# ((null == Eval("NotifyDate"))||("" == Eval("NotifyDate"))) ? string.Empty : DateTime.Parse(Eval("NotifyDate").ToString()).ToString("dd/MM/yyyy") %>' />
                                                        <asp:HiddenField runat="server" ID="hidExpireDate" Value='<%# ((null == Eval("ExpireDate"))||("" == Eval("ExpireDate"))) ? string.Empty : DateTime.Parse(Eval("ExpireDate").ToString()).ToString("dd/MM/yyyy") %>' />
                                                 ...
                                                 <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="33%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCampaignSalechannel" Text='<%# DataBinder.Eval(Container.DataItem, "ChannelName")%>' runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                          ...
                          <h5 class="modal-title sub-title" style="font-size: 18px; border-bottom: none" >โปรโมชั่น</h5> 
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body m-b-p-10">
                                    ...
                                    <div class="col-sm-4 p-r-0"  style=" float: right;">
                                        <div class="input-group" style="float: right;">
                                            <asp:TextBox id="txtSearchPromotionMedia" runat="server" class="form-control m-r-10" placeholder="ค้นหาชื่อโปรโมชั่นมีเดีย"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="gvPromotionMedia" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                <HeaderTemplate>
                                                    <div align="Left">รหัสโปรโมชัน</div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                ...
                                <div class="modal-content m-b-10">
                                    <div class="modal-body m-b-p-10">
                                        ...
                                        <div class="col-sm-4 p-r-0"  style=" float: right;">
                                                ...
                                                <div class="input-group" style="float: right;">
                                                 <asp:TextBox id="txtSearchProductMedia" runat="server" class="form-control m-r-10" placeholder="ค้นหาชื่อสินค้า"></asp:TextBox>
                                            ...
                                            <asp:GridView ID="gvProductMedia" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvProductMedia_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        <HeaderTemplate>
                                                            <div align="Right">ราคา</div>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:TextBox Style="width: 65px; text-align: right;" ID="txtAmount" AutoPostBack="True" min="0" max="99999" Text='<%# Eval("Amount") %>' OnTextChanged="txtAmountgvProductMedia_TextChanged" runat="server" TextMode="Number"></asp:TextBox>
                            ...
                            <div class="modal-content m-b-10">
                                <div class="modal-body m-b-p-10">
                                    ...
                                    <div class="col-sm-4 p-r-0"  style=" float: right;">
                                        ...
                                        <h5 class="modal-title sub-title m-b-5" style="font-size: 18px; border-bottom: none ;margin-bottom: 10px;">ตะกร้าสินค้า</h5>
                                        ...
                                        <asp:GridView ID="gvProductViewMedia" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="250px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox Style="width: 65px; text-align: right;" ID="txtAmount" AutoPostBack="True" min="0" max="99999" Text='<%# Eval("Amount") %>' OnTextChanged="txtAmountViewMedia_TextChanged" runat="server" TextMode="Number"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <h5 class="modal-title sub-title m-b-5" style="font-size: 18px; border-bottom: none" >สินค้า</h5>
                                 <table class="table-p-stand" style="width:100%">
                                  ...
                                  <div class="col-sm-12 text-center m-t-10 " style="pointer-events: auto;">
                        <!--<button type="button" class="button-active button-submit m-r-10 ">Add &nbsp; To &nbsp; Cart   </button>-->
                         <asp:Button ID="BtnAddtoCartMedia" CssClass="button-pri button-accept m-r-10" OnClick="BtnAddtoCartMedia_Click" Text="เพิ่มลงตระกร้า" runat="server"/>
                         <asp:Button ID="btnCloseAddtoCartMedia" runat="server" CssClass="button-pri button-cancel" Text="ปิด" OnClick="btnCloseAddtoCartMedia_Click" />
                      </div>
                            </div>
                        </ContentTemplate>
                       </asp:UpdatePanel>
    ...
    <div class="modal fade" id="modal-prpouploadfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" style="max-width: 1300px;">
            ...
            <div class="modal-content">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitle0" class="modal-title sub-title " style="font-size: 16px;">Upload PR&PO File</div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-block">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    <ContentTemplate>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Upload PR File</label>
                                            <div class="col-sm-4">
                                                <input type="file" name="PRFileUpload" multiple runat="server" />
                                            </div>
                                                                                        
                                            <label class="col-sm-2 col-form-label">Upload PO File</label>
                                            <div class="col-sm-4">
                                                <input type="file" name="POFileUpload" multiple runat="server" />
                                            </div>
                                        </div>
                                ...
                                <div class="text-center m-t-20 center">
                                    <asp:Button ID="POUploadFileUpload" Text="Upload" class="button-pri button-accept m-r-10" runat="server" OnClick="PRPOUploadFileUpload_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
