...
{
    public partial class FFOrderChangeStatus : System.Web.UI.Page
    {
        ...
        protected string GetLink(object objCode,object InventCode)
        {
            ...
            return "<a href=\"../FullfillmentOrderManagement/FFOrderChangeStatusDetail.aspx?inventorycode=" + StrInventCode + "&OrderCode=" + strCode + "\">" + strCode + "</a>";
        }
        ...
        protected Boolean ValidateSearch()
        {
            ...
            {
                flag = false;
                lblSearchDeliverDate_NoAnswerOrder.Text = MessageConst._MSG_PLEASEINSERT + " วันที่จัดส่งเท่านั้น";
            }
            return flag;
        }
