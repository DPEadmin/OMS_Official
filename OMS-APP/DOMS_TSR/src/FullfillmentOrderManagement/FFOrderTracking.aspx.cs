...
{
    public partial class FFOrderTracking : System.Web.UI.Page
    {
        ...
        protected string GetLink(object objCode,object InventCode)
        {
            ...
            return "<a href=\"../FullfillmentOrderManagement/FFOrderTrackingDetail.aspx?inventorycode=" + StrInventCode + "&OrderCode=" + strCode + "\">" + strCode + "</a>";
        }
