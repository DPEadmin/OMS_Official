<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="FFChangeGroupOrderStatus_GPQC.aspx.cs" Inherits="DOMS_TSR.src.FullfillmentOrderManagement.FFChangeGroupOrderStatus_GPQC" %>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-group">
                                        ...
                                        <div id="listcard1" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                  <img src="../../Image/icon/waiting-list.svg" width="20px" />
                                                </div>
                                ...
                                <div class="card" id="cardex2" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable2" ID="showSection_Setup" OnClick="showSection_Setup_Click" runat="server">
                                        <div id="listcard2" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                  <img src="../../Image/icon/clipboard.svg" width="20px" />
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                                ...
                                <div class="card" id="cardex4" runat="server" visible="false">
                                 ...
                                 <div class="card" id="Div5" runat="server" visible="false">
                                    <asp:LinkButton CssClass="btn-8bar-disable" ID="LinkButton3" title="Hello World!" OnClick="showSection_Distribute_Click" runat="server">
                                    ...
                                    <div class="card" id="Div7" runat="server" visible="false">
                                    <asp:LinkButton CssClass="btn-8bar-disable" ID="LinkButton4" title="Hello World!" OnClick="showSection_Distribute_Click" runat="server">
                                ...
                                <div class="card" id="cardex5" runat="server" visible="false">
                                ...
                                <div class="card" id="cardex8" runat="server" visible="false">
                                    ...
                                    <asp:LinkButton CssClass="btn-8bar-disable5" ID="LinkButton1" OnClick="showSection_FinishDeli_Click" runat="server">
                                ...
                                <div class="card" id="Div3" runat="server" visible="false">
                                    <asp:LinkButton CssClass="btn-8bar-disable2" ID="LinkButton2" OnClick="showSection_Setup_Click" runat="server">
                            ...
                            <div class="card-body">
                                ...
                                <asp:Button CssClass="button-pri button-print  m-b-10" ID="Button4" OnClick="btnAcceptOrder_ReadyDeli_Click" runat="server" Text="อัพเดท" OnClientClick="return ApproveConfirmGVDistri();" />
