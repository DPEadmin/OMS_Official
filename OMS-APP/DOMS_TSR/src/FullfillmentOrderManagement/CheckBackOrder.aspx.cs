...
{
    public partial class CheckBackOrder : System.Web.UI.Page
    {
        ...
        protected Boolean Changestatus_NoAnswerOrder()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstate = StaticField.OrderState_12, Confirmno =conNo.ToString() }); 
                }
            }
        ...
        protected string GetLink(object objCode)
        {
            ...
            return "<a href=\"../FullfillmentOrderManagement/CheckBackOrderDetail.aspx?OrderCode=" + strCode + "\">" + strCode + "</a>";
        }
