<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="FFOrderChangeInventory.aspx.cs" Inherits="DOMS_TSR.src.FullfillmentOrderManagement.FFOrderChangeInventory" %>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="input-group mb-0">
                                                        ...
                                                        <asp:Label ID="txtSearchDeliverDateva_NoAnswerOrder" runat="server" CssClass="validatecolor"></asp:Label>
                                                </div>
                                ...
                                <div class="card-group">
                                            ...
                                            <div id="listcard1" runat="server">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-left">
                                                        <p class=" m-0">Order Change Inventory</p>
                                                    </div>
                                    ...
                                    <div class="card-block p-t-5">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_NoAnswerOrder" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="Approve order" Visible="false" OnClientClick="return ApproveConfirmGV();" />

                                            <asp:Button CssClass="button-pri button-delete" ID="btnCancelOrder_NoAnswerOrder"  runat="server" Text="Reject order"  OnClick="btnCancelOrder_NoAnswerOrder_Click" Visible="false" OnClientClick="return DeleteConfirmGV();" />
                                            ...
                                            <asp:Panel ID="Panel_NoAnswerOrder" runat="server" Style="overflow-x: scroll;">
                                                <asp:GridView ID="gvOrder_NoAnswerOrder" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="false">
                                                            <HeaderTemplate>
                                                                <center>
