<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="FFChangeGroupOrderStatus.aspx.cs" Inherits="DOMS_TSR.src.FullfillmentOrderManagement.FFChangeGroupOrderStatus" %>
                            ...
                            <div class="card-body">
                                ...
                                <div id="searchSection_Setup" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName_Setup" class="form-control" placeholder="First Name" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchLName_Setup" class="form-control" placeholder="Last Name" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="searchSection_ReadyDeli" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateFrom_ReadyDeli" class="form-control" placeholder="Start" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil_ReadyDeli" class="form-control" placeholder="To" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName_ReadyDeli" class="form-control" placeholder="First Name" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchLName_ReadyDeli" class="form-control" placeholder="Last name" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateFrom_FinishDeli" class="form-control" placeholder="Start" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil_FinishDeli" class="form-control" placeholder="To" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="Section_Distribute" runat="server">
                                    <div>
                                        <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_Distribute" OnClick="btnAcceptOrder_Distribute_Click"   runat="server" Text="Update Status"  OnClientClick="return ApproveConfirmGVDistri();" />
                                    </div>
                                ...
                                <div id="Section_Setup" runat="server">
                                    <div>
                                        <asp:Button CssClass="button-pri button-print  m-b-10" ID="Button1" OnClick="btnAcceptOrder_Setup_Click" runat="server" Text="อัพเดทสถานะ" OnClientClick="return ApproveConfirmGVDistri();" />
                                    </div>
                                ...
                                <div id="Section_ReadyDeli" runat="server">
                                     <div>
                                        <asp:Button CssClass="button-pri button-print  m-b-10" ID="Button2" OnClick="btnAcceptOrder_ReadyDeli_Click" runat="server" Text="อัพเดทสถานะ" OnClientClick="return ApproveConfirmGVDistri();" />
                                    </div>
