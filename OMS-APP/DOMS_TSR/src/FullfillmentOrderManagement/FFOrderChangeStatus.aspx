<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="FFOrderChangeStatus.aspx.cs" Inherits="DOMS_TSR.src.FullfillmentOrderManagement.FFOrderChangeStatus" %>
                                ...
                                <div class="card-group">
                                            ...
                                            <div id="listcard1" runat="server">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-left">
                                                        <p class=" m-0">Order waiting approve</p>
                                                    </div>
                                    ...
                                    <div class="card-block p-t-5">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_NoAnswerOrder" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="อนุมัติใบสั่งขาย" Visible="false" OnClientClick="return ApproveConfirmGV();" />

                                            <asp:Button CssClass="button-pri button-delete" ID="btnCancelOrder_NoAnswerOrder"  runat="server" Text="ไม่อนุมิใบสั่งขาย"  OnClick="btnCancelOrder_NoAnswerOrder_Click" Visible="false" OnClientClick="return DeleteConfirmGV();" />
