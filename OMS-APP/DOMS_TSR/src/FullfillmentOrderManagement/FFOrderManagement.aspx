<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="FFOrderManagement.aspx.cs" Inherits="DOMS_TSR.src.FullfillmentOrderManagement.FFOrderManagement" %>
                            ...
                            <div class="card-body">
                                <div id="searchSection_All" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName" class="form-control" placeholder="First name" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchLName" class="form-control" placeholder="Last name" runat="server"></asp:TextBox>
                                            </div>
                                ...
                                <div id="searchSection_Cooking" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateFrom_Cooking" class="form-control" placeholder="Start" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil_Cooking" class="form-control" placeholder="To" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label">sales order status</label>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlSearchOrderState_Cooking" runat="server" class="form-control"></asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Cooking" Text="Search" OnClick="btnSearch_Click_Cooking"
                                        class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Cooking" Text="Clear" OnClick="btnClearSearch_Click_Cooking"
                                ...
                                <div id="searchSection_Cooked" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateFrom_Cooked" class="form-control" placeholder="Start" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil_Cooked" class="form-control" placeholder="To" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label">sales order status</label>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlSearchOrderState_Cooked" runat="server" class="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        ...
                                        class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Cooked" Text="Clear" OnClick="btnClearSearch_Click_Cooked"
                                        class="button-pri button-cancel "
                                            runat="server" />
                                    </div>
                                ...
                                <div id="searchSection_Delivering" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateFrom_Delivering" class="form-control" placeholder="Start" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil_Delivering" class="form-control" placeholder="To" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName_Delivering" class="form-control" placeholder="First Name" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchLName_Delivering" class="form-control" placeholder="Last Name" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label">sales order status</label>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlSearchOrderState_Delivering" runat="server" class="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Delivering" Text="Search" OnClick="btnSearch_Click_Delivering"
                                        class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Delivering" Text="Clear" OnClick="btnClearSearch_Click_Delivering"
                                        class="button-pri button-cancel "
                                            runat="server" />
                                    </div>
                                </div>
                                <div id="searchSection_Delivered" runat="server">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName_Delivered" class="form-control" placeholder="First Name" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchLName_Delivered" class="form-control" placeholder="Last Name" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label">sales order status</label>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlSearchOrderState_Delivered" runat="server" class="form-control"></asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Delivered" Text="Search" OnClick="btnSearch_Click_Delivered"
                                        class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Delivered" Text="Clear" OnClick="btnClearSearch_Click_Delivered"
                                        class="button-pri button-cancel "
                                            runat="server" />
                                    </div>
                                ...
                                <div class="card" id="cardex6" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable6" ID="showSection_Delivering" OnClick="showSection_Delivering_Click" runat="server">
                                        ...
                                        <div id="listcard6" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                    <i class="fi flaticon-truck  fw text-c-blue fi-3x"></i>
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                                ...
                                <div class="card" id="cardex7" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable7" ID="showSection_Delivered" OnClick="showSection_Delivered_Click" runat="server">
                                        ...
                                        <div id="listcard7" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                    <i class="fi flaticon-truck-1 fw text-c-blue fi-3x"></i>
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                            ...
                            <div class="card-body">
                                ...
                                <div id="Section_Cooking" runat="server">
                                    <asp:Panel ID="Panel_Cooking" runat="server" Style="overflow-x: scroll;">
                                        <asp:GridView ID="gvOrder_Cooking" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOrderRejectRemark_Cooking" Text='<%# DataBinder.Eval(Container.DataItem, "OrderNote")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <td width="100%" align="right" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 8.5pt;">
                                                            Page
                                                            <asp:DropDownList ID="ddlPage_Cooking" CssClass="textbox" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPage_SelectedIndexChanged_Cooking"></asp:DropDownList>
                                                            of
                                        ...
                                        <asp:GridView ID="gvOrder_Cooked" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOrderRejectRemark_Cooked" Text='<%# DataBinder.Eval(Container.DataItem, "OrderNote")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <td width="100%" align="right" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 8.5pt;">
                                                            Page
                                                            <asp:DropDownList ID="ddlPage_Cooked" CssClass="textbox" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPage_SelectedIndexChanged_Cooked"></asp:DropDownList>
                                                            of
                                        ...
                                        <asp:GridView ID="gvOrder_Delivering" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOrderRejectRemark_Delivering" Text='<%# DataBinder.Eval(Container.DataItem, "OrderNote")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <td width="100%" align="right" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 8.5pt;">
                                                            Page
                                                            <asp:DropDownList ID="ddlPage_Delivering" CssClass="textbox" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPage_SelectedIndexChanged_Delivering"></asp:DropDownList>
                                                            of
                                        ...
                                        <asp:GridView ID="gvOrder_Delivered" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                           ...
                                           <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOrderRejectRemark_Delivered" Text='<%# DataBinder.Eval(Container.DataItem, "OrderNote")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <td width="100%" align="right" valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 8.5pt;">
                                                            Page
                                                            <asp:DropDownList ID="ddlPage_Delivered" CssClass="textbox" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPage_SelectedIndexChanged_Delivered"></asp:DropDownList>
                                                            of
