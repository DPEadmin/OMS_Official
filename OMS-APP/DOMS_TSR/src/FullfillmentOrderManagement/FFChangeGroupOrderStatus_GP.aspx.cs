...
{
    public partial class FFChangeGroupOrderStatus_GP : System.Web.UI.Page
    {
        ...
        {
            btnSecondary();
            showSection_Distribute.CssClass = "btn btn-primary h-120";
        ...
        {
            btnSecondary();
            showSection_Setup.CssClass = "btn btn-primary h-120";
        ...
        {
            btnSecondary();
            showSection_ReadyDeli.CssClass = "btn btn-primary h-120";
        ...
        {
            btnSecondary();
            showSection_FinishDeli.CssClass = "btn btn-primary h-120";
        ...
        public void btnSecondary()
        {
            ...
            else { showSection_Distribute.CssClass = "btn-8bar-disable  h-120"; }

            if (check_Setup == true) { }
            else { showSection_Setup.CssClass = "  btn-8bar-disable2 h-120"; }

            if (check_ReadyDeli == true) { }
            else { showSection_ReadyDeli.CssClass = "btn-8bar-disable4 h-120"; }

            if (check_FinishDeli == true) { }
            else { showSection_FinishDeli.CssClass = "btn-8bar-disable5 h-120"; }
