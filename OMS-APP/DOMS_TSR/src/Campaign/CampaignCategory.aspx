                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">Search  Brand information</div>
                            </div>
                            <div class="card-block">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Brand code</label>
                                    <div class="col-sm-3">
                                            ...
                                            <asp:CheckBox ID="chkProductAll" OnCheckedChanged="chkProductAll_Change" AutoPostBack="true" runat="server"  />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowProduct" Style="float: none; border-radius: 5px; padding: 3px 10px; padding-top: 5px;"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px;">Add brand</div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-block">
                                <asp:UpdatePanel ID="upModal" runat="server">
                                    <ContentTemplate>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Brand Code<span style="color: red; background-position: right top;">*</span></label>
                                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input name="photo" type="file" accept="image/*" onchange="document.getElementById('<%= CampaignPicIm.ClientID %>').src = window.URL.createObjectURL(this.files[0])">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <img src="1" runat="server" id="CampaignPicIm" style="height: 100%; width: 100%; object-fit: contain" alt="">
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
