              ...
              <div class="col-sm-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="sub-title ">Campaign details
                    </div>
                  </div>
                                                ...
                                                <table class="table-detail m-0" style="width:100%">
                                                  ...
                                                  <div class="col-lg-12 col-xl-12 col-sm-12">     
                                                        <div class="text-center m-t-20 col-sm-12 ">
                                                            <asp:Button ID="btnBackLink" runat="server" Text="Back" class="button-pri button-accept" onclientclick='redirect();' />
                  ...
                  <div class="card">
        <div class="card-header">
          <div class="sub-title" >Search Promotion</div>
        </div>
        <div class="card-block">  
         <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            ...
            <div class="form-group row">
              ...
              <label class="col-sm-2 col-form-label">Promotion (start)</label>
              <div class="col-sm-4">
                  <asp:TextBox ID="txtPromotionStartDate" runat="server" class="form-control" />
                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtPromotionStartDate" 
                                        PopupButtonID="Image2">
                                    </ajaxToolkit:CalendarExtender>           
              </div>

                <label class="col-sm-2 col-form-label">Promotion (end)</label>
              <div class="col-sm-4">
                <asp:TextBox ID="txtSearchPromotionEndDate" runat="server" class="form-control" />
              ...
              <div class="text-center m-t-20 col-sm-12">
                  <asp:Button ID="btnSearch" Text="Search" OnClick="btnSearchCampaignPromotion_Click"
                      class="button-pri button-accept m-r-10" 
                      runat="server" />
                     <asp:Button ID="btnClearSearch" Text="Clear" OnClick="btnClearSearchCampaignPromotion_Click"
   ...
   <div class="card-block">
       ...
       <div class="m-b-10">
                 ...
                 <asp:LinkButton ID="btnDelete" OnClick="btnDelete_Click" OnClientClick="return DeleteConfirm();"    
                      class="button-action button-delete m-r-5"    runat="server" ><i class="fa fa-minus m-r-5"></i>Delete</asp:LinkButton>
                      ...
                      <asp:GridView ID="gvCampaignPromotion" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left" ItemStyle-Width="15%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                        <div align="Center">Promotion (start)</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                        <div align="Center">Promotion (end)</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="modal-header modal-header2   ">
                                                <div class="col-sm-12 p-0">
                                                    <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px; ">Add promotion</div>
...
<asp:UpdatePanel ID="UpdatePanel4" runat="server">
           ...
           <div class="modal-body">
            ...
            <div class="form-group row ">
              ...
              <label class="col-sm-2 col-form-label">Promotion (start)</label>
              <div class="col-sm-4">
                  <asp:TextBox ID="txtSearchPromotionStartDategvAdd"  class="form-control" runat="server"   />
                ...
                <label class="col-sm-2 col-form-label">Promotion (end)</label>
              <div class="col-sm-4">
                <asp:TextBox ID="txtSearchPromotionEndDategvAdd" runat="server"  class="form-control" />
          ...
          <div class="m-b-10">
              ...
              <asp:Label ID="lblsample" runat="server"></asp:Label>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                ...
                                <td width="100%" align="right" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                        <tr>
                                            ...
                                            <td style="width: 12px"></td>
                                            <td>
                                                <asp:Button ID="linkbtnPromoFirst" CssClass="Button pagina_btn" ToolTip="PromoFirst" CommandName="PromoFirst"
                                                    Text="<<" runat="server" OnCommand="GetPromoPageIndex"></asp:Button>
                                            </td>
                                            <td style="width: 6px"></td>
                                            <td>
                                                <asp:Button ID="linkbtnPromoPre" CssClass="Button pagina_btn" ToolTip="PromoPrevious" CommandName="PromoPrevious"
                                                    Text="<" runat="server" OnCommand="GetPromoPageIndex"></asp:Button>
                                            </td>
                                            <td style="width: 6px"></td>
                                            <td style="font-size: 8.5pt;">Page
                                            ...
                                            <td style="width: 6px"></td>
                                            <td>
                                                <asp:Button ID="linkbtnPromoNext" CssClass="Button pagina_btn" ToolTip="PromoNext" runat="server" CommandName="PromoNext" Text=">" OnCommand="GetPromoPageIndex"></asp:Button>
                                            </td>
                                            <td style="width: 6px"></td>
                                            <td>
                                                <asp:Button ID="linkbtnPromoLast" CssClass="Button pagina_btn" ToolTip="PromoLast" runat="server" CommandName="PromoLast"
                      ...
                      <div class="modal-content">
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="modal-header modal-header2 ">
                                <div class="col-sm-12 p-0">
                                <div id="exampleModalLongTitle01" class="modal-title sub-title " style="font-size: 16px;">Promotion Detail
                                </div>
                              </div>
                              <span>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">  <ContentTemplate>
           <div class="modal-body">
                            ...
                            <asp:GridView ID="gvPromotionDetail" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    <HeaderTemplate>
                                        <div align="Right">price(bath)</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                     ...
                     <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowCampaign"
                            ...
                            <EmptyDataTemplate>
                                <center>
                                    <asp:Label ID="lblDataEmpty" class="fontBlack" runat="server" Text="ไม่พบข้อมูล"></asp:Label>
                                </center>
                            </EmptyDataTemplate>
                        </asp:GridView>    
