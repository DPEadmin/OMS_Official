            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="sub-title">Search campaign information</div>
                    </div>
                            ...
                            <ContentTemplate>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <asp:TextBox ID="txtSearchCampaignCode" class="form-control" runat="server">
                                        </asp:TextBox>
                                        ...
                                        <asp:HiddenField ID="hidMerchantCodeSess" runat="server" />
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <asp:TextBox ID="txtSearchCampaignName" class="form-control" runat="server">
                                        </asp:TextBox>
                                    </div>
              ...
              <div class="col-sm-4">
                     <asp:DropDownList ID="ddlSearchFlagShowProductPromotion" class="form-control" runat="server">
                        ...
                        <%--            <label class="col-sm-2 col-form-label">แบรนด์</label>
                                    <div class="col-sm-4">
                                        <asp:DropDownList ID="ddlSearchCampaignCategory" runat="server"
                                            class="form-control"></asp:DropDownList>

                                    </div>--%>


                                    <label class="col-sm-2 col-form-label">Campaign type</label>
                                    <div class="col-sm-4">
                                         <asp:DropDownList ID="ddlSearchCampaignSpec" class="form-control" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                            ...
                                            <asp:ListItem Enabled="true" Text="Please select status" Value="-99">
                                            </asp:ListItem>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:LinkButton ID="btnAddCampaign" class="button-action button-add m-r-5"
                                        OnClick="btnAddCampaign_Click" runat="server"><i
                                            class="fa fa-plus m-r-5 "></i>Add</asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" OnClick="btnDelete_Click"
                                        OnClientClick="return DeleteConfirm();"
                                        class="button-action button-delete m-r-5" runat="server"><i
                                            class="fa fa-minus m-r-5"></i>Delete</asp:LinkButton>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvCampaign" runat="server" AutoGenerateColumns="False"
                                    ...
                                    OnRowCommand="gvCampaign_RowCommand" ShowHeaderWhenEmpty="true">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <HeaderTemplate>
                                                <center>
                                                    <asp:CheckBox ID="chkCampaignAll"
                                                        OnCheckedChanged="chkCampaignAll_Change" AutoPostBack="true"
                                                        runat="server" />
                                                </center>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="left" HeaderStyle-CssClass="TDHead"
                                            ItemStyle-CssClass="TDDetail">
                                            <HeaderTemplate>
                                                <div align="left">Campaign ID</div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <%# GetLink(DataBinder.Eval(Container.DataItem, "CampaignCode")) %>
                                                <%--&nbsp;&nbsp;<asp:Label ID="lblCampaignCode" Text='<%# DataBinder.Eval(Container.DataItem, "CampaignCode")%>'
                                                runat="server" />--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCampaignName"
                                                    Text='<%# DataBinder.Eval(Container.DataItem, "CampaignName")%>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblCampaignType" Text='<%# DataBinder.Eval(Container.DataItem, "CampaignType")%>'
                                        runat="server" />
                                        </ItemTemplate>
                                        </asp:TemplateField>--%>

                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="TDHead" Visible="false"
                                            ItemStyle-CssClass="TDDetail">
                                            <HeaderTemplate>
                                                <div align="left">Brand</div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCampainCategory"
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCampaignStatus"
                                                    Text='<%# DataBinder.Eval(Container.DataItem, "CAMPAIGNSTATUS")%>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblCampaignSpec"
                                                    Text='<%# DataBinder.Eval(Container.DataItem, "CampaignSpecValue")%>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                       <asp:Label ID="lblStartDate" Text='<%# ((null == Eval("StartDate"))||("" == Eval("StartDate"))) ? string.Empty : DateTime.Parse(Eval("StartDate").ToString()).ToString("dd/MM/yyyy") %>'
                                        runat="server" />
                                        </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblNotifyDate"
                                                    Text='<%# ((null == Eval("NotifyDate"))||("" == Eval("NotifyDate"))) ? string.Empty : DateTime.Parse(Eval("NotifyDate").ToString()).ToString("dd/MM/yyyy") %>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblExpireDate"
                                                    Text='<%# ((null == Eval("ExpireDate"))||("" == Eval("ExpireDate"))) ? string.Empty : DateTime.Parse(Eval("ExpireDate").ToString()).ToString("dd/MM/yyyy") %>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowCampaign"
                                                    CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"> <span
                                                        class="button-pri button-activity m-r-10 icofont icofont-ui-edit f-16"></span>
                                                </asp:LinkButton>

                                                <asp:HiddenField runat="server" ID="hidCampaignId"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "CampaignId")%>' />
                                                <asp:HiddenField runat="server" ID="hidCampaignCode"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "CampaignCode")%>' />
                                                <asp:HiddenField runat="server" ID="hidCampaignName"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "CampaignName")%>' />
                                                <asp:HiddenField runat="server" ID="hidCampaignCategory"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "CampaignCategory")%>' />
                                                <asp:HiddenField runat="server" ID="hidCampaignType"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "CampaignType")%>' />
                                                <asp:HiddenField runat="server" ID="hidCampaignSpec"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "CampaignSpec")%>' />
                                                <asp:HiddenField runat="server" ID="hidFlagComboSet"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "FlagComboSet")%>' />
                                                <asp:HiddenField runat="server" ID="hidFlagShowProductPromotion"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "FlagShowProductPromotion")%>' />
                                                <asp:HiddenField runat="server" ID="hidPictureCampaingUrl"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "PictureCampaignUrl")%>' />
                                                <asp:HiddenField runat="server" ID="hidActive"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "Active")%>' />
                                                <asp:HiddenField runat="server" ID="hidStartDate"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "StartDate")%>' />
                                                <asp:HiddenField runat="server" ID="hidNotifyDate"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "NotifyDate")%>' />
                                                <asp:HiddenField runat="server" ID="hidExpireDate"
                                                    Value='<%# DataBinder.Eval(Container.DataItem, "ExpireDate")%>' />
                                        ...
                                        <td width="100%" align="right" valign="top">
                                            <table border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="lnkbtnFirst" CssClass="Button" ToolTip="First"
                                                            CommandName="First" Text="<<" runat="server"
                                                            OnCommand="GetPageIndex"></asp:Button>
                                                    </td>
                                                    <td style="width: 6px"></td>
                                                    <td>
                                                        <asp:Button ID="lnkbtnPre" CssClass="Button" ToolTip="Previous"
                                                            CommandName="Previous" Text="<" runat="server"
                                                            OnCommand="GetPageIndex"></asp:Button>
                                                    </td>
                                                    <td style="width: 6px"></td>
                                                    <td style="font-size: 8.5pt;">Page
                                                        <asp:DropDownList ID="ddlPage" CssClass="textbox" runat="server"
                                                            AutoPostBack="True"
                                                    ...
                                                    <td style="width: 6px"></td>
                                                    <td>
                                                        <asp:Button ID="lnkbtnNext" CssClass="Button" ToolTip="Next"
                                                            runat="server" CommandName="Next" Text=">"
                                                            OnCommand="GetPageIndex"></asp:Button>
                                                    </td>
                                                    <td style="width: 6px"></td>
                                                    <td>
                                                        <asp:Button ID="lnkbtnLast" CssClass="Button" ToolTip="Last"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2    ">
                            ...
                            <span>
                                <button type="button" class="close  " style="padding-left: 0px; padding-right: 0px;"
                ...
                <div class="modal-body">
                                ...
                                <asp:UpdatePanel ID="UpModal" runat="server">
                                    <ContentTemplate>
                                       ...
                                       <%--     <label class="col-sm-2 col-form-label">แบรนด์<span
                                                    style="color: red; background-position: right top;">*</span></label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="ddlSearchCampaignCategory_Ins" runat="server"
                                                    class="form-control"></asp:DropDownList>
                                                <asp:Label ID="lblCampaignCategory_Ins" runat="server"
                                                    CssClass="validation"></asp:Label>
                                            </div>
                                          --%>
                                            <label class="col-sm-2 col-form-label">Campaign ID<span
                                                    style="color: red; background-position: right top;">*</span></label>
                                            <div class="col-sm-4">
                                                <asp:TextBox ID="txtCampaignCode_Ins" runat="server"
                                                    class="form-control"></asp:TextBox>
                                                <asp:Label ID="lblCampaignCode_Ins" runat="server"
                                                    CssClass="validation"></asp:Label>
                                        ...
                                        <div class="col-sm-1">
                                            ...
                                            <label class="col-sm-2 col-form-label">Campaign name<span
                                                    style="color: red; background-position: right top;">*</span></label>
                                            <div class="col-sm-4">
                                                <asp:TextBox ID="txtCampaignName_Ins" runat="server"
                                                    class="form-control"></asp:TextBox>
                                                <asp:Label ID="lblCampaignName_Ins" runat="server"
                                                    CssClass="validation"></asp:Label>
                                            </div>
                                             <label class="col-sm-2 col-form-label">Campaign type<span
                                                    style="color: red; background-position: right top;">*</span></label>
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="ddlCampaingnSpec_Ins" class="form-control"
                                                    runat="server"></asp:DropDownList>
                                                <asp:Label ID="lblCampaignSpec_Ins" runat="server"
                                                    CssClass="validation"></asp:Label>
                                            </div>
                                            <!-- <label class="col-sm-1 col-form-label"></label>
                                        ...
                                        <asp:ListItem Text="Product" Value="PRODUCT"></asp:ListItem>
                                                ...
                                                <asp:DropDownList ID="ddlActive_Ins" class="form-control"
                                                    runat="server">
                                                    <asp:ListItem Enabled="true" Text="Please select status" Value="-99">
                                                    </asp:ListItem>
                                                    <asp:ListItem Text="Active" Value="Y"></asp:ListItem>
                                                ...
                                                <asp:Label ID="lblActive_Ins" runat="server" CssClass="validation">
                                                </asp:Label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="photo" type="file" accept="image/*"
                                            onchange="document.getElementById('<%= CampaignPicIm.ClientID %>').src = window.URL.createObjectURL(this.files[0])">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                            <ContentTemplate>
                                                <img src="1" runat="server" id="CampaignPicIm"
