...
{
    public partial class OrderIncompleteBackOrder : System.Web.UI.Page
    {
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            using (var wb = new WebClient())
            {
                ...
                data["OrderStatusCode"] = StaticField.OrderStatus_01; 
                 data["GroupOrderStateCode"] = StaticField.OrderState_12 + "," + StaticField.OrderState_14; 
                data["ConfirmNo"] = "NULL";
        ...
        protected Boolean Changestatus_NoAnswerOrder()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstate = "02", Confirmno =conNo.ToString() });
                }
            }
        ...
        protected Boolean Changestatus_NoAnswerOrderforCancel()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstatus = "06",orderstate = "04" });
                }
            }
        ...
        protected Boolean Changestatus_NoAnswerOrderforBackOrder()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstatus = "02", orderstate = "12" });
                }
            }
        ...
        protected string GetLink(object objCode)
        {
            ...
            return "<a href=\"../FullfillOrderlist/OrderIncompleteBackOrderDetail.aspx?OrderCode=" + strCode + "\">" + strCode + "</a>";
        }
