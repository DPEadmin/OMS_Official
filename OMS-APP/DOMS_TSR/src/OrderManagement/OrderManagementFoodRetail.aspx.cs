...
{
    public partial class OrderManagementFoodRetail : System.Web.UI.Page
    {
        ...
        protected void chkAll_Change_NewOrder(object sender, EventArgs e)
        {
            for (int i = 0; i < gvOrder_NewOrder.Rows.Count; i++)
            {
                ...
                CheckBox chk_NewOrder = (CheckBox)gvOrder_NewOrder.Rows[i].FindControl("chk_NewOrder");
        ...
        protected void chkAll_Change_Cooking(object sender, EventArgs e)
        {
            for (int i = 0; i < gvOrder_Cooking.Rows.Count; i++)
            {
                ...
                CheckBox chk_Cooking = (CheckBox)gvOrder_Cooking.Rows[i].FindControl("chk_Cooking");

                if (chkall.Checked == true)
                {
                    chk_Cooking.Checked = true;
                }
                else
                {
                    chk_Cooking.Checked = false;
                }
        ...
        protected void chkAll_Change_Cooked(object sender, EventArgs e)
        {
            for (int i = 0; i < gvOrder_Cooked.Rows.Count; i++)
            {

                CheckBox chkall = (CheckBox)gvOrder_Cooked.HeaderRow.FindControl("chkAll_Cooked");
                CheckBox chk_Cooked = (CheckBox)gvOrder_Cooked.Rows[i].FindControl("chk_Cooked");

                if (chkall.Checked == true)
                {
                    chk_Cooked.Checked = true;
                }
                else
                {
                    chk_Cooked.Checked = false;
                }
        ...
        protected void chkAll_Change_Delivering(object sender, EventArgs e)
        {
            for (int i = 0; i < gvOrder_Delivering.Rows.Count; i++)
            {

                CheckBox chkall = (CheckBox)gvOrder_Delivering.HeaderRow.FindControl("chkAll_Delivering");
                CheckBox chk_Delivering = (CheckBox)gvOrder_Delivering.Rows[i].FindControl("chk_Delivering");

                if (chkall.Checked == true)
                {
                    chk_Delivering.Checked = true;
                }
                else
                {
                    chk_Delivering.Checked = false;
                }
        ...
        protected void chkAll_Change_OrderChanged(object sender, EventArgs e)
        {
            for (int i = 0; i < gvOrder_OrderChanged.Rows.Count; i++)
            {
                ...
                CheckBox chk_OrderChanged = (CheckBox)gvOrder_OrderChanged.Rows[i].FindControl("chk_OrderChanged");

                if (chkall.Checked == true)
                {
                    chk_OrderChanged.Checked = true;
                }
                else
                {
                    chk_OrderChanged.Checked = false;
                }
