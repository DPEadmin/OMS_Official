...
{
    public partial class OrderHistoryTakeOrder : System.Web.UI.Page
    {
        ...
        protected void gvOrderHistory_OnRowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "ShowOrderDetail")
            {
                ...
                GetOrderListByCriteria(hidOrderCodeHistory.Value);
            }            
        }
        ...
        #region function
        protected void LoadsumOrderDetail(Decimal? TransportPrice,string ordercode)
        {
            List<OrderDetailInfo> lOrderDetailInfo = new List<OrderDetailInfo>();

            lOrderDetailInfo = GetsumOrderDetail(ordercode);
        ...
        public List<OrderDetailInfo> GetsumOrderDetail(string ordercode)
        {
            string respstr = "";
        ...
        public List<OrderInfo> GetOrderListByCriteria(string ordercode)
        {
            string respstr = "";
            ...
            LoadsumOrderDetail(lOrderInfo[0].TransportPrice, ordercode);
        ...
        protected void gvOrderHistory_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.RowIndex == 0)
                {
                    ...
                    lblTotalPrice.Text = string.Format("{0:n}", (lblTotalPrice.Text));
                }
            }
        }
