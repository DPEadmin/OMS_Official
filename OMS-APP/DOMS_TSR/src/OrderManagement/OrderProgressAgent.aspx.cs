...
{
    public partial class OrderProgressAgent : System.Web.UI.Page
    {
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            using (var wb = new WebClient())
            {
                ...
                data["CreateBy"] = hidEmpCode.Value.ToString();
        ...
        protected Boolean Changestatus_NoAnswerOrder()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstatus="10" ,orderstate = "02", Confirmno =conNo.ToString() });
                }
            }
        ...
        protected Boolean Changestatus_NoAnswerOrderforCancel()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstatus = "06",orderstate = "04", Confirmno = conNo.ToString() });
                }
            }
