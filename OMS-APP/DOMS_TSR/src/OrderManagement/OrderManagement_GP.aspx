<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="OrderManagement_GP.aspx.cs" Inherits="DOMS_TSR.src.OrderManagement.OrderManagement_GP" %>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header border-0">
                                <div class="sub-title">ค้นหาข้อมูลใบสั่งขาย</div>
                            </div>
                            ...
                            <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group mb-0">
                                                    ...
                                                    placeholder="ตั้งแต่" runat="server" AutoCompleteType="Disabled">
                                                </asp:TextBox>
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil" class="form-control"
                                                    placeholder="ถึง" runat="server" AutoCompleteType="Disabled">
                                                </asp:TextBox>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName" class="form-control" placeholder="ชื่อ"
                                                    runat="server"></asp:TextBox>
                                                <asp:Label ID="lblSearchFName" runat="server" CssClass="validatecolor"></asp:Label>

                                                <asp:TextBox ID="txtSearchLName" class="form-control"
                                                    placeholder="นามสกุล" runat="server"></asp:TextBox>

                                            </div>
                                            <asp:Label ID="lblSearchLName" runat="server" CssClass="validatecolor"></asp:Label>
                                        </div>

                                        <label class="col-sm-2 col-form-label">เบอร์ติดต่อ</label>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtSearchContact" class="form-control" runat="server" onkeypress="return validatenumerics(event);">
                                            </asp:TextBox>
                                        ...
                                        <label class="col-sm-2 col-form-label">สถานะจัดส่ง</label>
                                        <div class="col-sm-4">
                                ...
                                <div id="searchSection_NewOrder" runat="server">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchFName_NewOrder" class="form-control"
                                                    placeholder="ชื่อ" runat="server"></asp:TextBox>
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_NewOrder" Text="ค้นหา"
                                            OnClick="btnSearch_Click_NewOrder" class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_NewOrder" Text="ล้าง"
                                ...
                                <div id="searchSection_Cooking" runat="server">
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Cooking" Text="ค้นหา"
                                            OnClick="btnSearch_Click_Cooking" class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Cooking" Text="ล้าง"
                                ...
                                <div id="searchSection_Cooked" runat="server">
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Cooked" Text="ค้นหา" OnClick="btnSearch_Click_Cooked"
                                            class="button-pri button-accept m-r-10" runat="server" />
                                        <asp:Button ID="btnClearSearch_Cooked" Text="ล้าง"
                                ...
                                <div id="searchSection_Delivering" runat="server">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateUntil_Delivering"
                                                    class="form-control" placeholder="ถึง" runat="server"
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Delivering" Text="ค้นหา"
                                            OnClick="btnSearch_Click_Delivering" class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Delivering" Text="ล้าง"
                                ...
                                <div id="searchSection_Delivered" runat="server">
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_Delivered" Text="ค้นหา"
                                            OnClick="btnSearch_Click_Delivered" class="button-pri button-accept m-r-10"
                                            runat="server" />
                                        <asp:Button ID="btnClearSearch_Delivered" Text="ล้าง"
                                ...
                                <div id="searchSection_OrderCancelled" runat="server">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchOrderDateFrom_OrderCancelled"
                                                    class="form-control" placeholder="ตั้งแต่" runat="server"
                                                    AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_OrderCancelled" Text="ค้นหา"
                                            OnClick="btnSearch_Click_OrderCancelled"
                                            class="button-pri button-accept m-r-10" runat="server" />
                                        <asp:Button ID="btnClearSearch_OrderCancelled" Text="ล้าง"
                        ...
                        <div class="card">
                            <div class="card-group">
                                <div class="card" id="cardex1" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable   h-120" ID="showSection_All"
                                         OnClick="showSection_All_Click" runat="server">
                                        <div id="listcard1" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                    <img src="../../Image/icon/all.svg" width="20px" />
                                ...
                                <div class="card" id="cardex2" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable2  h-120" ID="showSection_NewOrder"
                                        OnClick="showSection_NewOrder_Click" runat="server">
                                        <div id="listcard2" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                      <img src="../../Image/icon/bill.svg" width="20px" />
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                                ...
                                <div class="card" id="cardex4" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable4  h-120" ID="showSection_Cooking"
                                        OnClick="showSection_Cooking_Click" runat="server">
                                        <div id="listcard4" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                              <img src="../../Image/icon/box (1).svg" width="20px" />
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                                ...
                                <div class="card" id="cardex5" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable5  h-120" ID="showSection_Cooked"
                                ...
                                <div class="card" id="cardex6" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable6  h-120" ID="showSection_Delivering"
                                        OnClick="showSection_Delivering_Click" runat="server">

                                        <div id="listcard6" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                       <img src="../../Image/icon/delivery.svg" width="20px" />
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                                ...
                                <div class="card" id="cardex7" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable8  h-120" ID="showSection_Delivered"
                                ...
                                <div class="card" id="cardex8" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable8  h-120" ID="showSection_OrderCancelled"
                                ...
                                <div class="card" id="Div1" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable8  h-120" ID="LinkButton1"
                                        OnClick="showSection_OrderCancelled_Click" runat="server">
                                        ...
                                        <div id="Div2" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                    ...
                                                    <img src="../../Image/icon/back-in-store.svg" width="20px" />
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 class="text-c-blue">
                                ...
                                <div class="card" id="Div3" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable8  h-120" ID="LinkButton2"
                                        OnClick="showSection_OrderCancelled_Click" runat="server">
                                        ...
                                        <div id="Div4" runat="server">
                                            <div class="row">
                                                <div class="col-3 text-left p-b-15">
                                                    ...
                                                    <img src="../../Image/icon/file.svg" width="20px" />
                                                </div>
                                                <div class="col-9 text-right">
                                                    <h3 >
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 text-left">
                                                    <p class=" m-0">พัสดุสูญหายและเสียหาย</p>
                                                </div>
                                ...
                                <div class="card" id="Div5" runat="server">
                                    <asp:LinkButton CssClass="btn-8bar-disable8  h-120" ID="LinkButton3"
                                        OnClick="showSection_OrderCancelled_Click" runat="server">
                                        ...
                                        <div id="Div6" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 text-left">
                                                    <p class=" m-0">จัดส่งสำเร็จแล้ว</p>
                                                </div>
