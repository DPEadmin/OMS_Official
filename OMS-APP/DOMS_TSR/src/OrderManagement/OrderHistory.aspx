<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/src/MasterPage/Web.Master" CodeBehind="OrderHistory.aspx.cs" Inherits="DOMS_TSR.src.OrderManagement.OrderHistory" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                          ...
                          table-striped table-bordered nowrap"
                                    OnRowCommand="gvOrderHistory_OnRowCommand"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="modal-header modal-header2 ">
                                                        <div class="col-sm-11">
                                                            <div id="exampleModalLongTitle" runat="server">
                                                      ...
                                                      <table class="table m-0">
                                                          <tbody>
                                                              <tr>
                                                                  ...
                                                                  <td><asp:Label runat="server" ID="lblProductCode"></asp:Label></td>
                                                              </tr>
                                                              <tr>
                                                                  <th scope="row">ชื่อร้านค้า</th>
                                                                  <td><asp:Label runat="server" ID="lblMerchantName"></asp:Label>
                                                                  </td>                
                                                              </tr>   
                                                              <tr>
                                                                  <th scope="row">หน่วย</th>
                                                                  <td><asp:Label runat="server" ID="lblUnitNameName"></asp:Label>
                                                                  </td>                
                                                              </tr>
                                                              <tr>
                                                                  <th scope="row">ส่วนลด(บาท)</th>
                                                                  <td><asp:Label runat="server" ID="lblDiscountAmount"></asp:Label>
                                                                  </td>                
                                                              </tr>
                                                              <tr>
                                                                  <th scope="row">Net Price(Baht)
                                                                  </th>
                                                                  <td><asp:Label runat="server" ID="lblNetPrice"></asp:Label>
                                                                  </td>                
                                                              </tr>
                                                              <tr>
                                                                  <th scope="row">ราคารวม</th>
                                                                  <td><asp:Label runat="server" ID="lblTotalPrice"></asp:Label>
                                                                  </td>                
                                                              </tr>
                                                          </tbody>
                                                      </table>
                                                      ...
                                                      <table class="table m-0">
                                                          <tbody>
                                                              ...
                                                              <tr>
                                                                  ...
                                                                  <td><asp:Label runat="server" ID="lblPrice"></asp:Label>
                                                                  </td>
                                                              </tr>                                                             
                                                              <tr>
                                                                  <th scope="row">ส่วนลด(%) Discount(%)</th>
                                                                  <td><asp:Label runat="server" ID="lblDiscountPercent"></asp:Label>
                                                                  </td>
                                                              </tr>
                                                              <tr>
                                                                  <th scope="row">จำนวน</th>
                                                                  <td><asp:Label runat="server" ID="lblQuantity"></asp:Label>
                                                                  </td>
                                                              </tr>
                                                              <tr>
                                                                  <th scope="row"></th>
