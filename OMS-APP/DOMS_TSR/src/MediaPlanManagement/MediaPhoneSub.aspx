<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="MediaPhoneSub.aspx.cs" Inherits="DOMS_TSR.src.MediaPlanManagement.MediaPhoneSub" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        <ContentTemplate>
            ...
            <div class="page-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <%--<h5 style = "color:darkgrey">จัดการเบอร์โทรศัพท์ย่อย</h5>--%>
                        <!-- Basic Form Inputs card start -->
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">รายละเอียดข้อมูลเบอร์โทรศัพท์นำหมู่</div>
                            </div>
                            <div class="card-block">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">เบอร์โทรศัพท์นำหมู่</label>
                                
                                        <asp:Label ID="lblmediaphoneDis"   CssClass="col-sm-2 col-form-label" runat="server"> </asp:Label>           
                                   
                                    <label class="col-sm-1 col-form-label"></label>
                                    <label class="col-sm-1 col-form-label"></label>
                                    <label class="col-sm-2 col-form-label" >สถานะ</label>
                                  
                                           <asp:Label  ID="lblActiveDis"  CssClass="col-sm-2 col-form-label" runat="server"></asp:Label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">ค้นหาข้อมูลเบอร์โทรศัพท์ย่อย</div>
                            </div>
                            <div class="card-block">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">เบอร์โทรศัพท์ย่อย</label>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                ...
                                                <asp:LinkButton ID="btnAddMediaPhone" class="button-action button-add m-r-5"
                                                    OnClick="btnAddMediaPhone_Click" runat="server"><i class="fa fa-plus m-r-5"></i>เพิ่ม</asp:LinkButton>
                                            ...
                                            <asp:CheckBox ID="chkMediaPhoneAll" OnCheckedChanged="chkMediaPhoneAll_Change" AutoPostBack="true" runat="server"  />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">

                                                        <HeaderTemplate>

                                                            <div align="center">เบอร์โทรศัพท์ย่อย</div>

                                                        </HeaderTemplate>

                                                        <ItemTemplate>
                                                             <%--   <%# GetLink(DataBinder.Eval(Container.DataItem, "MediaPhoneNo")) %>--%>
                                                            <asp:Label ID="lblMediaPhoneNo" Text='<%# DataBinder.Eval(Container.DataItem, "MediaPhoneSubNo")%>' runat="server" />
                                           ...
                                           <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField runat="server" ID="HidMediaPhoneSubId" Value='<%# DataBinder.Eval(Container.DataItem, "MediaPhoneSubId")%>' />
                                                            <asp:HiddenField runat="server" ID="HidMediaPhoneNo" Value='<%# DataBinder.Eval(Container.DataItem, "MediaPhoneNo")%>' />
                                                            <asp:HiddenField runat="server" ID="HidMediaPhoneSubNo" Value='<%# DataBinder.Eval(Container.DataItem, "MediaPhoneSubNo")%>' />
                    ...
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2    ">
                            <div class="col-sm-12 p-0">
                                <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px;">เพิ่ม เบอร์โทรศัพท์ย่อย</div>
                    ...
                    <asp:UpdatePanel ID="UpModal" runat="server">
                        <ContentTemplate>
                            <div class="form-group row">
                                ...
                                <label class="col-sm-4 col-form-label">เบอร์โทรศัพท์ย่อย</label>
                                <div class="col-sm-8">
