...
{
    public partial class MediaPhoneSub : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                loadMediaPhoneSub();
                lblmediaphoneDis.Text = Request.QueryString["MediaPhoneCode"].ToString().Trim();
                lblActiveDis.Text = (Request.QueryString["Active"].ToString() != "Y") ? "Inactive" : "Active"; 
        ...
        protected void loadMediaPhoneSub()
        {
            List<MediaPhoneSubInfo> lMediaPhoneSubInfo = new List<MediaPhoneSubInfo>();
            ...
            lMediaPhoneSubInfo = GetMediaPhoneMasterByCriteria();

            gvMediaPhone.DataSource = lMediaPhoneSubInfo;
        ...
        public List<MediaPhoneSubInfo> GetMediaPhoneMasterByCriteria()
        {
           
            APIpath = APIUrl + "/api/support/ListMediaPhoneSubNoPagingByCriteria";
            MediaPhoneSubInfo mon = new MediaPhoneSubInfo();
            List<MediaPhoneSubInfo> lMediaPhoneSubInfo = new List<MediaPhoneSubInfo>();
            using (var client = new WebClient())
            {
                client.Headers[HttpRequestHeader.ContentType] = "application/json";
                client.Encoding = Encoding.UTF8;
                mon.MediaPhoneSubNo = txtMediaphoneNo.Text;
                mon.MediaPhoneNo = Request.QueryString["MediaPhoneCode"].ToString().Trim();
                ...
                lMediaPhoneSubInfo = JsonConvert.DeserializeObject<List<MediaPhoneSubInfo>>(dataString.ToString());
            }

            return lMediaPhoneSubInfo;
        ...
        public int? CountMediaPhoneMasterList()
        {
            ...
            int? cou = 0;
            APIpath = APIUrl + "/api/support/CountListMediaPhoneSub";
            MediaPhoneSubInfo mon = new MediaPhoneSubInfo();
            List<MediaPhoneSubInfo> lMediaPhoneSubInfo = new List<MediaPhoneSubInfo>();
            using (var client = new WebClient())
            {
        ...
        protected Boolean DeleteMediaPhone()
        {
            ...
            for (int i = 0; i < gvMediaPhone.Rows.Count; i++)
            {
                ...
                {
                    HiddenField hidId = (HiddenField)gvMediaPhone.Rows[i].FindControl("HidMediaPhoneSubId");
            ...
            if (Idlist != "")
            {
                ...
                APIpath = APIUrl + "/api/support/DeleteMediaPhoneSub";

                using (var wb = new WebClient())
                {
                    var data = new NameValueCollection();

                    data["MediaPhoneSubIdlist"] = Idlist;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    if (hidFlagInsert.Value == "True") //Insert
                    {
                        ...
                        {
                            int? sum = 0;
                            APIpath = APIUrl + "/api/support/InsertMediaPhoneSub";
                            MediaPhoneSubInfo mon = new MediaPhoneSubInfo();
                            List<MediaPhoneSubInfo> lMediaPhoneSubInfo = new List<MediaPhoneSubInfo>();
                            using (var client = new WebClient())
                            {
                                client.Headers[HttpRequestHeader.ContentType] = "application/json";
                                client.Encoding = Encoding.UTF8;
                                mon.MediaPhoneSubNo= txtMediaPhone_Ins.Text.Trim();
                                mon.MediaPhoneNo = Request.QueryString["MediaPhoneCode"].ToString().Trim();
                    ...
                    else //Update
                    {
                        ...
                        string respstr = "";
                        int? sumupdate = 0;
                        APIpath = APIUrl + "/api/support/UpdateMediaPhoneSub";
                        ...
                        using (var client = new WebClient())
                        {
                            ...
                            mon.UpdateBy = empInfo.EmpCode;
                            mon.MediaPhoneSubId = int.Parse(hidIdList.Value.ToString());
                            var jsonObj = JsonConvert.SerializeObject(new
                            {
                                mon.MediaPhoneSubNo,
                                mon.MediaPhoneNo,
        ...
        protected void gvMediaPhone_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            HiddenField HidMediaPhoneSubId = (HiddenField)row.FindControl("HidMediaPhoneSubId");
            HiddenField HidMediaPhoneSubNo = (HiddenField)row.FindControl("HidMediaPhoneSubNo");
            ...
            if (e.CommandName == "ShowMediaPhone")
            {
                ...
                txtMediaPhone_Ins.Text = HidMediaPhoneSubNo.Value;           
                hidIdList.Value = HidMediaPhoneSubId.Value;
        ...
        protected string GetLink(object objCode)
        {
            ...
            return "<a href=\"MediaPhoneDetail.aspx?MediaPhoneCode=" + strCode + "&MenuId=02\">" + strCode + "</a>";
        }
        ...
        protected string ValidateMediaID(string code)
        {
            ...
            {
                var data = new NameValueCollection();
                data["MediaPhoneSubCode"] = code;
                data["MediaPhoneNo"]  = Request.QueryString["MediaPhoneCode"].ToString().Trim();
        ...
        protected Boolean validateInsert()
        {
            ...
            mediaphonesub = ValidateMediaID(txtMediaPhone_Ins.Text);
            if (mediaphonesub == "[]" || mediaphonesub == "" || mediaphonesub == null)
            {
                flag = (flag == false) ? false : true;
                lblMediaPhone_Ins.Text = "";
            }
            ...
            {
                flag = false;
                lblMediaPhone_Ins.Text = "เบอร์โทรศัทพ์ย่อยนี้มีอยู่แล้ว";
            }
