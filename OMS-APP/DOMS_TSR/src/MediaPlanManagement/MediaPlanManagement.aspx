<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="MediaPlanManagement.aspx.cs" Inherits="DOMS_TSR.src.MediaPlanManagement.MediaPlanManagement" %>
...
<asp:Content ID="head" ContentPlaceHolderID="HeaderContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DeleteConfirm() {
            ...
            var grid = document.getElementById("<%= gvMediaOnAir.ClientID %>");
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">ค้นหาข้อมูล Media On Air</div>
                            </div>
                            <div class="card-block">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">ช่องทาง</label>
                                    <div class="col-sm-3">
                                      <asp:DropDownList ID="ddlSearchMediaOnAirChannel" class="form-control" runat="server"></asp:DropDownList>
                                    ...
                                    <div class="col-sm-3">
                                           <asp:DropDownList ID="ddlSearchMediaOnAirActive" class="form-control" runat="server"></asp:DropDownList>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                <!--Start modal Add MediaOnAir-->
                                                <asp:LinkButton ID="btnAddMediaOnAir" class="button-action button-add m-r-5"
                                                    OnClick="btnAddMediaOnAir_Click" runat="server"><i class="fa fa-plus m-r-5"></i>เพิ่ม</asp:LinkButton>
                                            ...
                                            <asp:HiddenField ID="hidMOQFlagMediaOnAir" runat="server" />
                                            <asp:GridView ID="gvMediaOnAir" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                                TabIndex="0" Width="100%" CellSpacing="0" OnRowCommand="gvMediaOnAir_RowCommand"  OnRowDataBound ="gvMediaOnAir_OnRowDataBound"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        <HeaderTemplate>
                                                            <center>
                                            <asp:CheckBox ID="chkMediaOnAirAll" OnCheckedChanged="chkMediaOnAirAll_Change" AutoPostBack="true" runat="server"  />
                                        </center>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>

                                                            <asp:CheckBox ID="chkMediaOnAir" runat="server" />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMediaOnAirTypeName" Text='<%# DataBinder.Eval(Container.DataItem, "ChannelName")%>' runat="server" />
                                                        ...
                                                        <HeaderTemplate>
                                                            ...
                                                            <div align="left">Media Phone</div>
                                                        ...
                                                        <HeaderTemplate>
                                                            ...
                                                            <div align="left">Media Sale Channel</div>

                                                        </HeaderTemplate>

                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMediasalechannel" Text='<%# DataBinder.Eval(Container.DataItem, "Mediasalechannel")%>' runat="server" />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowMediaOnAir"
                                                            ...
                                                            <asp:HiddenField runat="server" ID="HidMediaOnAirId" Value='<%# DataBinder.Eval(Container.DataItem, "MediaOnAirId")%>' /> 
                                                            ...
                                                            <asp:HiddenField runat="server" ID="HidMediasalechannelcode" Value='<%# DataBinder.Eval(Container.DataItem, "MediaSaleChannelcode")%>' />
    ...
    <div class="modal fade" id="modal-MediaOnAir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px;">เพิ่ม Media Plan</div>
                        ...
                        <ContentTemplate>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <label class="col-sm-4 col-form-label">Media Sale Channel</label>
                                <div class="col-sm-6">
                                    <asp:DropDownList ID="ddlMediSaleChannel_Ins" name="select" class="form-control" runat="server"></asp:DropDownList>
                                    <asp:Label ID="lblMediSaleChannel_Ins" runat="server" CssClass="validation"></asp:Label>
