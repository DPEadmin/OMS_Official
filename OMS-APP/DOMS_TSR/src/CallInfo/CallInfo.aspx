<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="CallInfo.aspx.cs" Inherits="DOMS_TSR.src.CallInfo.CallInfo" %>
            ...
            <div class="page-body">
                            ...
                            <div class="card-block">
                                ...
                                <div class="text-center m-t-20 col-sm-12">
                                    ...
                                    <asp:Button ID="btnSearch" Text="ค้นหา" class="button-pri button-accept m-r-10" OnClick="btnSearch_Click" runat="server" />
                                     <asp:Button ID="Button1" Text="ล้าง" class="button-pri button-accept m-r-10" OnClick="btnclear_Click" runat="server" />
                                </div>
                            </div>
                ...
                <div id="cardGridviewCallInfo" class="card" runat="server" style="display:none">
                            <div class="card-block">
                                 <div >
                                     <div>
                                         <asp:Button ID="btnSave" Text="ลูกค้าใหม่" Visible="false" class="button-pri button-accept m-r-10" OnClick="btnSave_Click" runat="server" />
                                     </div>
                                     <br />
                                     <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                                ...
                                <div class="text-center m-t-20 center">
                                    <asp:Button ID="btnSubmit" Text="บันทึก" class="button-pri button-accept m-r-10" runat="server" OnClick="btnSubmit_Click" />
