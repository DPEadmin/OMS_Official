...
{
    public partial class CallInfo : System.Web.UI.Page
    {
        ...
        {
            if (txtFName.Text == "" && txtLName.Text == "" && txtTel.Text == "") 
            {
                ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "alert", "alert('" + "กรุณากรอกข้อมูลค้นหา');", true);
        ...
        protected List<CallInformationInfo> GetCallinformationInfoMasterByCriteria()
        {
            ...
            APIpath = APIUrl + "/api/support/ListCallinformationInfoByCriteria_Manual";
        ...
        protected void bindDdlSearchGender()
        {
            ...
            ddlGender_Ins.Items.Insert(0, new ListItem("----------โปรดเลือก---------", "-99"));
        }
        protected void bindDdlSearchMaritalStatus()
        {
            ...
            ddlMaritalStatus_Ins.Items.Insert(0, new ListItem("----------โปรดเลือก---------", "-99"));
        }
        protected void bindDdlSearchOccupation()
        {
            ...
            ddlOccupation_Ins.Items.Insert(0, new ListItem("----------โปรดเลือก---------", "-99"));
        }
        protected void bindDDlTitle_Ins()
        {
            ...
            ddlTitle_Ins.Items.Insert(0, new ListItem("----------โปรดเลือก---------", "-99"));
        }
