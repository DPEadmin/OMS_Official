...
{
    public partial class Monthly_sumReport : System.Web.UI.Page
    {
        ...
        protected void gvMonthly_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    lblHour0.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour0.Text));
                    lblHour1.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour1.Text));
                    lblHour2.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour2.Text));
                    lblHour3.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour3.Text));
                    lblHour4.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour4.Text));
                    lblHour5.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour5.Text));
                    lblHour6.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour6.Text));
                    lblHour7.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour7.Text));
                    lblHour8.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour8.Text));
                    lblHour9.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour9.Text));
                    lblHour10.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour10.Text));
                    lblHour11.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour11.Text));
                    lblHour12.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour12.Text));
                    lblHour13.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour13.Text));
                    lblHour14.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour14.Text));
                    lblHour15.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour15.Text));
                    lblHour16.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour16.Text));
                    lblHour17.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour17.Text));
                    lblHour18.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour18.Text));
                    lblHour19.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour19.Text));
                    lblHour20.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour20.Text));
                    lblHour21.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour21.Text));
                    lblHour22.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour22.Text));
                    lblHour23.Text = string.Format("{0:N}", Convert.ToDecimal(lblHour23.Text));
