<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="AppointmentOrderManagement.aspx.cs" Inherits="DOMS_TSR.src.FullfillOrderlist.AppointmentOrderManagement" %>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div id="searchSection_NoAnswerOrder" runat="server">
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          <label class="col-sm-2 col-form-label">Name - Last name</label>
                                                            <div class="col-sm-4">
                                                                <div class="input-group mb-0">
                                                                    <asp:TextBox ID="txtSearchFName_NoAnswerOrder" class="form-control" placeholder="Name" runat="server"></asp:TextBox>
                                                                    <asp:TextBox ID="txtSearchLName_NoAnswerOrder" class="form-control" placeholder="Last name" runat="server"></asp:TextBox>
                                                                </div>
                                                            <asp:Label ID="lblSearchName_NoAnswerOrder" runat="server" CssClass="validatecolor"></asp:Label>                                  
                                                            </div>
                                            
                                                     <label class="col-sm-2 col-form-label">Contact number</label>
                                                <div class="col-sm-4">
                                                    <asp:TextBox ID="txtSearchContact_NoAnswerOrder" class="form-control" runat="server"></asp:TextBox>
                                                <asp:Label ID="lblSearchContact_NoAnswerOrder" runat="server" CssClass="validatecolor"></asp:Label>                                    </div>
                                ...
                                <div class="card-group">
                                            ...
                                            <div id="listcard1" runat="server">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 text-left">
                                                        <p class=" m-0">Order wait apporve</p>
                                                    </div>
                                    ...
                                    <div class="card-block p-t-5">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_NoAnswerOrder" style=" width: 150px;" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="sales order approval" OnClientClick="return ApproveConfirmGV();" />

                                            <asp:Button CssClass="button-pri button-delete" ID="btnCancelOrder_NoAnswerOrder"  style=" width: 150px;" runat="server" Text="Sales order not approved"  OnClick="btnCancelOrder_NoAnswerOrder_Click" OnClientClick="return DeleteConfirmGV();" />
                                                 <asp:Button CssClass="button-pri button-delete" ID="Button1"  runat="server" style=" width: 150px;" Text="Back Order"  OnClick="btnBackOrder_NoAnswerOrder_Click" OnClientClick="return BackOrderConfirmGV();" />
                                            ...
                                            <asp:CheckBox ID="chkAll_NoAnswerOrder" OnCheckedChanged="chkAll_Change_NoAnswerOrder" AutoPostBack="true" runat="server"  />
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField runat="server" ID="hidInventoryCode_NoAnswerOrder" Value='<%# DataBinder.Eval(Container.DataItem, "InventoryCode")%>' />
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                          ...
                                                          <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">warehouse</div>
                                                            </HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="false">
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="false">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBackorder_NoAnswerOrder" Text='<%# DataBinder.Eval(Container.DataItem, "BackOrder")%>' runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                           <asp:TemplateField ItemStyle-Wrap="false"  HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
