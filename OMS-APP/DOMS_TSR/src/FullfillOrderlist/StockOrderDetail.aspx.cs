...
namespace DOMS_TSR.src.FullfillOrderlist
{
    public partial class StockOrderDetail : System.Web.UI.Page
    {
        ...
        {
            saveOrder();
            Response.Redirect("StockOrderProgress.aspx");
        }
        ...
        protected void saveOrder()
        {
            ...
            string Strordernote = "เปลียนคลังจาก " + nameinventBeforeChange + " เป็น " + ddlInventory.SelectedItem.Text;
            
            resultinv.L_OrderChangeInventoryInfo.Add(new OrderChangeInventoryInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Request.QueryString["OrderCode"].Trim(), Inventorycode = ddlInventory.SelectedValue.ToString(),
                orderstate = StaticField.OrderState_13, orderstatus= StaticField.OrderStatus_10,
