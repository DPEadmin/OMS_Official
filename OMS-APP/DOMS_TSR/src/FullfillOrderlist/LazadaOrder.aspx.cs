...
{
    public partial class LazadaOrder : System.Web.UI.Page
    {
        ...
        {
            List<OrderOLInfo> lOrderInfo_NoAnswerOrder = new List<OrderOLInfo>();
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/CountLotLazadaReviewSearch";

            using (var wb = new WebClient())
            {
                var data = new NameValueCollection();

                data["Lot"] = txtSearchOrderCode_NoAnswerOrder.Text;
        ...
        public List<OrderOLInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            ...
            APIpath = APIUrl + "/api/support/LotLazadaReviewSearch";

            using (var wb = new WebClient())
            {
                var data = new NameValueCollection();

                data["LotNo"] = txtSearchOrderCode_NoAnswerOrder.Text;
        ...
        protected string GetFKLink(object objCode)
        {
            string strCode = (objCode != null) ? objCode.ToString() : "";
            return "<a href=\"../Report/ReportOrder.aspx?LotNo=" + strCode + "\">" + strCode + "</a>";
        }
    }
}