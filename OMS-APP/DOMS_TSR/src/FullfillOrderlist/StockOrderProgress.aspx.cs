...
{
    public partial class StockOrderProgress : System.Web.UI.Page
    {
        ...
        protected void BindDdlInventory()
        {
            ...
            ddlSearchInventory_NoAnswerOrder.DataSource = linvInfo;
            ddlSearchInventory_NoAnswerOrder.DataTextField = "InventoryName";
            ddlSearchInventory_NoAnswerOrder.DataValueField = "InventoryCode";
            ddlSearchInventory_NoAnswerOrder.DataBind();

            ddlSearchInventory_NoAnswerOrder.Items.Insert(0, new ListItem("---- กรุณาเลือก ----", "-99"));
        }
        ...
        public int? CountOrderMasterList_NoAnswerOrder()
        {
            ...
            using (var wb = new WebClient())
            {
                ...
                data["InventoryCode"] = ddlSearchInventory_NoAnswerOrder.SelectedValue == "-99" ? data["InventoryCode"] = "" : data["InventoryCode"] = ddlSearchInventory_NoAnswerOrder.SelectedValue;
                ...
                data["OrderStateCode"] = StaticField.OrderState_12; 
                data["ConfirmNo"] = "NULL";
        ...
        public void clearSearch_NoAnswerOrder()
        {
            ...
            ddlSearchInventory_NoAnswerOrder.ClearSelection();
        ...
        protected Boolean Changestatus_NoAnswerOrder()
        {
            ...
            for (int i = 0; i < gvOrder_NoAnswerOrder.Rows.Count; i++)
            {
                ...
                if (checkbox.Checked == true)
                {
                    ...
                    result.L_OrderChangestatusInfo.Add(new OrderChangestatusInfo() { updateBy = hidEmpCode.Value.ToString(), ordercode = Lbordercode.Text.Trim(), orderstate = StaticField.OrderState_12, orderstatus= StaticField.OrderStatus_10 }); 
                }
            }
        ...
        protected void btnSearch_Click_NoAnswerOrder(object sender, EventArgs e)
        {
            ...
            if(txtSearchOrderDateFrom_NoAnswerOrder.Text != "" && txtSearchOrderDateUntil_NoAnswerOrder.Text != "")
            { 
                DateTime Orderstartdate = DateTime.Parse(txtSearchOrderDateFrom_NoAnswerOrder.Text,new System.Globalization.CultureInfo("pt-BR"));
                DateTime Orderenddate = DateTime.Parse(txtSearchOrderDateUntil_NoAnswerOrder.Text,new System.Globalization.CultureInfo("pt-BR"));
                Ordermonth = (Orderenddate.Month - Orderstartdate.Month) + 12 * (Orderenddate.Year - Orderstartdate.Year);
                if (Ordermonth < 12)
                {
                    flag = false;
                }
            ...
            if (txtSearchDeliverDate_NoAnswerOrder.Text != "" && txtSearchDeliverDateTo_NoAnswerOrder.Text != "")
            {
                DateTime Deliverstartdate = DateTime.Parse(txtSearchDeliverDate_NoAnswerOrder.Text, new System.Globalization.CultureInfo("pt-BR"));
                DateTime Deliverenddate = DateTime.Parse(txtSearchDeliverDateTo_NoAnswerOrder.Text, new System.Globalization.CultureInfo("pt-BR"));
                Delivermonth = (Deliverenddate.Month - Deliverenddate.Month) + 12 * (Deliverenddate.Year - Deliverstartdate.Year);
                if (Delivermonth < 12)
                {
            ...
            if (flag == false)
            {
                ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "aler", "alert('" + "โปรดกรอกวันที่ให้ถูกต้อง" + "');", true);
        ...
        protected string GetLink(object objCode)
        {
            ...
            return "<a href=\"../FullfillOrderlist/StockOrderDetail.aspx?OrderCode=" + strCode + "\">" + strCode + "</a>";
        }
