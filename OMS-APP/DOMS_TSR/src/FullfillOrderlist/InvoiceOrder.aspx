<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="InvoiceOrder.aspx.cs" Inherits="DOMS_TSR.src.FullfillOrderlist.InvoiceOrder" %>
                                        ...
                                        <div id="searchSection_NoAnswerOrder" runat="server">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <label class="col-sm-2 col-form-label">คลังสินค้า</label>
                                                <div class="col-sm-4">
                                                    <asp:DropDownList ID="DDlInventory" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                ...
                                <div class="card-group">
                                    ...
                                    <div class="card-block p-t-5">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnPrint"  runat="server" Text="Print" Visible="false" />
                                            <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_NoAnswerOrder" style=" width: 150px;" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="อนุมัติใบสั่งขาย" OnClientClick="return ApproveConfirmGV();" Visible="false" />

                                            <asp:Button CssClass="button-pri button-delete" ID="btnCancelOrder_NoAnswerOrder"  style=" width: 150px;" runat="server" Text="ไม่อนุมัติใบสั่งขาย"  OnClick="btnCancelOrder_NoAnswerOrder_Click" OnClientClick="return DeleteConfirmGV();" Visible="false" />
                                                 <asp:Button CssClass="button-pri button-delete" ID="Button1"  runat="server" style=" width: 150px;" Text="Back Order"  OnClick="btnBackOrder_NoAnswerOrder_Click" OnClientClick="return BackOrderConfirmGV();" Visible="false"/>
                                            <asp:Panel ID="Panel_NoAnswerOrder" runat="server" Style="overflow-x: scroll;">
                                                <asp:GridView ID="gvOrder_NoAnswerOrder" runat="server" OnRowDataBound="gvOrder_RowDatabound" OnRowCommand="gvOrder_RowCommand" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true">
                                          ...
                                          <%--<asp:TemplateField HeaderStyle-CssClass="TDHead" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false" ItemStyle-CssClass="TDDetail" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" ItemStyle-Wrap="false">
                                            <HeaderTemplate>
                                                <center>
                                                    <asp:CheckBox ID="chkAll_Order" runat="server" AutoPostBack="true" />
                                                </center>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chk_ByOrder" runat="server" />
                                                        ...
                                                        <%--<asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" Visible="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <center>
                                            <asp:CheckBox ID="chkAll_NoAnswerOrder" OnCheckedChanged="chkAll_Change_NoAnswerOrder" AutoPostBack="true" runat="server"  />
                                                        ...
                                                        <HeaderTemplate>
                                                            <div align="center">View(PDF)</div>
                                                        </HeaderTemplate>

                                                        <ItemTemplate>                                                     
                                                            <asp:ImageButton Height="30px" ID="ImgPL" ImageUrl="~/Image/product.png" runat="server" CommandName="ShowInvoice" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                                                          <asp:TemplateField HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">

                                                        <HeaderTemplate>
                                                            <div align="center">Print(PDF)</div>
                                                        </HeaderTemplate>

                                                        <ItemTemplate>                                                     
                                                            <asp:ImageButton Height="30px" ID="ImgPrint" ImageUrl="~/Image/ordering.png" runat="server" CommandName="PrintInvoice" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <ItemTemplate>
                                                                 <%# GetLink(DataBinder.Eval(Container.DataItem, "OrderCode"),DataBinder.Eval(Container.DataItem, "CustomerCode")) %>
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">ออกใบเสร็จ</div>
                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBrandName_NoAnswerOrder" Text="Y" runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                        <asp:Label Cssclass="green-text" ID="lblBackorder_NoAnswerOrder" Text="รอพิมพ์" runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                           <asp:TemplateField ItemStyle-Wrap="false"  HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
