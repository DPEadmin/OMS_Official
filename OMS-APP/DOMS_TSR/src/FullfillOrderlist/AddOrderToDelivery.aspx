<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="AddOrderToDelivery.aspx.cs" Inherits="DOMS_TSR.src.FullfillOrderlist.AddOrderToDelivery" %>
    ...
    <script type="text/javascript">
        function ApproveConfirmGV() {
            ...
            if (sum == 0) {
                ...
                alert("กรุณาเลือกรายการแจกจ่าย");

                return false;

            } else {

                var MsgDelete = "คุณแน่ใจที่จะแจกจ่ายข้อมูลนี้ ?";

                if (confirm(MsgDelete)) {
                    //alert("c");
                    document.getElementById("<%=hidFlagDel.ClientID%>").value = "TRUE";
                    alert("แจกจ่ายขนส่งสำเร็จ");
                     return true;
            ...
            <div class="page-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card ">
                            <div class="card-header border-0">
                                <div class="sub-title">Insert Order to transmission line</div>
                            </div>
                            <div class="card-body">

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">transmission line</label>
                                    <div class="col-sm-3">
                                        <asp:DropDownList ID="ddlRouting" runat="server" OnSelectedIndexChanged="ddlRouting_SelectedIndexChanged" AutoPostBack="true" class="form-control"></asp:DropDownList>
                                    </div>

                                    <div class="col-sm-1"></div>
                                    <label class="col-sm-2 col-form-label">Sent by</label>
                                    <div class="col-sm-3">
                                        <asp:DropDownList ID="ddlVechicle" runat="server" class="form-control"></asp:DropDownList>
                                    </div>
                            ...
                            <div class="card-block p-t-5">
                                ...
                                <div id="Section_NoAnswerOrder" runat="server">
                                    ...
                                    <asp:Button CssClass="button-pri button-print  m-b-20 " Style ="width:auto" ID="btnMergeOrder_NoAnswerOrder" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="add freight car" OnClientClick="return ApproveConfirmGV();" />
                                    ...
                                    <asp:Panel ID="Panel_NoAnswerOrder" runat="server" Style="overflow-x: scroll;">
                                        <asp:GridView ID="gvOrder_NoAnswerOrder" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true">
                                            ...
                                            <asp:CheckBox ID="chkAll_NoAnswerOrder" OnCheckedChanged="chkAll_Change_NoAnswerOrder" AutoPostBack="true" runat="server"  />
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">sales order Type </div>
                                                    </HeaderTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail" Visible="false">
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" Visible="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">Sale order channel</div>
                                                    </HeaderTemplate>
