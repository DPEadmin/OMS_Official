<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="StockOrderProgress.aspx.cs" Inherits="DOMS_TSR.src.FullfillOrderlist.StockOrderProgress" %>
        ...
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hidTabNo" runat="server" />
                    ...
                    <div class="page-body">
                                        ...
                                        <div id="searchSection_NoAnswerOrder" runat="server">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <%--<asp:CompareValidator ID="CompareValidator1" ControlToCompare="txtSearchOrderDateUntil_NoAnswerOrder"  Operator="LessThan" 
                                                        ControlToValidate="txtSearchOrderDateFrom_NoAnswerOrder" Type="Date" Display="Dynamic"  runat="server" ErrorMessage="เลือกวันที่ให้ถูกต้อง"></asp:CompareValidator>--%>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:DropDownList ID="ddlSearchInventory_NoAnswerOrder" runat="server" class="form-control"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-1"></div>
                        ...
                        <%--                                 <asp:CompareValidator ID="CompareValidator2" ControlToCompare="txtSearchDeliverDateTo_NoAnswerOrder"  Operator="LessThan" 
                                                        ControlToValidate="txtSearchDeliverDate_NoAnswerOrder" Type="Date"  runat="server" ErrorMessage="เลือกวันที่ให้ถูกต้อง"></asp:CompareValidator>--%>
                                                </div>
                                ...
                                <div class="card-group">
                                            ...
                                            <div id="listcard1" runat="server">
                                                <div class="row">
                                                    <div class="col-3 text-left p-b-15">
                                                        <i class="fi fi-3x flaticon-warning fw text-c-blue"></i>
                                                    </div>
                                    ...
                                    <div class="card-block p-t-5">
                                        ...
                                        <div id="Section_NoAnswerOrder" runat="server">
                                            ...
                                            <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_NoAnswerOrder" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="Back Order" OnClientClick="return ApproveConfirmGV();" />

                                            <asp:Button CssClass="button-pri button-delete" ID="btnCancelOrder_NoAnswerOrder"  runat="server" Text="ยกเลิกใบสั่งขาย"  OnClick="btnCancelOrder_NoAnswerOrder_Click" OnClientClick="return DeleteConfirmGV();" Visible="false" />
                                            ...
                                            <asp:CheckBox ID="chkAll_NoAnswerOrder" OnCheckedChanged="chkAll_Change_NoAnswerOrder" AutoPostBack="true" runat="server"  />
                                                        ...
                                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                         ...
                                                         <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
                                                                <div align="Center">Inventory</div>
                                                            </HeaderTemplate>
          ...
          <%--                                              <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" Visible="true" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            <HeaderTemplate>
