...
namespace DOMS_TSR.src.FullfillOrderlist
{
    public partial class InvoiceOrder : System.Web.UI.Page
    {
        ...
        protected void gvOrder_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            HiddenField hidOrderCode_NoAnswerOrder = (HiddenField)row.FindControl("hidOrderCode_NoAnswerOrder");    
            if (e.CommandName == "ShowInvoice")
            {
                
                string pageurl = "InvoiceViewer.aspx?Ordercode=" + hidOrderCode_NoAnswerOrder.Value + "&FlagView=View";
            ...
            {
                string pageurl = "InvoiceViewer.aspx?Ordercode=" + hidOrderCode_NoAnswerOrder.Value + "&FlagView=Print";
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow", "window.open('" + pageurl + "', '_blank');", true);
        ...
        public List<OrderInfo> GetOrderMasterByCriteria_NoAnswerOrder()
        {
            ...
            using (var wb = new WebClient())
            {
                ...
                data["GroupOrderStateCode"] = StaticField.OrderState_13; 
    ...
    internal class PdfTextSection
    {
        ...
        public PdfTextSection(int v1, int v2, string v3, Font font)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.v3 = v3;
