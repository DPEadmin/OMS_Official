         ...
         <div class="card-block">
             ...
             <asp:UpdatePanel ID="UpdatePanel2" runat="server">
               <ContentTemplate>
                   ...
                   <asp:LinkButton id="btnAddEmployee" class="button-action button-add m-r-5" 
                       OnClick="btnAddSupplier_Click" runat ="server"><i class="fa fa-plus m-r-5 "></i>เพิ่ม Supplier</asp:LinkButton>
            ...
            <ContentTemplate>
                  <div class="dt-responsive table-responsive">
                      <asp:GridView ID="gvSupplier" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand" OnRowCommand="gvSupplier_RowCommand"
                      ...
                      <div class="modal-content">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="form-group row">      
                                  ...
                                  <label class="col-sm-1 col-form-label"></label>
                                  <label class="col-sm-2 col-form-label">ตัวแทนผู้ผลิต</label>
                                  <div class="col-sm-3">
                                      <asp:TextBox id="txtContactorIns" class="form-control" runat="server"></asp:TextBox>
                                      <asp:Label ID="lblContactorIns" runat="server" CssClass="validation"></asp:Label>                   
                                  </div>
                                </div>
                            <div class="form-group row">      
                                  <label class="col-sm-2 col-form-label">เบอร์โทรศัพท์</label>
                                  <div class="col-sm-3">
                                      <asp:TextBox id="txtPhoneNumberIns" class="form-control" runat="server"></asp:TextBox>                                   
                                      <asp:Label ID="lblPhoneNumberIns" runat="server" CssClass="validation"></asp:Label>                              
                                  </div>
                                  <label class="col-sm-1 col-form-label"></label>
                                  <label class="col-sm-2 col-form-label"></label>
                                  <div class="col-sm-3">
