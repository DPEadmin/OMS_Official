...
namespace DOMS_TSR.src.CallBackOrderManagement
{
    public partial class CallBackOrderManagement : System.Web.UI.Page
    {
        ...
        #region Function (Request For Reject Order)
        ...
        #endregion Function (Request For Reject Order)

        #region Events (Request For Reject Order)
        ...
        #endregion Events (Request For Reject Order)

        #region Binding (Request For Reject Order)
        ...
        #endregion Binding (Request For Reject Order)

        #region Paging (Request For Reject Order)
        ...
        #endregion Paging (Request For Reject Order)
