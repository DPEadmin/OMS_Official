...
<asp:Content ID="head" ContentPlaceHolderID="HeaderContent" runat="server">
   ...
   <script type="text/javascript">
       ...
       function DeleteConfirmInventory() {
...
<asp:UpdatePanel ID="UpdatePanel3" runat="server">
    ...
    <asp:HiddenField ID="hd" runat="server" />
         <asp:HiddenField ID="hidcoutRI" runat="server" />
<div class="page-body">
    ...
    <div class="row">
      <div class="col-sm-12">
         ...
         <div class="sub-title" >Transmission Line Information</div>
            </div>
                        ...
                        <div class="col-sm-12 col-lg-12 col-xl-6">
                          <div class="table-responsive">
                            <table class="table m-0" style="width: 100%">
                              <tbody>
                                <tr>
                                  <td scope="row"  >Transmission Line Code</td>
    ...
    text-shadow: 0px 1px 0px #263666;
          ...
          <div class="col-sm-12">
            ...
            <div>
                    ...
                    <asp:Linkbutton id="tab1" runat="server" OnClick="btntab1_Click" class="myButton">Transport Vehicle</asp:Linkbutton>
                    <asp:Linkbutton id="tab2" runat="server" OnClick="btntab2_Click" class="myButton" style="margin-left:-3px;">Transport Employee</asp:Linkbutton>
                   <asp:Linkbutton id="Linkbutton1" runat="server" OnClick="btntab3_Click" class="myButton">Inventory</asp:Linkbutton>
            </div>
            <div id="VehicleSection" runat="server">
                <div class="card">
                     <div class="sub-title" >Search Transport Information</div>
                            

                                <div class="card-body">

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Car Registration</label>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="TxtCar_No" class="form-control" runat="server"></asp:TextBox>
                                    </div>

                                    <div class="col-sm-1"></div>
                                    <label class="col-sm-2 col-form-label">Brand</label>
                                    <div class="col-sm-3">
                                        <%--<asp:DropDownList ID="ddlSearchVehicleBrand" runat="server" class="form-control"></asp:DropDownList>--%>
                                         <asp:TextBox ID="txtSearchVehicleBrand_main" class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="text-center m-t-20 col-sm-12">
                                    ...
                                    <asp:Button ID="Button1" Text="Search" OnClick="btnSearch_Click"
                                          class="button-pri button-accept m-r-10"
                                        runat="server" />
                                    <asp:Button ID="Button2" Text="Clear" OnClick="btnClearSearch_Click"
            ...
            <div class="card">      
              <div class="card-block">
                 ...
                 <asp:LinkButton ID="btnDeleteVehicle"  OnClick="btnDeleteVehicle_Click" OnClientClick="return DeleteConfirm();"   
                      ...
                      <asp:DropDownList ID="ddlFilterVehicle" runat="server"   AutoPostBack="true" Visible="false"></asp:DropDownList>
                      <asp:TextBox id="txtFilterVehicle" runat="server" Visible="false"></asp:TextBox>
                      <asp:Linkbutton id="Carsearch" onClick="btnSearch_Click" runat="server"  Visible="false" style="margin-left:-3px;" class="myButton">seach</asp:Linkbutton>
                      </span>
                   </div>
                  
                  <div class="dt-responsive table-responsive">
                      <asp:GridView ID="gvRoutingVehicle" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="center">Car Registration</div>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <ItemTemplate>
                                             <asp:Label ID="lblVechicle_active" Text= '<%# (((string)DataBinder.Eval(Container.DataItem,"Vechicle_active")) == "Y") ? ("Active") : ("Inactive" )%>' runat="server" />
            ...
            <div id="DriverSection" runat="server">
                <div class="card">
                  <div class="sub-title" >Search Transportation Employee Information.</div>
                      <div class="card-body">
                                   <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:DropDownList ID="ddlSearchRole" class="form-control" runat="server"></asp:DropDownList>
                                ...
                                <div class="text-center m-t-20 col-sm-12">
                                    ...
                                    <asp:Button ID="btnSearch" Text="Search" OnClick="btnSearchDirverMain_Click"
                                    class="button-pri button-accept m-r-10"
                                        runat="server" />
                                    <asp:Button ID="btnClearSearch" Text="Clear" OnClick="btnClearSearchDriverMain_Click"
                                         class="button-pri button-cancel"
                                        runat="server" />
              ...
              <div class="card-block">
                 ...
                 <asp:LinkButton ID="btnDeleteDriver"  OnClick="btnDeleteDriver_Click" OnClientClick="return DeleteConfirm1();"   
                      class="button-action button-delete"    runat="server"  ><i class="fa fa-minus m-r-5"></i>Delete</asp:LinkButton>
                      <span style="float: right;display:none">
                      <asp:DropDownList ID="ddlFilterDriver" runat="server" Visible="false"   AutoPostBack="true"></asp:DropDownList>
                      <asp:TextBox id="txtFilterDriver" runat="server" Visible="false"></asp:TextBox>
                      <asp:Linkbutton id="Driversearch" runat="server" style="margin-left:-3px;" class="myButton">seach</asp:Linkbutton>
                      </span>
                   </div>
                  
                
                      <asp:GridView ID="gvRoutingDriver" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                            TabIndex="0" Width="100%" CellSpacing="0" 
                            ShowHeaderWhenEmpty="true">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblRolename" Text='<%# Eval("RoleName").ToString() %>' runat="server" />
              ...
              <div id="InventorySelection" runat="server">
                  <div class="card" style="display:none" >
                      <div class="sub-title">ค้นหาข้อมูลคลังสินค้า</div>
                          ...
                          <div class="card-body">
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-3">
                                      <asp:TextBox ID="txtSeachInventoryCode_Main" class="form-control" runat="server"></asp:TextBox>
                                  </div>
                                  <div class="col-sm-1"></div>
                                  <label class="col-sm-2 col-form-label">ชื่อคลังสินค้า</label>
                                  <div class="col-sm-3">
                                      <asp:TextBox ID="txtSeachInventoryName_Main" class="form-control" runat="server"></asp:TextBox>
                                  </div>
                              </div>

                              <div class="form-group row">
                                  <label class="col-sm-2 col-form-label">ชื่อสายส่ง</label>
                                  <div class="col-sm-3">
                                      <asp:TextBox ID="txtSeachRoutingName_Main" class="form-control" runat="server"></asp:TextBox>
                                  </div>
                              </div>
                              ...
                              <div class="text-center m-t-20 col-sm-12">
                                  ...
                                  <asp:Button ID="Button3" Text="ค้นหา" OnClick="btnSearchInventoryMain_Click"
                                      class="button-pri button-accept m-r-10"
                                      runat="server" />
                                  <asp:Button ID="Button4" Text="ล้าง" OnClick="btnClearSearchInventoryMain_Click"
                                      class="button-pri button-cancel"
                                      runat="server" />
                      ...
                      <div class="card">
                          ...
                          <div class="m-b-10">
                              <!--Start modal Add Product-->
                              <asp:LinkButton ID="btnAddInventory" class="button-action button-add" data-backdrop="false"
                                  OnClick="btnAddInventory_Click" runat="server"><i class="fa fa-plus m-r-5"></i>Add</asp:LinkButton>
                              <asp:LinkButton ID="btnDeleteInventory" OnClick="btnDeleteInventory_Click" OnClientClick="return DeleteConfirm();"
                                  class="button-action button-delete" runat="server"><i class="fa fa-minus m-r-5"></i>Delete</asp:LinkButton>
                              <span style="float: right; display: none">
                                  <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true"></asp:DropDownList>
                                  <asp:TextBox ID="TextBox1" runat="server" Visible="false"></asp:TextBox>
                                  <asp:LinkButton ID="Linkbutton4" OnClick="btnSearch_Click" runat="server" Style="margin-left: -3px;" class="myButton">seach</asp:LinkButton>
                              </span>
                          </div>

                          <div class="dt-responsive table-responsive">
                              <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                  TabIndex="0" Width="100%" CellSpacing="0"
                                  ShowHeaderWhenEmpty="true">
                                  ...
                                  <Columns>
                                      <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="95px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                          ...
                                          <ItemTemplate>
                                              ...
                                              <asp:HiddenField runat="server" ID="hidRoutinginventoryId" Value='<%# DataBinder.Eval(Container.DataItem, "RoutinginventoryId")%>' />
                                          </ItemTemplate>
                                      </asp:TemplateField>
                                      ...
                                      <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                          ...
                                          <HeaderTemplate>
                                              ...
                                              <div align="center">Inventory Code</div>

                                          </HeaderTemplate>

                                          <ItemTemplate>
                                              <asp:Label ID="lblInventory_No" Text='<%# DataBinder.Eval(Container.DataItem, "Inventory_Code")%>' runat="server" />
                                      ...
                                      <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                          ...
                                          <ItemTemplate>
                                              <asp:Label ID="lblInventory_Name" Text='<%# DataBinder.Eval(Container.DataItem, "Inventory_name")%>' runat="server" />
                                      ...
                                      <td width="100%" align="right" valign="top">
                                          <table border="0" cellpadding="0" cellspacing="0" style="vertical-align: middle;">
                                              <tr>
                                                  ...
                                                  <td style="width: 12px"></td>
                                                  <td>
                                                      <asp:Button ID="lnkbtnFirstRI" CssClass="Button" ToolTip="First" CommandName="First"
                                                          Text="<<" runat="server" OnCommand="GetPageRIIndex"></asp:Button>
                                                  </td>
                                                  <td style="width: 6px"></td>
                                                  <td>
                                                      <asp:Button ID="lnkbtnPreRI" CssClass="Button" ToolTip="Previous" CommandName="Previous"
                                                          Text="<" runat="server" OnCommand="GetPageRIIndex"></asp:Button>
                                                  </td>
                                                  <td style="width: 6px"></td>
                                                  <td style="font-size: 8.5pt;">Page
                                                                                    <asp:DropDownList ID="ddlRIPage" CssClass="textbox" runat="server" AutoPostBack="True"
                                                                                        OnSelectedIndexChanged="ddlRIPage_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
                                                      of
                                                                                    <asp:Label ID="lblTotalPagesRI" CssClass="fontBlack" runat="server"></asp:Label>
                                                  </td>
                                                  <td style="width: 6px"></td>
                                                  <td>
                                                      <asp:Button ID="lnkbtnNextRI" CssClass="Button" ToolTip="Next" runat="server" CommandName="Next" Text=">" OnCommand="GetPageRIIndex"></asp:Button>
                                                  </td>
                                                  <td style="width: 6px"></td>
                                                  <td>
                                                      <asp:Button ID="lnkbtnLastRI" CssClass="Button" ToolTip="Last" runat="server" CommandName="Last"
                                                          Text=">>" OnCommand="GetPageRIIndex"></asp:Button>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
               ...
               <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                  <ContentTemplate>
                      <div class="form-group row">
                          ...
                          <label class="col-sm-2 col-form-label">Car Type</label>
                          <div class="col-sm-3">
                              <asp:DropDownList ID="ddltabTransport_typeCar" runat="server" class="form-control"></asp:DropDownList>
                          </div>
                          <label class="col-sm-1 col-form-label"></label>
                          <label class="col-sm-2 col-form-label">Status</label>
                          <div class="col-sm-3">
                              <asp:DropDownList ID="ddltabTransport_Active" class="form-control" runat="server"></asp:DropDownList>
                ...
                <div class="row">
                          <div class="col-sm-12">
                            <div class="modal-header modal-header2 ">
                              <div class="col-sm-11">
                                <div id="exampleModalLongTitle">Choose A Transport
                                </div>
                              </div>
                              <div class="col-sm-1">
     ...
     <div class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="sub-title" >Search Transportation Employee Information.</div>
                ...
                <label class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-3">
                    <asp:TextBox  ID="txtSearchFnamePopup" class="form-control" runat="server"></asp:TextBox>              
                </div>
                     <label class="col-sm-1 col-form-label"></label>
                      <label class="col-sm-2 col-form-label">Lastname</label>
                        <div class="col-sm-3">
                    <asp:TextBox  ID="txtSearchLnamePopup" class="form-control" runat="server"></asp:TextBox>              
                </div>
                      <label class="col-sm-2 col-form-label">Driver Code</label>
                <div class="col-sm-3">
                     <asp:TextBox  ID="txtSearchDriverCodepopup" class="form-control" runat="server"></asp:TextBox>
                </div>
                        <label class="col-sm-1 col-form-label"></label>
                      <label class="col-sm-2 col-form-label">Role</label>
                                    <div class="col-sm-3">
                                        <asp:DropDownList ID="ddlInsRole" class="form-control" runat="server"></asp:DropDownList>
                ...
                <div class="row">
                          <div class="col-sm-12">
                            <div class="modal-header modal-header2 ">
                              <div class="col-sm-11">
                                <div id="exampleModalLongTitle1">Add Transport Employee 
                                </div>
                              </div>
                              <div class="col-sm-1">
                                <button type="button" class="close " data-dismiss="modal" aria-label="Close">
                              ...
                              <%--  <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="95px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="center">Driver Code</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="center">Name - Lastname</div>
     ...
     <div class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg" style="max-width:75%;">
                ...
                <div class="modal-content m-b-10">
                        ...
                        <div class="modal-body">
                            <div class="modal-header">
            <div class="sub-title" >Select An Inventory</div>
          </div>
                ...
                <div class="form-group row">
                       ...
                       <label class="col-sm-4 col-form-label">Invenotory Code</label>
                <div class="col-sm-4">
                      <asp:DropDownList ID="ddlInventory" runat="server"  CssClass="form-control"  class="form-control"></asp:DropDownList>
                      <asp:Label ID="lblddlInventory_Ins" runat="server" CssClass="validatecolor"></asp:Label>
                </div>
              </div>
          
                <div class="text-center m-t-20 col-sm-12">
                        <asp:Button ID="Button7" Text="Submit" OnClick="btnSaveRoutInventory_Click"
                      class="button-pri button-accept m-r-10"
                      runat="server" />
                    <asp:Button ID="Button5" Text="Search" OnClick="btnSearchInventoryPopup_Click"
                      class="button-pri button-accept m-r-10"
                      runat="server" Visible="false" />
                     <asp:Button ID="Button6" Text="Cancel" OnClick="btnClearSearchInventoryPopup_Click"
                      class="button-pri button-cancel"
                      runat="server" />
                </div>
              </ContentTemplate>
