<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="Routing.aspx.cs" Inherits="DOMS_TSR.src.RoutingManagement.Routing" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="card">
                                        <div class="card-block">
                                            ...
                                            <div class="m-b-10">
                                                <!--Start modal Add routing-->
                                                <asp:LinkButton ID="btnAddrouting" class="button-action button-add" data-backdrop="false"
                                            ...
                                            <asp:GridView ID="gvRouting" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        <HeaderTemplate>
                                                            <center>
                                            <asp:CheckBox ID="chkRoutingAll" OnCheckedChanged="chkRoutingAll_Change" AutoPostBack="true" runat="server"  />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblroutingName" Text='<%# DataBinder.Eval(Container.DataItem, "Routing_name")%>' runat="server" />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowRouting" Style="float: none; border-radius: 5px; padding: 3px 10px; padding-top: 5px;"
    ...
    <div class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true" id="modal-routing">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px;">Add Transmission Line</div>
                    ...
                    <asp:UpdatePanel ID="UpModal" runat="server">
                        <ContentTemplate>
                            <div class="form-group row">
                                ...
                                <label class="col-sm-4 col-form-label">Transmission Line Code</label>
                                <div class="col-sm-6">
                                    ...
                                    <asp:HiddenField runat="server" ID="hidroutingImgId" />

                                </div>

                                <label class="col-sm-4 col-form-label">Transmission Line Name</label>
                                <div class="col-sm-6">
