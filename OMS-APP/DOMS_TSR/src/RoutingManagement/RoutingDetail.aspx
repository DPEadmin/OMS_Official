        ...
        <div class="card">
          ...
          <div class="card-block">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <asp:TextBox  ID="txtSearchPostCode" class="form-control" runat="server" onkeypress="return validatenumerics(event);"></asp:TextBox>  
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="card-block">
                  ...
                  <div class="m-b-10">
                   ...
                   <asp:LinkButton id="btnAddProduct" class="button-action button-add" data-backdrop="false"
                       OnClick="btnAddRouting_Click" runat ="server"><i class="fa fa-plus m-r-5"></i>เพิ่ม</asp:LinkButton>
            ...
            <div class="modal-dialog modal-lg" style="max-width:650px;">
                ...
                <div class="row">
                    ...
                    <div class="modal-header modal-header2 ">
                        <div class="col-sm-11">
                        <div id="exampleModalLongTitle">เพิ่มเส้นทาง
                        </div>
                        </div>
                        <div class="col-sm-1">
                    ...
                    <asp:UpdatePanel ID="UpModal" runat="server">
                        <ContentTemplate>
                          <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                      <asp:DropDownList ID="ddlProvince_Ins" runat="server"  class="form-control"  OnSelectedIndexChanged="ddlProvince_SelectedIndexChanged"  AutoPostBack="true"></asp:DropDownList>
                                    ...
                                    <div class="col-sm-6">
                                      <asp:DropDownList ID="ddlDistrict_Ins" runat="server"  class="form-control"  OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged"  AutoPostBack="true"></asp:DropDownList>
                                      <asp:Label id="lblDistrict_Ins" runat="server" CssClass="validatecolor"></asp:Label>
                                    </div>

                                    <label class="col-sm-4 col-form-label">ตำบล/แขวง</label>
                                    <div class="col-sm-6">
                                     <asp:DropDownList ID="ddlSubDistrict_Ins" runat="server"   class="form-control" AutoPostBack="true"></asp:DropDownList>
                                ...
                                <div class="col-sm-6">
                                 <asp:TextBox id="txtPostCode_Ins"  class="form-control" runat="server" onkeypress="return validatenumerics(event);"></asp:TextBox>
