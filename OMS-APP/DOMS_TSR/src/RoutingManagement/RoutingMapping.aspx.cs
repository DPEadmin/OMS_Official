...
{
    public partial class RoutingMapping : System.Web.UI.Page
    {
        ...
        {
            List<RoutingInfo> lProductInfo = new List<RoutingInfo>();
            ...
            lProductInfo = GetRoutingMasterByCriteria();

            gvRouting.DataSource = lProductInfo;
        ...
        protected void chkRoutingAll_Change(object sender, EventArgs e)
        {
            for (int i = 0; i < gvRouting.Rows.Count; i++)
            {
                ...
                {
                    HiddenField hidCode = (HiddenField)gvRouting.Rows[i].FindControl("hidProductId");
        ...
        protected string GetLink(object objCode)
        {
            ...
            return "<a href=\"RoutingMappingDetail.aspx?RoutingCode=" + strCode + "&MenuId=02\">" + strCode + "</a>";
        }
