<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="ContactHistoryTIB.aspx.cs" Inherits="DOMS_TSR.src.Outbound.ContactHistoryTIB" %>
                                ...
                                <div id="searchSection_NoAnswerOrder" runat="server">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <asp:TextBox ID="txtSearchCarYear" class="form-control" runat="server"></asp:TextBox>
                                        </div>

                                       

                                        <%--<label class="col-sm-2 col-form-label">วันที่เคยซื้อ</label>--%>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group mb-0">
                                                ...
                                                <asp:TextBox ID="txtSearchCarModel" class="form-control" runat="server"></asp:TextBox>
                                        ...
                                        OnRowCommand="gvOrder_NoAnswerOrder_RowCommand" OnRowCreated="gvOrder_NoAnswerOrder_RowCreated">
                                            ...
                                            <asp:CheckBox ID="chkAll_NoAnswerOrder" OnCheckedChanged="chkAll_Change_NoAnswerOrder" AutoPostBack="true" runat="server"  />
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">callback date</div>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">Contact time back</div>
                                                    </HeaderTemplate>                                                    
                                                    <ItemTemplate>                                                        
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTransactionTypeName" Text='<%# DataBinder.Eval(Container.DataItem, "TransactionTypeName")%>' runat="server" />
                                                </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-Width="10%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                            <HeaderTemplate>
                                                <div align="left">sub version</div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
        ...
        <div class="modal-dialog" role="document" style="max-width: 60%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">SO Number
                        </label>
                        <div class="col-sm-10">
