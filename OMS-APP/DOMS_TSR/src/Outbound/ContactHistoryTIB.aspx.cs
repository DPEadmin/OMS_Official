...
{
    public partial class ContactHistoryTIB : System.Web.UI.Page
    {
        ...
        protected void gvOrder_NoAnswerOrder_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            gvOrder_NoAnswerOrder.Columns[9].Visible = false; //hide customername column
            gvOrder_NoAnswerOrder.Columns[10].Visible = false; //hide customerphone column
            ...
            gvOrder_NoAnswerOrder.Columns[17].Visible = false; 
            gvOrder_NoAnswerOrder.Columns[18].Visible = false; 
            gvOrder_NoAnswerOrder.Columns[19].Visible = false; 
        }
