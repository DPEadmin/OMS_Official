<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="Channel.aspx.cs" Inherits="DOMS_TSR.src.Channel.Channel" %>
    ...
    function removeLine(obj)
{
  ...
  //console.log(finalFiles);
        ...
        function DeleteConfirm() {
            ...
            var grid = document.getElementById("<%= gvChannel.ClientID %>");
    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="sub-title" >ค้นหาข้อมูลช่องทางการขาย</div>
        </div>
        <div class="card-block">            
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">รหัสช่องทางการขาย</label>
              <div class="col-sm-4">
                <asp:TextBox  ID="txtSearchChannelCode" class="form-control" runat="server"></asp:TextBox>
                <asp:Label ID="lblSearchChannelCode" runat="server" CssClass="validation"></asp:Label>
            ...
            <asp:HiddenField ID="hidMsgDel" runat="server" />
             ...
             <asp:HiddenField ID="hidMerCode" runat="server"/>
              ...
              <label class="col-sm-2 col-form-label">ชื่อช่องทางการขาย</label>
              <div class="col-sm-4">
                  <asp:TextBox  ID="txtSearchChannelName" class="form-control" runat="server"></asp:TextBox>
                  <asp:Label ID="lblSearchChannelName" runat="server" CssClass="validation"></asp:Label>
              </div>
              ...
              <div class="card-block">
                  ...
                  <div class="m-b-10">
                   ...
                   <asp:LinkButton id="btnAddProduct" class="button-action button-add m-r-5"
                       OnClick="btnAddProduct_Click" runat ="server"><i class="fa fa-plus"></i> เพิ่ม</asp:LinkButton>
                 <asp:LinkButton ID="btnDelete"  OnClick="btnDelete_Click" OnClientClick="return DeleteConfirm();"   
                 class="button-action button-delete m-r-5"    runat="server" ><i class="fa fa-minus"></i> ลบ</asp:LinkButton>
                   </div>
   
                  <div class="dt-responsive table-responsive">
                      <asp:GridView ID="gvChannel" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="Center">รหัสช่องทางการขาย</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# GetLink(DataBinder.Eval(Container.DataItem, "ChannelCode"),DataBinder.Eval(Container.DataItem, "ChannelName")) %>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="center">ชื่อช่องทางการขาย</div>

                                    </HeaderTemplate>

                                    <ItemTemplate>
                                       <asp:Label ID="lblProductName" Text='<%# DataBinder.Eval(Container.DataItem, "ChannelName")%>' runat="server" />
                     ...
                     <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowProduct"
                                        ...
                                        <asp:HiddenField runat="server" ID="hidChannelId" Value='<%# DataBinder.Eval(Container.DataItem, "ChannelId")%>' />
      ...
      <!-- Basic Form Inputs card end -->
        ...
        <div class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            aria-hidden="true" id="modal-Channel">
            ...
            <asp:UpdatePanel ID="upModal" runat="server">
                    <ContentTemplate>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">รหัสช่องทางการขาย</label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtChannelCode_Ins" runat="server" class="form-control"></asp:TextBox> 
                                <asp:Label ID="lblChannelCode_Ins" runat="server" CssClass="validation"></asp:Label>
                                <asp:HiddenField ID="hidChannelCode_Ins" runat="server" ></asp:HiddenField>
                            ...
                            <div class="col-sm-4">
                                ...
                                <asp:TextBox ID="txtChannelName_Ins" runat="server" class="form-control"></asp:TextBox> 
                                <asp:Label ID="lblChannelName_Ins" runat="server" CssClass="validation"></asp:Label>
