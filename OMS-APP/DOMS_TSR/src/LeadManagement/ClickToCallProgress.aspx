<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="ClickToCallProgress.aspx.cs" Inherits="DOMS_TSR.src.LeadManagement.ClickToCallProgress" %>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header border-0">
                                <div class="sub-title">search for information Call Out Progress </div>
                            </div>
                                ...
                                <div id="searchSection_NoAnswerOrder" runat="server">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <asp:Label ID="lblSearchTelephone" runat="server" CssClass="validatecolor"></asp:Label>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group mb-0">
                                                <asp:TextBox ID="txtSearchASTFName_NoAnswerOrder" class="form-control" placeholder="Name" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchASTLName_NoAnswerOrder" class="form-control" placeholder="Surname" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtSearchEmpName" class="form-control" runat="server"></asp:TextBox>
                                            </div>
                                                        <asp:Label ID="lblSearchEmpName" runat="server" CssClass="validatecolor"></asp:Label>                                            </div>
                                         <div class="col-sm-1"></div>
                        ...
                        <div class="card ">
                            ...
                            <div class="card-block p-t-5">
                                ...
                                <div id="Section_NoAnswerOrder" runat="server">
                                    ...
                                    <asp:Button CssClass="button-pri button-print  m-b-10" ID="btnMergeOrder_NoAnswerOrder" OnClick="btnAcceptOrder_NoAnswerOrder_Click" runat="server" Text="Approve order" OnClientClick="return ApproveConfirmGV();" Visible="false" />

                                    <asp:Button CssClass="button-pri button-delete" ID="btnCancelOrder_NoAnswerOrder" runat="server" Text="Reject order" OnClick="btnCancelOrder_NoAnswerOrder_Click" OnClientClick="return DeleteConfirmGV();" Visible="false" />
                                    ...
                                    <asp:Panel ID="Panel_NoAnswerOrder" runat="server" Style="overflow-x: scroll;">
                                        ...
                                        <asp:GridView ID="gvOrder_NoAnswerOrder" runat="server" OnRowDataBound="gvOrder_RowDatabound" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" 
                                         ShowHeaderWhenEmpty="true" OnRowCommand="gvOrder_NoAnswerOrder_RowCommand" OnRowCreated="gvOrder_NoAnswerOrder_RowCreate">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">Name - Last name</div>
                                                    </HeaderTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center"> Assign To </div>
                                                    </HeaderTemplate>

                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAssign_NAME_TH" Text='<%# DataBinder.Eval(Container.DataItem, "AssignEmpName")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>  
                                                    <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">Lead Status</div>
                                                    </HeaderTemplate>

                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLeadStatusName" Text='<%# DataBinder.Eval(Container.DataItem, "LeadStatusName")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>  
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">Date buy</div>
                                                    </HeaderTemplate>

                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPREVIOUS_ORDER_DATE" Text='<%# ((null == Eval("PREVIOUS_ORDER_DATE"))||("" == Eval("PREVIOUS_ORDER_DATE"))) ? string.Empty : DateTime.Parse(Eval("PREVIOUS_ORDER_DATE").ToString()).ToString("dd/MM/yyyy") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">employee sale</div>
                                                    </HeaderTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                    <HeaderTemplate>
                                                        <div align="Center">PREVIOUS PRODUCT</div>
                                                    </HeaderTemplate>
