...
{
    public partial class LeadAssignmentTIB : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (empInfo != null)
                {
                    // Pls Switch into empInfo.CoonectionAPI when deploy to server
                ...
                ordernoanswersection.Visible = false;
                ...
                LoadCountLeadAssignmentbyEmpAssigned();
            }
        }
        ...
        protected void LoadgvLeadManagement()
        {
            ...
            foreach(var od in lLeadManagementInfo)
            {
                if(od.RecontactbackDate == "")
                {
                    od.RecontactbackDate = "";
                }
            }
        ...
        protected Boolean ValidateUpdate()
        {
            ...
            {
                flag = false;
                error += "กรุณาเลือก BU ของพนักงาน \\n";
                counterr++;
            }
            ...
            {
                flag = false;
                error += "กรุณาเลือกพนักงานที่ต้องการ Assign \\n";
                counterr++;
            }
        ...
        protected void LoadCountLeadAssignmentbyEmpAssigned()
        {            
            int? haveassignemp = 0;
            int? nohaveassignemp = 0;
            int? alllead = 0;
            ...
            List<LeadManagementInfo> lleadmanagementassignInfo = JsonConvert.DeserializeObject<List<LeadManagementInfo>>(respstr);

            if(lleadmanagementassignInfo.Count > 0)
            {
                foreach(var oa in lleadmanagementassignInfo.ToList())
                {
                    haveassignemp++;
                }
            }
            ...
            List<LeadManagementInfo> lleadmanagementnoassignInfo = JsonConvert.DeserializeObject<List<LeadManagementInfo>>(respstr1);

            if (lleadmanagementassignInfo.Count > 0)
            {
                foreach (var oa in lleadmanagementnoassignInfo.ToList())
                {
                    nohaveassignemp++;
                }
            }
            ...
            using (var wb = new WebClient())
            {
                ...
                data["HaveAssignEmpCode"] = "";
                data["NoHaveAssignEmpCode"] = "";
            ...
            List<LeadManagementInfo> lleadmanagementallInfo = JsonConvert.DeserializeObject<List<LeadManagementInfo>>(respstr2);

            if (lleadmanagementallInfo.Count > 0)
            {
                foreach (var oa in lleadmanagementallInfo.ToList())
                {
                    alllead++;
                }
            }

            lblsumtotal.Text = alllead.ToString();
            lblsumassign.Text = haveassignemp.ToString();
            lblsumremain.Text = nohaveassignemp.ToString();
        }
        #endregion
        ...
        protected void BindddlBU()
        {
            ...
            ddlEmpBU.DataBind();
            ddlEmpBU.Items.Insert(0, new ListItem("กรุณาเลือก", "-99"));
            ...
            ddlEmpBUGroup.Items.Insert(0, new ListItem("กรุณาเลือก", "-99"));
            ...
            ddlEmpBUPercent.Items.Insert(0, new ListItem("กรุณาเลือก", "-99"));
            ...
            ddlEmpBURoundRobin.Items.Insert(0, new ListItem("กรุณาเลือก", "-99"));
        }
        ...
        protected void btnSelectEmp_Clicked(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "alert", "alert('" + "กรุณาเลือก BU" + "');", true);
            }
        }
        ...
        {
            //recalculate lead for each emp for empgrup assign type
            if (radAssignType.SelectedValue == "1")
            {
                CalculateCountLeadAssign(L_EmpGroupInfolist);
        ...
        protected void gvLeadManagement_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label lblRecontactbackDate = (Label)e.Row.FindControl("lblRecontactbackDate");
                Label lblRecontactbactPeriodTimeName = (Label)e.Row.FindControl("lblRecontactbactPeriodTimeName");
                Label lblCusReason = (Label)e.Row.FindControl("lblCusReason");
                Label lblCusReasonOther = (Label)e.Row.FindControl("lblCusReasonOther");
                Label lblInsurancetype = (Label)e.Row.FindControl("lblInsurancetype");
                Label lblCaryear = (Label)e.Row.FindControl("lblCaryear");
                Label lblCarmodel = (Label)e.Row.FindControl("lblCarmodel");
                Label lblCartype = (Label)e.Row.FindControl("lblCartype");
                Label lblCarsubmodel = (Label)e.Row.FindControl("lblCarsubmodel");
                Label lblInsurancedate = (Label)e.Row.FindControl("lblInsurancedate");
                ...
                if (lblRecontactbackDate.Text == "01/01/1900")
                {
                    lblRecontactbackDate.Text = "-";
                }
                if (lblRecontactbactPeriodTimeName.Text == "")
                {
                    lblRecontactbactPeriodTimeName.Text = "-";
                }
                if (lblCusReason.Text == "")
                {
                    lblCusReason.Text = "-";
                }
                if (lblCusReasonOther.Text == "")
                {
                    lblCusReasonOther.Text = "-";
                }
                if (lblInsurancetype.Text == "")
                {
                ...
                if (lblCarsubmodel.Text == "")
                {
                    lblCarsubmodel.Text = "-";
                }
                if (lblInsurancedate.Text == "")
                {
                    lblInsurancedate.Text = "-";
                }
                if (lblProductName.Text == "")
                {
                    lblProductName.Text = "-";
                }
                if (lblPromotionName.Text == "")
                {
        ...
        protected void gvLeadManagement_RowCreated(object sender, GridViewRowEventArgs e)
        {
            gvLeadManagement.Columns[1].Visible = false; //hide customercode column
            gvLeadManagement.Columns[2].Visible = false; //hide customername column
            gvLeadManagement.Columns[3].Visible = false; //hide customerphone column
