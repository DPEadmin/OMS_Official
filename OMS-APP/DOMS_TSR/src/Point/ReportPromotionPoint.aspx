<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="ReportPromotionPoint.aspx.cs" Inherits="DOMS_TSR.src.Point.ReportPromotionPoint" %>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title"><asp:Label ID="ReportPromotionPoint_title" runat="server" /></div>
                            </div>
                            <div class="card-block">
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 col-form-label">วันที่ทำรายการ</label>
                                    <div class="col-sm-4">
                                            ...
                                            <asp:GridView ID="gvPromotion" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPointTypeName" Text='<%# DataBinder.Eval(Container.DataItem, "PointTypeName")%>' runat="server" />
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                        ...
                                                        <HeaderTemplate>
                                                            ...
                                                            <div align="left">ระดับ</div>

                                                        </HeaderTemplate>

                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPointRangeName" Text='<%# DataBinder.Eval(Container.DataItem, "PointRangeName")%>' runat="server" />
