<%@ Page Language="C#" MasterPageFile="~/src/MasterPage/Web.master" AutoEventWireup="true" CodeBehind="CompanyManagement.aspx.cs" Inherits="DOMS_TSR.src.Point.CompanyManagement" %>
...
<asp:Content ID="head" ContentPlaceHolderID="HeaderContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DeleteConfirmGV() {
            ...
            var grid = document.getElementById("<%= gvCompany.ClientID %>");
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">ข้อมูลร้านค้า</div>
                            </div>
                            <div class="card-block">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtSearchCompanyCode" class="form-control" runat="server"></asp:TextBox>
                                        <input type="hidden" id="hidIdList" runat="server" />
                                        <input type="hidden" id="hidComCode" runat="server" />
                                    ...
                                    <label class="col-sm-2 col-form-label">ชื่อร้านค้า(ไทย)</label>
                                    <div class="col-sm-4">
                                        <asp:TextBox  ID="txtSearchCompanyNameTH" class="form-control" runat="server" ></asp:TextBox>
                                    </div>
                                    <label class="col-sm-2 col-form-label">ชื่อร้านค้า(อังกฤษ)</label>
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtSearchCompanyNameEN" class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="m-b-10">
                                    ...
                                    <asp:LinkButton ID="btnAddCompany" class="button-action button-add" data-backdrop="false" OnClick="btnAddCompany_Click" runat="server"><i class="fa fa-plus m-r-5"></i>เพิ่ม</asp:LinkButton>
                                ...
                                <asp:GridView ID="gvCompany" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand " Style="white-space: nowrap" TabIndex="0" Width="100%" CellSpacing="0" OnRowCommand="gvCompany_RowCommand" ShowHeaderWhenEmpty="true">
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                            <HeaderTemplate>
                                                <center>
                                                           <asp:CheckBox ID="chkAll" OnCheckedChanged="chkAll_Change" AutoPostBack="true" runat="server"  />
                                                                </center>
                                            </HeaderTemplate>
                                        ...
                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="left" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                            ...
                                            <HeaderTemplate>
                                                ...
                                                <div align="left">รหัสร้านค้า</div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                 <asp:Label ID="lblCompanyCode" Text='<%# DataBinder.Eval(Container.DataItem, "CompanyCode")%>' runat="server" />
                                        ...
                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                            ...
                                            <HeaderTemplate>
                                                ...
                                                <div align="Center">ชื่อร้านค้า(ไทย)</div>

                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <div class="hideText">
                                                    <asp:Label ID="lblCompanyNameTH" Text='<%# DataBinder.Eval(Container.DataItem, "CompanyNameTH")%>' runat="server" />
                                                </div>
                                            </ItemTemplate>
                                         ...
                                         <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                            ...
                                            <HeaderTemplate>
                                                ...
                                                <div align="Center">ชื่อร้านค้า(อังกฤษ)</div>
                                        ...
                                        <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEdit" runat="Server" CommandName="ShowCompany" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"> <span class="button-pri button-activity m-r-10 icofont icofont-ui-edit f-16"></span></asp:LinkButton>
                                                <%--<asp:LinkButton ID="buttonDelete" runat="Server" OnClientClick="return DeleteConfirm();" CommandName="DeleteCompany"  CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" class="button-activity  " >  <span class="ti-trash f-14"></span></asp:LinkButton>--%>


                                                <asp:HiddenField runat="server" ID="hidCompanyId" Value='<%# DataBinder.Eval(Container.DataItem, "CompanyId")%>' />
                                                <asp:HiddenField runat="server" ID="hidCompanyNameTH" Value='<%# DataBinder.Eval(Container.DataItem, "CompanyNameTH")%>' />
                                                <asp:HiddenField runat="server" ID="hidCompanyNameEN" Value='<%# DataBinder.Eval(Container.DataItem, "CompanyNameEN")%>' />
    ...
    <div class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true" id="modal-company">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="modal-header modal-header2  p-l-0 ">
                            <div class="col-sm-12">
                                <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px;">เพิ่มร้านค้า</div>
                                ...
                                <asp:UpdatePanel ID="UpModal" runat="server">
                                    <ContentTemplate>
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-4 col-form-label">รหัสร้านค้า</label>
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtCompanyCode_Ins" runat="server" class="form-control" Style="width: 100%"></asp:TextBox>
                                                <asp:Label ID="lblCompanyCode_Ins" runat="server" CssClass="validation"></asp:Label>
                                            </div>
                                            <label class="col-sm-4 col-form-label">ชื่อร้านค้า(ไทย)<span style="color: red; background-position: right top;">*</span></label>
                                                <div class="col-sm-8">
                                                        <asp:TextBox  ID="txtCompanyNameTH_Ins" class="form-control" runat="server" ></asp:TextBox>
                                                     <asp:Label ID="lblCompanyNameTH_Ins" runat="server" CssClass="validation"></asp:Label>
                                                </div>
                                            <label class="col-sm-4 col-form-label">ชื่อร้านค้า(อังกฤษ)<span style="color: red; background-position: right top;">*</span></label>
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtCompanyNameEN_Ins" runat="server" class="form-control"></asp:TextBox>
                                                <asp:Label ID="lblCompanyNameEN_Ins" runat="server" CssClass="validation"></asp:Label>
                                            </div>
                                        </div>
