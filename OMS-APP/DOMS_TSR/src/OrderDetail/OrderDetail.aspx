<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="OrderDetail.aspx.cs" Inherits="DOMS_TSR.src.OrderDetail" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <asp:Panel ID="Panel_All" runat="server" Style="overflow-x: scroll;">
                                    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="False" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true" OnRowDataBound="gvProduct_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                <HeaderTemplate>
                                                    <div align="right">Total price</div>
                                                </HeaderTemplate>
                        ...
                        <div class="card-deck" style="margin-bottom: 10px">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 text-right">
                                            <asp:Label ID="lblPayDetail" runat="server">pay by cash</asp:Label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label style="font-weight: bold">
                                                Total price(<asp:Label ID="lblCountsumTotalPrice" runat="server" Text="0"></asp:Label>
                                                item):</label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label style="font-weight: bold">Shipping cost:</label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <label style="font-weight: bold">Price to pay:</label>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="sub-title">Notes on this command</div>
                                </div>
                        ...
                        <div class="card-deck" style="margin-bottom: 10px">
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="sub-title">tax invoice address</div>
                                </div>
