...
{
    public partial class OrderPaymentDetail : System.Web.UI.Page
    {
        ...
        protected void LoadOrderMapCustomer()
        {
            ...
            lblInstallment.Text = lOrderDetailInfo[0].Installment;

            lblInstallmentPrice.Text = lOrderDetailInfo[0].InstallmentPrice;

            lblFirstInstallment.Text = lOrderDetailInfo[0].FirstInstallment;

            lblCardIssuename.Text = lOrderDetailInfo[0].CardIssuename;

            lblCardType.Text = lOrderDetailInfo[0].CardType;

            lblCardNo.Text = lOrderDetailInfo[0].CardNo;

            lblCVCNo.Text = lOrderDetailInfo[0].CVCNo;

            lblCardHolderName.Text = lOrderDetailInfo[0].CardHolderName;

            lblCardExpYear.Text = lOrderDetailInfo[0].CardExpYear;

            lblCitizenId.Text = lOrderDetailInfo[0].CitizenId;
        ...
        public List<OrderDetailInfo> GetOrderMapCustomerByCriteria()
        {
            ...
            APIpath = APIUrl + "/api/support/ListOrderPaymentMapCustomerNopagingByCriteria";
