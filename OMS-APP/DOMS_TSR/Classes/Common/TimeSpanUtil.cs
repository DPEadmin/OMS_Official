...
namespace SALEORDER.Common
{
    public static  class TimeSpanUtil
    {
        ...
        public static DateTime getCurrDateTimeFromOrcle(String dateOra, String dateFormat)
        {
            Thread.CurrentThread.CurrentCulture = CultureInfo.GetCultureInfo("en-GB");
            DateTime result;
            try
            {
                if (DateTime.TryParse(dateOra, out result))
                {
                    result = DateTime.ParseExact(dateOra,
            ...
            {
                DateTime.TryParse(dateOra, out result);
                return result;
            }
