...
namespace SALEORDER.DTO
{
    public class LeadManagementInfo
    {
        ...
        public String CampiagnCode { get; set; }
        ...
        public String chkboxstatus { get; set; }
        public String checkboxallstatus { get; set; }
    ...
    {
        public List<LeadManagementInfo> L_LeadManagement { get; set; } = new List<LeadManagementInfo>();
    }

    public class LeadCallOMSCoreInfo
    {
        public String CustomerCode { get; set; }
        public String CustomerPhone { get; set; }
        public String Lot { get; set; }
