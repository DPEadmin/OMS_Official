                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="sub-title">Search Logistic Management</div>
                            </div>
                            <div class="card-block">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:DropDownList ID="ddlsearchLogictype" class="form-control" runat="server"></asp:DropDownList>
                                            ...
                                            <asp:CheckBox ID="chkProductAll" OnCheckedChanged="chkProductAll_Change" AutoPostBack="true" runat="server"  />
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                            ...
                                                            <HeaderTemplate>
                                                                ...
                                                                <div align="center">Logistic Name</div>

                                                            </HeaderTemplate>

                                                            <ItemTemplate>
                                                                <asp:Label ID="lblProductName" Text='<%# DataBinder.Eval(Container.DataItem, "LogisticName")%>' runat="server" />
                                ...
                                <asp:UpdatePanel ID="upModal" runat="server">
                                    <ContentTemplate>
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-2 col-form-label">Logistic Type</label>
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="ddlLogistype_Ins" runat="server" class="form-control"></asp:DropDownList>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:TextBox ID="txtEstimatedTime_Ins" runat="server" class="form-control"></asp:TextBox>
                                                <asp:Label ID="lbEstimatedTime_Ins" runat="server" CssClass="validation"></asp:Label>

                                            </div>
                                            <label class="col-sm-2 col-form-label">Active</label>
                                            <div class="col-sm-3">
                                                <asp:DropDownList ID="ddlActive_Ins" name="select" class="form-control" runat="server">
                                                    <asp:ListItem Value="-99">---- กรุณาเลือก ----</asp:ListItem>
                                                    <asp:ListItem Value="Y">ใช่</asp:ListItem>
                                                    <asp:ListItem Value="N">ไม่</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:Label ID="Label6" runat="server" CssClass="validation"></asp:Label>
                                            </div>
                                            ...
                                            <div>
                                                <%--<asp:GridView ID="Gridview1" runat="server" ShowFooter="true" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="Center" cs
                                                CssClass=" table table-bordered prpa " TabIndex="0" CellSpacing="0" BorderColor="0" OnRowDataBound="GridView1_RowDataBound"
                                                ...
                                                <Columns>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                          <asp:TextBox ID="GvTxtWeightFrom" runat="server" Width="70px" class="form-control" ></asp:TextBox>
                                                                           ...
                                                                           To : <asp:TextBox ID="GvTxtWeightTo" runat="server" Width="70px" class="form-control"  ></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <asp:TemplateField HeaderText="FEE" ItemStyle-HorizontalAlign="Center">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:Button ID="ButtonAdd" runat="server" Text="Add Condition" OnClick="ButtonAdd_Click" Class="btn btn-success btnadd waves-effect waves-light m-r-10 btn-colorprimary" />
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ลบ">
                                                        <ItemTemplate>
   
                                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" Class="btn btn-round  btn-sm btn-warning waves-effect waves-light m-r-10 btn-colorprimary">Remove</asp:LinkButton>
                                                            </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>--%>
