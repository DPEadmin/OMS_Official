                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                <div class="sub-title">Search Vehicle</div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-b-10">
                                    <asp:LinkButton ID="btnAddVehicle" class="btn-add button-active btn-small"
                                        OnClick="btnAddVehicle_Click" runat="server"><i class="fa fa-plus"></i>Add</asp:LinkButton>
                                ...
                                <div class="dt-responsive table-responsive">
                                    <asp:GridView ID="gvVehicle" runat="server" AutoGenerateColumns="False" CssClass="table-p
                          table-striped table-bordered nowrap"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                <HeaderTemplate>
                                                    <div align="center">License Plate</div>
                                                </HeaderTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                                <HeaderTemplate>
                                                    <div align="center">Vehicle Brand</div>
                                                </HeaderTemplate>
