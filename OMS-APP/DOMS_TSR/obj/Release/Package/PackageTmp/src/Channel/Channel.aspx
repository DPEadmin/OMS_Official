      ...
      <div class="card">
        ...
        <div class="card-block">            
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">รหัสช่องทาง</label>
              <div class="col-sm-3">
            ...
            <asp:HiddenField ID="hidMsgDel" runat="server" />
             <asp:HiddenField ID="hidEmpCode" runat="server" />
              ...
              <label class="col-sm-2 col-form-label">ชื่อช่องทาง</label>
              <div class="col-sm-3">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="center">รหัสช่องทาง</div>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# GetLink(DataBinder.Eval(Container.DataItem, "ChannelCode")) %>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="400px" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <div align="center">ชื่อช่องทาง</div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <div class="modal-header modal-header2  p-l-0 ">
                          <div class="col-sm-12">
                              <div id="exampleModalLongTitle" class="modal-title sub-title " style="font-size: 16px; ">เพิ่ม ช่องทาง</div>
