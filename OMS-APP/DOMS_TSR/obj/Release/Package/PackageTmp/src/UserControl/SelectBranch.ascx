...
<%--        if (cusLat != "" && cusLng != "") {
    ...
    $("<script/>", {
      ...
      src: "//maps.google.com/maps/api/js?v=3.2&key=AIzaSyCtfKs5LsP1Yb4TR7gxdkjtrEEFEgedSII&sensor=false&language=th&callback=initialize&libraries=places,drawing,geometry"
    }).appendTo("body");    
});
