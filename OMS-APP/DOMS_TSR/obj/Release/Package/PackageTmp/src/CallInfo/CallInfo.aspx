<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/WebReatil.Master" AutoEventWireup="true" CodeBehind="CallInfo.aspx.cs" Inherits="DOMS_TSR.src.CallInfo.CallInfo" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <div id="cardGridviewCallInfo" class="card" runat="server" style="display:none">
                            <div class="card-block">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="gvCallInfo" runat="server" AutoGenerateColumns="false" CssClass="table-p-stand" TabIndex="0" Width="100%" CellSpacing="0" ShowHeaderWhenEmpty="true" OnRowCommand="gvCallInfo_RowCommand">
                                            <Columns>
    ...
    <script type="text/javascript">
        function validatetext(key) {
            ...
            if ((keycode < 1 || keycode > 64) && (keycode < 91 || keycode > 96) && (keycode < 123 || keycode > 127)) {
                return true;
            }
