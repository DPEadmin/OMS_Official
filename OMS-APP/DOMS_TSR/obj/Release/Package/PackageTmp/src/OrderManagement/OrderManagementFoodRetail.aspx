<%@ Page Title="" Language="C#" MasterPageFile="~/src/MasterPage/Web.Master" AutoEventWireup="true" CodeBehind="OrderManagementFoodRetail.aspx.cs" Inherits="DOMS_TSR.src.OrderManagement.OrderManagementFoodRetail" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="searchSection_NewOrder" runat="server">
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        <asp:Button ID="btnSearch_NewOrder" Text="ค้นหา" OnClick="btnSearch_Click_NewOrder" class="button-pri button-accept m-r-10" runat="server" />
                                        <asp:Button ID="btnClearSearch_NewOrder" Text="ล้าง" OnClick="btnClearSearch_Click_NewOrder" class="button-pri button-cancel " runat="server" />
                                    </div>
                                ...
                                <div id="searchSection_OrderChanged" runat="server">
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                                        ...
                                        class="button-pri btn-accept m-r-10" runat="server" />
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="Section_All" runat="server">
                                    ...
                                    <asp:Button CssClass="button-pri button-add m-b-10" ID="btnCreateTakeOrder_All" runat="server" Text="Create" PostBackUrl="~/src/TakeOrderMK/TakeOrder.aspx?CustomerCode=C2018091700001&RefCode=0001&BrandNo=01&Customerphone=0838023829&UniqueId=Unq001"/>
                                            ...
                                            <asp:CheckBox ID="chkAll_NewOrder" OnCheckedChanged="chkAll_Change_NewOrder" AutoPostBack="true" runat="server"  />
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btnRequestReject_NewOrder" runat="Server" class="button-activity"  CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"><span class="icofont icofont-ui-edit f-14"></span></asp:LinkButton>
                                ...
                                <div id="Section_Cooking" runat="server">
                                    <asp:Button CssClass="button-pri button-print m-b-10" ID="btnSubmitToRider_Cooking" runat="server" Text="Merge"/>
                                    <asp:Button CssClass="button-pri button-delete m-b-10" ID="btnPrint_Cooking" runat="server" Text="Cancel" OnClick="btnSubmitToRider_Cooking_Click"/>
                                            ...
                                            <asp:CheckBox ID="chkAll_Cooking" OnCheckedChanged="chkAll_Change_Cooking" AutoPostBack="true" runat="server"  />
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btnRequestReject_Cooking" runat="Server" class="button-activity"  CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"><span class="icofont icofont-ui-edit f-14"></span></asp:LinkButton>
                                ...
                                <div id="Section_Cooked" runat="server">
                                    <asp:Button CssClass="button-pri button-print m-b-10" ID="btnMergeOrder_Cooked" runat="server" Text="Merge"/>
                                    <asp:Button CssClass="button-pri button-delete m-b-10" ID="btnOrderCancel_Cooked" runat="server" Text="Cancel" OnClick="btnOrderCancel_Cooked_Click"/>
                                            ...
                                            <asp:CheckBox ID="chkAll_Cooked" OnCheckedChanged="chkAll_Change_Cooked" AutoPostBack="true" runat="server"  />
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btnRequestReject_Cooked" runat="Server" class="button-activity" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"><span class="icofont icofont-ui-edit f-14"></span></asp:LinkButton>
                                ...
                                <div id="Section_Delivering" runat="server">
                                    <asp:Button CssClass="button-pri button-delete m-b-10" ID="btnOrderCancel_Delivering" runat="server" Text="Cancel" OnClick="btnOrderCancel_Delivering_Click"/>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderStyle-CssClass="TDHead" ItemStyle-CssClass="TDDetail btn-action">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="btnRequestReject_OrderChanged" runat="Server" class="button-activity" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"><span class="icofont icofont-ui-edit f-16"></span></asp:LinkButton>
