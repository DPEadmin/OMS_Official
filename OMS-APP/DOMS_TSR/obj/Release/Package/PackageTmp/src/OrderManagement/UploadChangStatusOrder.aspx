...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        <div class="card-header border-0">
            <div class="sub-title">
                นำเข้าข้อมูล สถานะใบสั่งขาย</div>
        </div>
        <div class="card-body">
            <div id="searchSection_All" runat="server">
                <div class="form-group row">
                    <label class="col-sm-5 col-form-label">
                    ไฟล์ import รายการ Order </label>
                    <div class="col-sm-3">
                       <asp:FileUpload ID="fiUpload" runat="server" CssClass="textbox"  width="70%"></asp:FileUpload><br />
                    </div>
                 
                </div>
              
                <div class="text-center m-t-20 col-sm-12">
                    <asp:Button ID="btnSearch_OrderCancelled" OnClick="btnPreview_Click" runat="server" class="button-pri button-accept m-r-10" Text="Import File" />
                    <asp:Button ID="btnClearSearch_OrderCancelled" runat="server" class="button-pri button-cancel m-r-10"  Text="ล้าง" />
                </div>
            </div>
        </div>
        ...
        <div class="page-body" id="divGrid" runat="server" visible="false">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="text-center m-t-20 col-sm-12">
                    <asp:Button ID="btnSaveStatusOrder" runat="server" class="button-pri button-accept m-r-10" Text="Save Order Status" OnClick="btnSaveStatusOrder_Click" />
                    <asp:Button ID="btnCancelSaveStatusOrder" runat="server" class="button-pri button-cancel m-r-10 "  Text="Cancel" />
                </div>
