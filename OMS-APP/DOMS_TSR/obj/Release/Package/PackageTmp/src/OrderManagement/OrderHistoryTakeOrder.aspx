            ...
            <ContentTemplate>
                  <div class="dt-responsive table-responsive">
                      <asp:GridView ID="gvOrderHistory" runat="server" AutoGenerateColumns="False" CssClass="table-p
                          table-striped table-bordered nowrap"  OnRowCommand="gvOrderHistory_OnRowCommand"
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="modal-header modal-header2 ">
                              <div class="col-sm-11">
                                <div id="exampleModalLongTitle" runat="server">รายละเอียดใบสั่งขาย (Order Detail)
                                </div>
                                  <div id="exampleModalLongTitle1" runat="server">เลขที่ใบสั่งขาย 
