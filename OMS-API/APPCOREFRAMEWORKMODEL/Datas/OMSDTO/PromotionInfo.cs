...
namespace APPCOREMODEL.Datas.OMSDTO
{
    public class PromotionInfo
    {
        ...
        public int? PromotionMapPromotionTagId { get; set; }
        ...
        public String StatusWfforReq { get; set; }
        ...
        public string PromotionCodeString { get; set; }
    ...
    public class PromotionListReturn
    {
        public int? PromotionId { get; set; }
        public int? CampaignPromotionId { get; set; }
        public int? PromotionMapPromotionTagId { get; set; }
