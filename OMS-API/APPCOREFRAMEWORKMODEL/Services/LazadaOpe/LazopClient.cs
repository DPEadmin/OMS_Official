using APPCOREMODEL.Services.LazadaOpe.Util;
using System;
using System.Collections.Generic;

namespace APPCOREMODEL.Services.LazadaOpe
{
    /// <summary>
    ...
    public class LazopClient : ILazopClient
    {
        ...
        public LazopClient(string serverUrl, string appKey, string appSecret)
        {
            ...
            this.topLogger = APPCOREMODEL.Services.LazadaOpe.LazopLogger.Instance;
        }
